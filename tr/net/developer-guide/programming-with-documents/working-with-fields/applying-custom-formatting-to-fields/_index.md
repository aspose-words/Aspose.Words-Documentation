...
mail merge'den sonra `IF` durumunu değerlendirmek istiyorsanız ifade değerlendirmesinin sonucunu anında döndüren [EvaluateCondition](https://reference.aspose.com/words/net/aspose.words.fields/fieldif/evaluatecondition/) yöntemini kullanabilirsiniz.

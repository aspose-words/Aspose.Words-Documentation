...
Microsoft Word'te, Filigran Ekle komutunu kullanarak bir belgeye kolayca filigran eklenebilir. Aspose.Words, belgelere filigran eklemek veya kaldırmak için [watermark](https://reference.aspose.com/words/tr/net/aspose.words/watermark/) sınıfını sağlar. Aspose.Words, üzerinde çalışılacak üç olası filigran türünü (Metin, Resim ve Yok) tanımlayan [Filigran Türü](https://reference.aspose.com/words/tr/net/aspose.words/watermark/type/)enumeration'ı sağlar

### Metin Filigranı Ekle

Aşağıdaki kod örneği, [SetText](https://reference.aspose.com/words/tr/net/aspose.words/watermark/settext/#settext) yöntemini kullanarak [TextWatermarkOptions](https://reference.aspose.com/words/tr/net/aspose.words/textwatermarkoptions/)'i tanımlayarak bir belgeye metin filigranının nasıl ekleneceğini gösterir:
...
Aşağıdaki kod örneği, [SetImage](https://reference.aspose.com/words/tr/net/aspose.words/watermark/setimage/#setimage) yöntemini kullanarak [ImageWatermarkOptions](https://reference.aspose.com/words/tr/net/aspose.words/imagewatermarkoptions/)'i tanımlayarak bir belgeye görüntü filigranının nasıl ekleneceğini gösterir:
...
[Watermark](https://reference.aspose.com/words/tr/net/aspose.words/watermark/) sınıfı, filigranı bir belgeden kaldırmak için kaldırma yöntemini sağlar.
...
Filigranlar [Shape](https://reference.aspose.com/words/tr/net/aspose.words.drawing/shape/) sınıfı nesnesi kullanılarak eklenirse, filigranı bir belgeden kaldırmak için, ekleme sırasında yalnızca filigran şeklinin adını ayarlamanız ve ardından filigran şeklini atanan bir adla kaldırmanız gerekir.

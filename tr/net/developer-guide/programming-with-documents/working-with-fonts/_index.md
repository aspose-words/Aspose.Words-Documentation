...
Yazı tipi, belirli bir boyuta, renge ve tasarıma sahip bir karakter kümesidir. Aspose.Words, [Fonts](https://reference.aspose.com/words/net/aspose.words.fonts/) ad alanını ve [Font](https://reference.aspose.com/words/net/aspose.words/font/) sınıfını kullanarak yazı tipleriyle çalışmanıza olanak tanır.

## Yazı Tipi Biçimlendirmesi

Geçerli yazı tipi formatı, [Font](https://reference.aspose.com/words/net/aspose.words/documentbuilder/font/) özelliği tarafından döndürülen **Font** nesnesi tarafından temsil edilir. **Font** sınıfı, Microsoft Word'de mevcut olanları çoğaltan çok çeşitli yazı tipi özellikleri içerir.
...
Bu değeri elde etmek için aşağıdaki örnekte gösterildiği gibi [LineSpacing](https://reference.aspose.com/words/net/aspose.words/font/linespacing/) özelliği **Font** sınıfına tanıtıldı:
...
Bazı Doğu Asya dilleri, vurguyu belirtmek için özel bir vurgu işareti kullanır. **Font** sınıfı, biçimlendirme sırasında uygulanacak [EmphasisMark](https://reference.aspose.com/words/net/aspose.words/emphasismark/) numaralandırma değerlerini almak veya ayarlamak için [EmphasisMark](https://reference.aspose.com/words/net/aspose.words/font/emphasismark/) özelliğini sağlar.

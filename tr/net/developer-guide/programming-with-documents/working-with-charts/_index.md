...
Çok satırlı etiketler için metin hizalamasını ayarlamak istiyorsanız bunu [TickLabelAlignment](https://reference.aspose.com/words/net/aspose.words.drawing.charts/chartaxis/ticklabelalignment/) özelliğinin değerini ayarlayarak kolayca yapabilirsiniz.

...
- [VBAProject](https://reference.aspose.com/words/net/aspose.words.vba/vbaproject/) sınıfı VBA proje bilgilerine erişim sağlar
- [VBAModuleCollection](https://reference.aspose.com/words/net/aspose.words.vba/vbamodulecollection/) sınıfı, VBA proje modüllerinin koleksiyonunu döndürür
- [VbaModule](https://reference.aspose.com/words/net/aspose.words.vba/vbamodule/) sınıfı VBA proje modülüne erişim sağlar
- [VbaModuleType](https://reference.aspose.com/words/net/aspose.words.vba/vbamoduletype/) numaralandırması bir VBA projesindeki model türlerini tanımlar. Modül bir prosedür modülü, belge modülü, sınıf modülü veya tasarımcı modülü olabilir

## VBA Projesi Oluşturma

Aspose.Words API, belgede VbaProject'i almak veya ayarlamak için [VbaProject](https://reference.aspose.com/words/net/aspose.words/document/vbaproject/) özelliğini sağlar.
...
Aşağıdaki kod örneği, [SourceCode](https://reference.aspose.com/words/net/aspose.words.vba/vbamodule/sourcecode/) özelliğini kullanarak VBA Makrolarının nasıl değiştirileceğini gösterir:
...
Aşağıdaki kod örneği, mevcut projenin bir kopyasını oluşturan [Clone](https://reference.aspose.com/words/net/aspose.words.vba/vbaproject/clone/) özelliğini kullanarak VBA Projesinin nasıl kopyalanacağını gösterir:
...
Aşağıdaki kod örneği, mevcut projenin bir kopyasını oluşturan [Clone](https://reference.aspose.com/words/net/aspose.words.vba/vbamodule/clone/) özelliğini kullanarak VBA Modülünün nasıl kopyalanacağını gösterir:
...
Aspose.Words API, [VbaReferenceCollection](https://reference.aspose.com/words/net/aspose.words.vba/vbareferencecollection/) sınıfının, VBA proje referanslarının bir koleksiyonunu temsil eden VBA Proje Referansları ile çalışmasını sağlar.

...
Does your organization have a corporate document repository on Windows SharePoint Services (WSS) or Microsoft Office SharePoint Server’s (MOSS) technologies? Do you have to use {multiple|several|a few|many|numerous} document formats in your internal work process or in your interaction with customers and partners? 
...
- you have to use {multiple|several|a few|many|numerous} document formats in your internal work process or in interactions with customers and partners.

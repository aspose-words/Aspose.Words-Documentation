...
When you select {multiple|several|a few|many|numerous} items in a document library view, you can convert or combine selected the items only.
...
**Conversion Settings screen for {multiple|several|a few|many|numerous} files conversion.** 

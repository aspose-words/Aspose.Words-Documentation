...
articleTitle: 「 Aspose.Words for .NET」的新功能是什麼？
linktitle: 「 Aspose.Words for .NET」的新功能是什麼？
type: docs
...
"* 能修改「廣播按鈕」ActiveX 控制項的值，以啟用動態互動功能的功能已新增。"
...
#### 在載入 Markdown 個檔案時「保留空白行」 <sup>24.2</sup>

「在加載 Markdown 個檔案時，能保存空白行」這個功能已經被加入。
...
#### 「原件圖形」的「線性漸變」 `SkiaSharp` Native Shader <sup>23.3</sup>

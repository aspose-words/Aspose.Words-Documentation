...
### 在「查找與取代」操作中插入文件 {#insert-a-document-during-find-and-replace-operation}
...
以下範例示意如何在「搜尋與替換」作業中，將一個文件的内容插入另一個文件中：
...
以下範例示範了如何透過「已建立的處理常式」將檔案插入到合併欄位中：

...
有時不可能辨別哪些細胞是合併的，因為有些較新版本的 Microsoft Word 在水平合併細胞時不再使用合併標誌。 「不過，在細胞根據其寬度從水平方向合併的狀況中，「Aspose.Words」提供「`ConvertToHorizontallyMergedCells`」方法來轉換細胞。 「此方法簡單地將表格轉換並依需要新增新細胞。」

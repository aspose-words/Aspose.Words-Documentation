...
This page contains release notes for [Aspose.Words for JasperReports 2.3.0](http://www.aspose.com/downloads/words/jasperreports/new-releases/aspose.words-for-jasperreports-2.3.0/)
...
- Fix WORDSJSP-149 (Contents are missing when {multiple|several|a few|many|numerous} jrxml exported to Docx)
...
- Implement WORDSJSP-153 (MS Word 2010/2013 {shows|demonstrates} compatibility mode for Docx files)

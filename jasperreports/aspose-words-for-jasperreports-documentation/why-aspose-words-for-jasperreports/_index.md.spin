...
Aspose.Words for JasperReports {allows|enables} exporting reports as DOC and DOCX documents. Compared to RTF, these formats offer a number of advantages (smaller file size for example). 

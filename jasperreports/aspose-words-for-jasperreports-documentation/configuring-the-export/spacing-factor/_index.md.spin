...
Sometimes you may notice that page contents in the exported documents do not fit a particular page and therefore are pushed to the next page, causing an etra page. This is a trade-off of the flow layout mode which {allows|enables} to compose documents from “normal” inline paragraphs and tables and which is the default in Aspose.Words for JasperReports. 

...
Aspose.Words for JasperReports provides a unique feature that enables inserting Microsoft Word fields to any point of a document. This feature can be used to insert page numbers that are dynamically updated as the document is edited, TOC (table of contents), and many other things.

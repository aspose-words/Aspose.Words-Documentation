...
type: docs
weight: 30
url: /net/public-api-changes-in-aspose-words-13-3-0/
---
...
Save any document to fixed HTML based format. All elements in this output are absolutely positioned that {allows|enables} displaying document in browser exactly as it looks in Microsoft Word.
...
In previous versions a merge field with an empty string as a table name would be merged i.e **TableStart:**. This behavior was changed in recent versions as only region names with at least one character would be merged. This fix {allows|enables} regions with empty table names to be merged once again.

### Non-standard Quotation Marks are Recognized in Fields

Microsoft Word recognizes quotation marks in fields from {several|multiple|a few|many|numerous} Unicode characters: U+0022 (standard), U+00AB, U+00BB, U+201C, U+201D, U+201E, U+201E. Aspose.Words previously only recognized the standard quotation marks, however with this release it now recongizes all of the listed characters.

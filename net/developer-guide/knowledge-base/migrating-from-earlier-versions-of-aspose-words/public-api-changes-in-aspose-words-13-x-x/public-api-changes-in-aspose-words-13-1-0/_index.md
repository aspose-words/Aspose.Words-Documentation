...
We have implemented a **FieldCollection** class that is very similar to **BookmarkCollection**. The **Range.Fields** property now enables to access all fields based on field starts within a node's range.
...
- Since Aspose.Words for .NET is auto-ported to Java multiple performance benefits will extend to Aspose.Words for Java as well.

...
- Simplified (default) - Soft edges are simulated using a few layers with different transparency, which gives acceptable result with higher performance than in Fine mode.

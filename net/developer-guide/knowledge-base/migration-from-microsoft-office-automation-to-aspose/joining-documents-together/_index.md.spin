...
A common task of document processing is to join {many|multiple|several|a few|numerous} small documents together to create a complete document.
...
*Shows how to join {multiple|several|a few|many|numerous} documents together.*

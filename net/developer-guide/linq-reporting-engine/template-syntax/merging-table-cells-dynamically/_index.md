...
Given that `invoices` is an enumeration of `Invoice` instances, you could use the following template to output information on numerous invoices in one table.

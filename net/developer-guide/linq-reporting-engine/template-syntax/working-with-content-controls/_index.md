...
A single `item` tag causes addition of a single combobox or dropdown list item during runtime. You can add several combobox or dropdown list items using numerous `item` tags as shown in the following snippet.

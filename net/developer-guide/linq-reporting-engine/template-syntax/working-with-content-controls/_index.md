...
A single `item` tag causes addition of a single combobox or dropdown list item during runtime. You can add a few combobox or dropdown list items using multiple `item` tags as shown in the following snippet.

...
description: "Aspose.Words for .NET enables users to convert to PDF/A-1 and PDF/A-2. There are multiple problems when converting to PDF/A documents, and Aspose.Words for .NET solves them."
type: docs
weight: 25

...
description: "Aspose.Words for .NET allows users to convert to PDF/A-1, PDF/A-2, and PDF/UA using C#. There are a few problems when converting to PDF/A documents, and Aspose.Words for .NET solves them."
type: docs
weight: 25

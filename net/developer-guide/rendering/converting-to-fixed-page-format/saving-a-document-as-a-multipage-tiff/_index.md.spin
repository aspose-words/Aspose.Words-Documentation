...
description: "Aspose.Words for .NET {enables|allows} you to convert a document to a multi-page TIFF. To determine how the document is displayed on the image you need to specify additional options: resolution, number of pages, image binarization, etc."
type: docs
weight: 30
...
The following example {shows|demonstrates} how to convert DOC to TIFF with configured options:
...
The following example {shows|demonstrates} how to perform TIFF binarization with a specified threshold:

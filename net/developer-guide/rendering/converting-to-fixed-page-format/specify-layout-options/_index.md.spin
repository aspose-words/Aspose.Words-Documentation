...
The [TextShaperFactory](https://apireference.aspose.com/words/net/aspose.words.layout/layoutoptions/properties/textshaperfactory) property {enables|allows} you to set the text shaping functionality, as well as the OpenType features support.

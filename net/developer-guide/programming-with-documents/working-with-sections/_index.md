...
Note that in a Word Document the same character is used to represent a page break and section break. The **ControlChar.PageBreakChar** and [ControlChar.SectionBreakChar](https://reference.aspose.com/words/net/aspose.words/controlchar/fields/sectionbreakchar) are identical. You will only ever encounter a page break represented by this character in a document using Aspose.Words. This is explained further in the section below.

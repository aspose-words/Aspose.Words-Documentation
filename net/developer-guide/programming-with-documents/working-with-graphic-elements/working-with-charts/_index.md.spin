...
Below examples {shows|demonstrates} how to insert column chart.
...
Below example {shows|demonstrates} how to insert a scatter chart.
...
Below example {shows|demonstrates} how to insert an area chart.
...
Below example {shows|demonstrates} how to insert a bubble chart.
...
Using ChartDataLabel.NumberFormat you are able to specify number formatting of a single data label of the chart. The code example given below {shows|demonstrates} how to format a number of the data label. 
...
The AxisBound class represents a minimum or maximum bound of axis values. Bound can be specified as a numeric, date-time or a special "auto" value. The following code example {shows|demonstrates} how to set bounds of an axis.
...
If you want to set a text alignment for multi-line labels, you can simply achieve this by setting the value of ChartAxis.TickLabelAlignment property. The following code example {shows|demonstrates} how to tick label alignment.

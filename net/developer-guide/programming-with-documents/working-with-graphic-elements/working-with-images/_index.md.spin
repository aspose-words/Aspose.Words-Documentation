...
## {How to Insert|Insert} an Image {#insert-an-image}

DocumentBuilder provides {several|multiple|a few|many|numerous} overloads of the [DocumentBuilder.InsertImage](https://apireference.aspose.com/words/net/aspose.words.documentbuilder/insertimage/methods/1) method that {allows|enables} you to insert an inline or floating image. If the image is an EMF or WMF metafile, it will be inserted into the document in metafile format. All other images will be stored in PNG format. The DocumentBuilder.InsertImage method can use images from different sources:
...
### {How to Insert|Insert} an Inline Image {#insert-an-inline-image}
...
### {How to Insert|Insert} {a|Absolutely Positioned} Floating Image  {#insert-a-floating-image}
...
## {How to Extract|Extract} Images from a Document {#how-to-extract-images-from-a-document}
...
## {How to Insert|Insert} Barcode on each Document Page {#how-to-insert-barcode-on-each-documen-page}
...
## Lock {Aspect Ratio of Image|Image Aspect Ratio} {#lock-aspect-ratio-of-image}
...
## How to Get Actual {Bounds of Shape|Shape Bounds} in Points {#how-to-get-actual-bounds-of-shape-in-points}

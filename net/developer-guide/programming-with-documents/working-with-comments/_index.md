...
You can use Comment.RemoveReply method to remove the specified reply to this comment. Following code example demonstrates how to add a reply to comment and remove comment's reply.

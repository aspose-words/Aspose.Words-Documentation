...
Aspose.Words allows you to protect your documents from changes using the [Protect](https://reference.aspose.com/words/net/aspose.words/document/methods/protect/index) method. This method is not a security feature and does not encrypt a document.
...
Aspose.Words allows you to mark the parts that can be changed in your document using the [StartEditableRange](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/starteditablerange) and [EndEditableRange](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/endeditablerange/index) methods.

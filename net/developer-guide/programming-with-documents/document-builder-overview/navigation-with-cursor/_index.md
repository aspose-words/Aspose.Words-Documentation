...
The main method is to be able to move the cursor position to a specific node in your document, you can achieve this by using the [MoveTo](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/moveto) method.
...
You can go to the beginning or  the end of your document using the [MoveToDocumentStart](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/movetodocumentstart) and [MoveToDocumentEnd](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/movetodocumentend) methods.
...
You can move to a specific field in your document by using the [MoveToField](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/movetofield) method. In addition, you can move to a specific merge field by using the [MoveToMergeField](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/movetomergefield/index) method.
...
You can move to the beginning of a header or footer by using the [MoveToHeaderFooter](https://reference.aspose.com/words/net/aspose.words/documentbuilder/methods/movetoheaderfooter) method. 

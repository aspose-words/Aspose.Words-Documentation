...
type: docs
description: "DocumentBuilder {allows|enables} you to build dynamic documents from scratch or add new elements to existing ones. DocumentBuilder provides methods to insert text, checkboxes, tables, images, and other content elements with .NET."
weight: 20
url: /net/document-builder-overview/
---

[DocumentBuilder](https://apireference.aspose.com/words/net/aspose.words/documentbuilder) is a powerful class that associates with [Document](https://apireference.aspose.com/words/net/aspose.words/document) and {enables|allows} you to build dynamic documents from scratch or add new elements to an existing one.

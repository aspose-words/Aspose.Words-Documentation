---
title: Working with Paragraphs – Aspose.Words for .NET
...
The shading texture is set with a [TextureIndex](https://apireference.aspose.com/words/net/aspose.words/textureindex) enumeration value that allows the application of various patterns to the **Shading** object. For example, to set a background color for a document element, use the [TextureIndex.TextureSolid](https://apireference.aspose.com/words/net/aspose.words/textureindex) value and set the foreground shading color as appropriate. Below example shows how to apply borders and shading to a paragraph.

...
- A Row represents a single row of a table and contains numerous Cell nodes. Additionally a Row provides members which define how a row is displayed, for example the height and alignment.

...
description: "Aspose.Words for .NET {allows|enables} to use hyphenation for a more compact arrangement of text. It provides advanced algorithms to work with hyphenation dictionaries, uses OpenOffice dictionaries."
type: docs
weight: 115

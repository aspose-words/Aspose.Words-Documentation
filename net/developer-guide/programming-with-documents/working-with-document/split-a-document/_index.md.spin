...
description: "Aspose.Words for .NET allows you to split a document into numerous files. Use the split feature to effectively split a document by headings or sections, as well as by pages or by page ranges."
type: docs
weight: 80
...
This section describes many use cases of dividing documents by paged using the [Document](https://apireference.aspose.com/words/net/aspose.words/document) class and the **ExtractPages** method.

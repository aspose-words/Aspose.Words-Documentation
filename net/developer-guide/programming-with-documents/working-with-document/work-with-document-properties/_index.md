...
description: "Aspose.Words for .NET enables storing some useful information about your document, such as API and Version Number or Authorized Date, in built-in or custom document properties."
type: docs
weight: 20
...
The following code example demonstrates how to remove personal information:

...
- Call [Node.Accept](https://reference.aspose.com/words/net/aspose.words/node/methods/accept) on the node from where you want to start the enumeration. For example, if you want to enumerate the whole document, use [Document.Accept](https://reference.aspose.com/words/net/aspose.words/document/methods/accept) .
...
- Use [Document.Save](https://reference.aspose.com/words/net/aspose.words.document/save/methods/3) with [SaveFormat.Text](https://reference.aspose.com/words/net/aspose.words/saveformat) to save as plain text into a file or stream.
- Use [Node.ToString](https://reference.aspose.com/words/net/aspose.words/node/methods/tostring) and pass the SaveFormat.Text parameter. Internally, this invokes save as text into a memory stream and returns the resulting string.
- Use [Node.GetText](https://reference.aspose.com/words/net/aspose.words/node/methods/gettext) to retrieve text with all Microsoft Word control characters including field codes.

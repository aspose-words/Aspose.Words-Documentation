...
description: "Aspose.Words for .NET {enables|allows} you to print a document on a Server using the unmanaged XpsPrint API or via a selected printer with Settings and Print Preview Dialogs."
type: docs
weight: 55
url: /net/print-a-document-programmatically-or-using-dialogs/
---

This article describes how to print a word processing document from an ASP.NET or Windows Service application using Aspose.Words and the XpsPrint API. It also {demonstrates|shows} the methods of printing a document with Settings, Print preview, and Print progress dialogs, and explains how to reduce the time of the first call to print a document.
...
The code example below {shows|demonstrates} how to print a document using the **XpsPrintHelper** class:
...
The following example {shows|demonstrates} how to use these classes to print a document from Aspose.Words via the Print preview and Settings dialogs:
...
The **AllowSomePages** property {enables|allows} you to select a range of pages for printing if the value of this property is True. By default, all pages in the range are selected for printing.

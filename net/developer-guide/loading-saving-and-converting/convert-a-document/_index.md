...
<div class="row">
	<div class="col-md-4">
		<h2>Convert Word to PDF</h2>
			<ul>
				<li><a href="http://localhost:1313/words/net/convert-a-word-document-to-pdf/#convert-doc-or-docx-to-pdf">Convert DOC to PDF</a></li>
				<li><a href="http://localhost:1313/words/net/convert-a-word-document-to-pdf/#convert-doc-or-docx-to-pdf">Convert DOCX to PDF</a></li>
				<li>and others</li>
			</ul>
		<h2>Convert Image to PDF</h2>
			<ul>
				<li><a href="http://localhost:1313/words/net/convert-an-image-to-pdf/#convert-jpeg-to-pdf">Convert JPG to PDF</a></li>
				<li><a href="http://localhost:1313/words/net/convert-an-image-to-pdf/#convert-tiff-to-pdf">Convert TIFF to PDF</a></li>
				<li>and others</li>
			</ul>

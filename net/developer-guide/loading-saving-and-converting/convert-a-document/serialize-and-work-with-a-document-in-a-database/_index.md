...
description: "Convert a document into a byte array for work with this document in a database. You can store and retrieve a document to and from the database."
type: docs
weight: 50
...
To serialize a [Document](https://apireference.aspose.com/words/net/aspose.words/document) object in Aspose.Words:

1. Save it to a **MemoryStream** using the [Save](https://apireference.aspose.com/words/net/aspose.words/document/methods/save) method overload of the **Document** class.

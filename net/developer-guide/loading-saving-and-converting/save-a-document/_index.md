...
Pass a stream object to the [Save](https://reference.aspose.com/words/net/aspose.words/document/methods/save) method. It's necessary to specify the save format explicitly when saving to a stream.

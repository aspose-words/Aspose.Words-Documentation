...
1. Save it to a **MemoryStream** using the [Save](https://reference.aspose.com/words/net/aspose.words/document/methods/save) method overload of the **Document** class.

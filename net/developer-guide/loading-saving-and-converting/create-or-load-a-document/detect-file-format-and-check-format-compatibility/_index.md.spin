...
description: "Aspose.Words for .NET {enables|allows} you to determine the file format if you are not sure what the actual content of the file is, or to check the format compatibility. This {allows|enables} to avoid possible exceptions."
type: docs
weight: 20

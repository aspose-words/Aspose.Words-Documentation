...
description: "Aspose.Words for .NET enables you to create a document or to load it from a file or stream. This is useful for almost any task performed using Aspose.Words."

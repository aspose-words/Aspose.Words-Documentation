...
The following code example demonstrates how to add a mapped field using the [Add](https://apireference.aspose.com/words/net/aspose.words.mailmerging/mappeddatafieldcollection/methods/add) method when a merge field in a template and a data field in a data source have different names:

...
You can implement the [Next](https://apireference.aspose.com/words/net/aspose.words.fields/fieldnext) field to merge the next data record into the current resulting merged document, instead of starting a new merged document. It is used to display a few records in one document.

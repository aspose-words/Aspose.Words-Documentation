...
Aspose.Words enables you to customize your template through a few properties. Template customization will be described below through an example of customizing some properties of images and text.

...
type: docs
description: "Aspose.Words for .NET enables you to perform a mail merge operation with nested regions. Nested merge is a feature that enables you to merge hierarchical data from your data source into your merge template."
...
The most common example of a nested mail merge is an order that contains numerous items where you need to link numerous data tables and present the information in a template.

...
|WORDSNET-7382|DrawingML nodes in Header/Footer are repeated {multiple|several|a few|many|numerous} times during open/save|Bug|
...
|WORDSNET-8172|Customer's 3D Charts look {many|multiple|several|a few|numerous} times higher than they should in output PDF|Bug|
...
|WORDSNET-7656|Make {multiple|several|a few|many|numerous} pages setup options public|Enhancement|
...
|WORDSNET-8189|Bookmark spanning across {multiple|several|a few|many|numerous} Paragraphs is exported to HTML incorrectly|Enhancement|
...
|WORDSNET-7689|Support Book Fold {multiple|several|a few|many|numerous} page setup|Feature|

...
This maintenance release contains improvements and fixes to DOCX import (which is still in Beta) as well as {many|multiple|several|a few|numerous} other fixes.

...
This is a maintenance release that addresses {several|multiple|a few|many|numerous} issues reported by Aspose.Words customers in importers/exporters as well as some new features.
...
- 3020 - When reading {multiple|several|a few|many|numerous} copies of same image, read only once to memory.

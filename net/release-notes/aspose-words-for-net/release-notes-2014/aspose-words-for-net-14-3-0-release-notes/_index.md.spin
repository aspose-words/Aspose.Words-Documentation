...
|WORDSNET-7406|Hyperlinks split into {multiple|several|a few|many|numerous} fragments/links in output PDF|Bug|
...
|WORDSNET-8842|Content in the output html is overlapped at {many|multiple|several|a few|numerous} places in Html|Bug|
...
|WORDSNET-9315|Offset of the hyperlink text line is off by {a few|multiple|several|many|numerous} pixels in output Pdf|Bug|
|WORDSNET-9369|Hyperlinks split into {multiple|several|a few|many|numerous} fragments/links in output PDF|Bug|

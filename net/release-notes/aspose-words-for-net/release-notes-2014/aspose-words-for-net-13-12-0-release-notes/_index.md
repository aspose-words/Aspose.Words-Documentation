...
|WORDSNET-8910|Implement a mechanism to apply multiple depended CSS properties together to a model format|Enhancement|
...
- Simplified
  (default) - Soft edges are simulated using a few layers with different

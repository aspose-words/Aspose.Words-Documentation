...
- Fixed exception when table which spans numerous pages and has a few nested floaters is broken across pages.
...
Obsolete method Replace was removed from Range class. And fixed many minor bug in new FindReplacer.

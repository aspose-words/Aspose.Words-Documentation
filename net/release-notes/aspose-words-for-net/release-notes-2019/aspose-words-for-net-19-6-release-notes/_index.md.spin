...
- Fixed exception when table which spans a few pages and has several nested floaters is broken across pages.
- Improved text positioning when there is a paragraph-relative shape with an anchor wrapped around many floaters.
...
Obsolete method Replace was removed from Range class. And fixed numerous minor bug in new FindReplacer.

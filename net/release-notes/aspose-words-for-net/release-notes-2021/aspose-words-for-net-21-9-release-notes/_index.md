...
| :- | :- | :- |
| WORDSNET-17101 | Optimize the PDF output size for document with a few gradient filled   shapes | New Feature |
...
| WORDSNET-13652 | InsertDocument splits one content control into numerous when document   have section break | Bug |

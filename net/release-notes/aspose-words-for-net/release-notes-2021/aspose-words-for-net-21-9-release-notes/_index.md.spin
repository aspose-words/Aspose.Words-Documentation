...
| :- | :- | :- |
| WORDSNET-17101 | Optimize the PDF output size for document with {multiple|several|a few|many|numerous} gradient filled   shapes | New Feature |
...
| WORDSNET-13652 | InsertDocument splits one content control into {multiple|several|a few|many|numerous} when document   have section break | Bug |

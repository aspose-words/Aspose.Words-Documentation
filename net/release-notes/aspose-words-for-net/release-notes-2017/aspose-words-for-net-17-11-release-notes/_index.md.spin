...
- PCL documents rendering improved. UCS-2 symbol sets can now be mapped to the printer built-in fonts – it {allows|enables} to print non-ascii symbols with built-in fonts if supported by printer.
...
|WORDSNET-15205|MS Word 2016 {shows|demonstrates} page number incorrectly in status bar after saving RTF To DOCX|Bug|

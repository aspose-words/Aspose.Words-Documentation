...
The changes are not likely to affect numerous users. Even if you cannot recompile your project because of a change, it is very easy to update your code because all changes are cosmetic, although they had to be done.
...
|4318 |PDF |MACROBUTTON field is output incorrectly if display text occupies multiple runs (PDF, HTML) |

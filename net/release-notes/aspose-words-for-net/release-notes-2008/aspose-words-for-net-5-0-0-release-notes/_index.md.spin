...
|3609 |DOCX |Demo2007\ManualComms Out.docx {shows|demonstrates} numbering revisions while it should not |
...
|4318 |PDF |MACROBUTTON field is output incorrectly if display text occupies {several|multiple|a few|many|numerous} runs (PDF, HTML) |

...
I would like to thank the team who worked on the engine painstakingly trying to recreate the multiple quirks of Microsoft Word’s page layout behavior.I would also like to thank all customers who have been waiting for this feature for 5 years!
...
Being able to print Word® documents in any server or client application without utilizing Microsoft Word® has been a dream for numerous and for long. Aspose.Words for .NET 6.0 makes it possible. 
...
Saving documents as MHTML has been available in Aspose.Words for many months already and the ability to load MHTML files is a logical next step.

...
This is the first release of Aspose.Words for iOS via Xanarin. In future regular monthly releases will be published. 'Aspose.Words for iOS via Xamarin' has full functionality of Aspose.Words for .NET with [few limitations, minor API changes and additional requirements](/words/net/aspose-words-for-ios-via-xamarin-api-differences-and-limitations/).
...
For full list of features, please, see the [documentation](/words/net/aspose-words-for-ios-via-xamarin-features/).

...
- A wide range of functions for modifying documents: [combining documents from {several|multiple|a few|many|numerous} into one](/words/net/insert-and-append-documents/), [splitting a document](/words/net/split-a-document/) into several, [finding and replacing](/words/net/find-and-replace/), filling documents with data from various sources, replacing fonts, etc.

...
description: "Aspose.Words for .NET {allows|enables} you to extract image from a document easily and fast instead of using Open XML SDK."
type: docs
weight: 90
...
The following code example {shows|demonstrates} how to extract images from a document and save them as files:

...
description: "Aspose.Words for .NET {allows|enables} you to open and modiffy an existing Word document easily and fast instead of using Open XML SDK."
type: docs
weight: 40
...
The following code example {shows|demonstrates} how to open an existing document and add text into it:

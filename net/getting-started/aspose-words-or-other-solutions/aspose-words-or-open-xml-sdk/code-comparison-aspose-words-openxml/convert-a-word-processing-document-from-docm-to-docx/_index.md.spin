...
description: "Aspose.Words for .NET {allows|enables} you to convert DOCM to DOCX easily and fast instead of using Open XML SDK."
type: docs
weight: 50
...
The following code example {shows|demonstrates} how to convert DOCM to DOCX:

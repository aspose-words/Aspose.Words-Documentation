...
description: "Aspose.Words for .NET {allows|enables} you to remove section breaks from a document easily and fast instead of using Open XML SDK."
type: docs
weight: 170
...
The following code example {shows|demonstrates} how to remove page breaks from a document:
...
The following code example {shows|demonstrates} how to remove section breaks from a document:

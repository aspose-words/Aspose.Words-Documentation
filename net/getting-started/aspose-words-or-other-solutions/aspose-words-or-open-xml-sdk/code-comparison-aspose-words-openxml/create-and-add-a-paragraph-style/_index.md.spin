...
description: "Aspose.Words for .NET {allows|enables} you to create and add a paragraph style easily and fast instead of using Open XML SDK."
type: docs
weight: 120
...
The following code example {shows|demonstrates} how to create and add a paragraph style:

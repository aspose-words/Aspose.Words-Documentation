...
description: "Aspose.Words for .NET {allows|enables} you to change or replace header or footer easily and fast instead of using Open XML SDK."
type: docs
weight: 60
...
The following code example {shows|demonstrates} how to replace header or footer:

...
description: "Aspose.Words for .NET {allows|enables} you to create a Word Processing document easily and fast instead of using Open XML SDK."
type: docs
weight: 10
...
The following code example {shows|demonstrates} how to create a document:

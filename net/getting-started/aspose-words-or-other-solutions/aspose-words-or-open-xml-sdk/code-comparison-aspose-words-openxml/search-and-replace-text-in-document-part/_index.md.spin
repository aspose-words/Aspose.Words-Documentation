...
description: "Aspose.Words for .NET {allows|enables} you to find and replace text from a document part easily and fast instead of using Open XML SDK."
type: docs
weight: 140
...
The following code example {shows|demonstrates} how to find and replace text from a document part:

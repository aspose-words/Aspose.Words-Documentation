...
description: "Aspose.Words for .NET {allows|enables} you to remove comments of all or a specific author easily and fast instead of using Open XML SDK."
type: docs
weight: 200
...
The following code example {shows|demonstrates} how to remove all comments in a document:
...
The following code example {shows|demonstrates} how to remove comments of a speciffic author:
...
The following code example {shows|demonstrates} how to remove comments in a document:

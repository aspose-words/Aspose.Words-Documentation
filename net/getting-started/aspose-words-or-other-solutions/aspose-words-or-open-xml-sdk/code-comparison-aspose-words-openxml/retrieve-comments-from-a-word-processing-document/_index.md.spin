...
description: "Aspose.Words for .NET {allows|enables} you to retrieve comments from a word processing  document easily and fast instead of using Open XML SDK."
type: docs
weight: 190
...
The following code example {shows|demonstrates} how to retrieve comments from a Word Document:

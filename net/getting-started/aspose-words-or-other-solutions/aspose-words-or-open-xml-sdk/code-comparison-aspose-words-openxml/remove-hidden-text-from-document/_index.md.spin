...
description: "Aspose.Words for .NET {allows|enables} you to remove hidden text from a document easily and fast instead of using Open XML SDK."
type: docs
weight: 150
...
The following code example {shows|demonstrates} how to remove hidden text from a Word Document:

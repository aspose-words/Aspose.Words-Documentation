...
description: "Aspose.Words for .NET {allows|enables} you to add a table to a Word document easily and fast instead of using Open XML SDK."
type: docs
weight: 100
...
The following code example {shows|demonstrates} how to add a table to a document:

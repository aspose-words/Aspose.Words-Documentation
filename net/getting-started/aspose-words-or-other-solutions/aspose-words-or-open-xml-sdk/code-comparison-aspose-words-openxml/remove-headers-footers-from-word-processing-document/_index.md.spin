...
description: "Aspose.Words for .NET {allows|enables} you to remove headers or footers from a word processing document easily and fast instead of using Open XML SDK."
type: docs
weight: 70
...
The following code example {shows|demonstrates} how to remove header and footer from a Word document:

...
description: "Aspose.Words for .NET {allows|enables} you to get and set bokmark textin a document easily and fast instead of using Open XML SDK."
type: docs
weight: 130
...
The following code example {shows|demonstrates} how to get and set bokmark text in a document:

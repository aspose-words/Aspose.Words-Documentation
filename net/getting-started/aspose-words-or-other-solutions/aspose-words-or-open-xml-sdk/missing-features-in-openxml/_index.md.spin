...
description: "Aspose.Words for .NET {allows|enables} to perform some operations with documents faster and more conveniently than Open XML SDK. In addition, there are operations that are not supported by OpenXML."
type: docs
weight: 60
...
| Join {multiple|several|a few|many|numerous} documents, including combine formatting of documents when importing content | The ["Insert and Append Documents"](/words/net/insert-and-append-documents/) article |

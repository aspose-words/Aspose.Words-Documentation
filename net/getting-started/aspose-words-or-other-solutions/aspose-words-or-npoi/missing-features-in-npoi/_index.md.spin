...
description: "Aspose.Words for .NET {allows|enables} to perform some operations with documents faster and more conveniently than NPOI. In addition, there are operations that are not supported by NPOI."
type: docs
weight: 20

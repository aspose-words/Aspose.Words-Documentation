...
See more details in the ["Applying Formatting"](https://docs.aspose.com/words/net/applying-formatting/) article of the ["Working with Tables"](https://docs.aspose.com/words/net/working-with-tables/) documentation section.

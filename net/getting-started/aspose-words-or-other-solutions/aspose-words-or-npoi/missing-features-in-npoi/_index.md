...
description: "Aspose.Words for .NET enables to perform some operations with documents faster and more conveniently than NPOI. In addition, there are operations that are not supported by NPOI."
type: docs
weight: 20
...
| Join numerous documents, including combine formatting of documents when importing content | The [“Insert and Append Documents”](https://docs.aspose.com/words/net/insert-and-append-documents/) article |

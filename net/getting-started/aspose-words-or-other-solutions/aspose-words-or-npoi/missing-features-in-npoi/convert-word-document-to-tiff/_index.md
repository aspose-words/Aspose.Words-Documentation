...
To convert a Word document to TIFF, simply invoke the [Save](https://apireference.aspose.com/net/words/aspose.words/document/methods/save/index) method and specify a file name with the “.TIFF” extension.

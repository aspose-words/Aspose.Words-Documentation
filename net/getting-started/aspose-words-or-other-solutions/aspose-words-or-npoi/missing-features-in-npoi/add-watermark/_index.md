...
In Microsoft Word, you can quickly insert a watermark using the Insert Watermark option. Not several people using this command realize that such “watermark” is just a shape with text inserted into a header or footer and positioned in the centre of the page.

...
description: "Aspose.Words for .NET enables to add a watermark into a document. NPOI does not provide an opportunity to add a watermark."
type: docs
weight: 90
...
In Microsoft Word, you can quickly insert a watermark using the Insert Watermark option. Not numerous people using this command realize that such “watermark” is just a shape with text inserted into a header or footer and positioned in the centre of the page.

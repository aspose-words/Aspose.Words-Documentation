...
To convert a Word document to PNG, simply invoke the [Save](https://reference.aspose.com/words/net/aspose.words/document/methods/save/index) method and specify a file name with the “.PNG” extension.

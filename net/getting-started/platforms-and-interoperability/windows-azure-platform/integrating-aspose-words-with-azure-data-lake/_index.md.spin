...
Aspose.Words can be integrated with the Microsoft Azure Data Lake services: Azure Data Lake Analytics (ADLA) and Azure Data Lake Storage (ADLS). This {allows|enables} you to combine the big data analytics capabilities of the Azure Data Lake cloud storage solution with the power of Aspose.Words, which {enables|allows} your applications to programmatically perform various document processing tasks, such as generating, modifying, rendering, reading, or converting documents between different formats.

This article explains how to configure a C# project in Visual Studio with ADLA, and provides an example that {demonstrates|shows} the integration of Aspose.Words and Azure Data Lake.
...
The following code example {shows|demonstrates} how to implement the IOutputter interface:
...
The following screenshot {shows|demonstrates} how the output document looks after executing the application.

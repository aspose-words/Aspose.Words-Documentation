...
type: docs
description: "Aspose.Words for .NET supports a wide range of formats for loading and saving documents. This {allows|enables} you to edit source documents in {many|multiple|several|a few|numerous} popular formats, as well as freely convert files from one format to another."
weight: 20
...
|[PDF](https://docs.fileformat.com/pdf/)|Saves the document as PDF (Adobe Portable Document) format.|{{< emoticons/tick >}}|{{< emoticons/tick >}}| |

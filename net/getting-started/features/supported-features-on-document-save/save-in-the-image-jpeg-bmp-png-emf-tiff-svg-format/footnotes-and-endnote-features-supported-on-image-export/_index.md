...
description: "Aspose.Words for .NET allows you to work with footnote and endnote features supported when saving to image formats: JPEG, BMP, PNG, TIFF, SVG, etc."
type: docs
weight: 60
url: /net/footnotes-and-endnote-features-supported-on-image-export/
aliases: [/net/footnotes-an-endnote-features-supported-on-image-export/]
---

...
There are save options to control how the document is rendered. There are often several special save options for each image format. For example there are options to:

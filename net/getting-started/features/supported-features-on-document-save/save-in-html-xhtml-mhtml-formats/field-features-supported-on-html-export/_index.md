...
description: "Aspose.Words for .NET allows you to work with field features supported when saving to HTML-based format."
type: docs
weight: 50
...
Fields such as FileName or FileSize are not automatically updated on save. However, they can be updated explicitly by calling the Document.UpdateFields.

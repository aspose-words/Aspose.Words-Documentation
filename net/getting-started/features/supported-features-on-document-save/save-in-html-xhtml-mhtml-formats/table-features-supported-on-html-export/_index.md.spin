...
|Borders|Yes|<p>Supported except for diagonal borders.</p><p>Exported as &lt;td&gt; style attribute border-XXX-style, border-XXX-width etc.</p><p>Not all line types are exported. For reference, many line types supported by Aspose.Words are mentioned below.</p><p>CSS - LineStyle</p><p>'solid' - LineStyle.Single</p><p>'dashed' - LineStyle.DashSmallGap</p><p>'dotted' - LineStyle.Dot</p><p>'double' - LineStyle.Double</p><p>'groove' - LineStyle.Emboss3D</p><p>'ridge' - LineStyle.Engrave3D</p><p>'none' - LineStyle.None</p>| |

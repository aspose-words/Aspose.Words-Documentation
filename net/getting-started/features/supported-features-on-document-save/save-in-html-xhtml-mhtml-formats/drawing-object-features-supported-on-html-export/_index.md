...
description: "Export to HTML-based format using drawing saving features in C#."
type: docs
weight: 40
...
|Wrap Sides|Yes|<p>Wrap sides are exported through the use of the float style attribute.</p><p>- Both sides and largest only wrap have no suitable analogue in HTML and are exported as float:left.</p><p>- Right side wrap is exported as float:left.</p><p>- Left side wrap is exported as float:right.</p>| |

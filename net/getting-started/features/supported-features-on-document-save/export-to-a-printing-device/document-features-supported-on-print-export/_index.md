...
There are save options to control how the document is rendered. There are often multiple special save options for each image format. For example there are options to:

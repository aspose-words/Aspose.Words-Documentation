...
The [TxtSaveOptions.ParagraphBreak](https://reference.aspose.com/words/net/aspose.words.saving/txtsaveoptionsbase/paragraphbreak/) property is used to define a custom character to use for a paragraph break in the output text. You can also use [TxtSaveOptions.PreserveTableLayout](https://reference.aspose.com/words/net/aspose.words.saving/txtsaveoptions/preservetablelayout/) property to add white space around tables to attempt to preserve table layout as seen in the source word document.

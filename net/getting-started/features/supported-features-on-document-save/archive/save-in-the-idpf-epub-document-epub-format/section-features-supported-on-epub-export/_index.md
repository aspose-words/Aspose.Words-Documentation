...
- [HtmlSaveOptions.ExportHeadersFootersMode](https://reference.aspose.com/words/net/aspose.words.saving/htmlsaveoptions/properties/exportheadersfootersmode)
...
Section formatting is exported using the "@page" identifier along with margin and size attributes that defines the appearance of the section as seen in the source document.

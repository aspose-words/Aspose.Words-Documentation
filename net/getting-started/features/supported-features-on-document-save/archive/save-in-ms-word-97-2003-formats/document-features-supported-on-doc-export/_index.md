---
title: DOC Export - Document Features
...
|Encryption |Yes |You can encrypt a DOC document on save by specifying the password using the DocSaveOptions class. |- [DocSaveOptions.Password](https://reference.aspose.com/words/net/aspose.words.saving/docsaveoptions/password/)|
|Font Table |Yes | | |

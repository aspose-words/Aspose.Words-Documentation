...
|Custom Payload Part |Yes |Only Custom Payload Parts that are attached to the root of the package are preserved on load. <br><br>Custom Parts can be accessed through the Aspose.Words API. |- [Document.PackageCustomParts](https://reference.aspose.com/words/net/aspose.words/document/packagecustomparts/)|
...
|Font Table |Yes | | |
|Glossary Document/Quick Parts/Auto Text |Yes |Glossary Document for DOCX is accessiable through the DOM. |- [Document.GlossaryDocument](https://reference.aspose.com/words/net/aspose.words/document/glossarydocument/)|
...
|Mail Merge Recipient Data |Yes | |- [Document.MailMergeSettings](https://reference.aspose.com/words/net/aspose.words/document/mailmergesettings/)|
...
|Access and Use Embedded Fonts |Yes |Embedded fonts in DOCX are preserved and can be accessed through the API. |<p>- [FontInfo](https://reference.aspose.com/words/net/aspose.words.fonts/fontinfo/) </p><p>- [FontInfo.GetEmbeddedFont](https://reference.aspose.com/words/net/aspose.words.fonts/fontinfo/getembeddedfont/)</p>|

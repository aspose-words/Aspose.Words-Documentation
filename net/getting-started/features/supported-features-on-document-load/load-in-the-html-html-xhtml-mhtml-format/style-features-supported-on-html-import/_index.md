...
A style allows you to define a set of formatting that can be reused on a few elements in a document. This saves time and enables for a more consistent formatting throughout your document.

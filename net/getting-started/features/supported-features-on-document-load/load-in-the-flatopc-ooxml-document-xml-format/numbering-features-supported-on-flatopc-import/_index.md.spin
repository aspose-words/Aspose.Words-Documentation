...
A list used in a document is actually made up of {many|multiple|several|a few|numerous} complex parts. List and their properties are fully supported by Aspose.Words. There are two main types of lists:

...
Office Open XML (OOXML) is the new XML-based format introduced in Microsoft Office 2007 applications. Office Open XML is a container format for many specialized XML-based markup languages. WordprocessingML is the markup language used by Microsoft Office Word to store its DOCX documents.
...
|Access and Use Embedded Fonts|Yes|Embedded fonts in DOCX are preserved and can be accessed through the API.|<p>- [FontInfo](https://apireference.aspose.com/words/net/aspose.words.fonts/fontinfo)</p><p>- [FontInfo.GetEmbeddedFont](https://apireference.aspose.com/words/net/aspose.words.fonts/fontinfo/methods/getembeddedfont)</p>|

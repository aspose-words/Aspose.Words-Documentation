...
- [Shape.TextBox](https://apireference.aspose.com/words/net/aspose.words.drawing/shape/properties/textbox.html)

|**Feature**|**Supported**|**Comment**|**See Also**|
| :- | :- | :- | :- |
|Text Direction |Yes | |- [TextBox.LayoutFlow](https://apireference.aspose.com/words/net/aspose.words.drawing/textbox/properties/layoutflow.html)|
...
|Internal Margins |Yes | |<p>- [TextBox.InternalMarginLeft](https://apireference.aspose.com/words/net/aspose.words.drawing/textbox/properties/internalmarginleft.html) </p><p>- [TextBox.InternalMarginRight](https://apireference.aspose.com/words/net/aspose.words.drawing/textbox/properties/internalmarginright.html) </p><p>- [TextBox.InternalMarginTop](https://apireference.aspose.com/words/net/aspose.words.drawing/textbox/properties/internalmargintop.html) </p><p>- [TextBox.InternalMarginBottom](https://apireference.aspose.com/words/net/aspose.words.drawing/textbox/properties/internalmarginbottom.html)</p>|
|Vertical Alignment |Yes | | |
|Resize To Fit Text |Yes | |- [TextBox.FitShapeToText](https://apireference.aspose.com/words/net/aspose.words.drawing/textbox/properties/fitshapetotext.html)|
...
|**Feature**|**Supported**|**Comment**|**See Also**|
| :- | :- | :- | :- |
|Linked |Yes |Note that Aspose.Words cannot update an OLE link. However you can modify a link only OLE object to point to a new location which can provide a partial way of changing OLE objects. <br><br>When such a document is saved and opened in Microsoft Word it will detect the change in link and prompt the user to update the linked object. This results in the linked object appearing in the document. <br><br>Such a tecnhique will only work for Word formats and if the document is opened in an editor which {allows|enables} to update OLE objects (such as Microsoft Word). If the link is changed and the document to a different format such as PDF then the original content will still appear in the output. |<p>- [OleFormat.IsLink](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/islink.html) </p><p>- [OleFormat.SourceFullName](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/sourcefullname.html)</p>|
|Embedded |Yes | | |
|Draw Aspect |Yes | | |
|Auto Update |Yes | |- [OleFormat.AutoUpdate](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/autoupdate.html)|
|Lock |Yes | |- [OleFormat.IsLocked](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/islocked.html)|
|Ole Object Data |Yes | |<p>- [OleFormat.GetOleEntry](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/getoleentry.html) </p><p>- **OleFormat.Save**</p>|
|Ole Object Picture |Yes | |- [OleFormat.OleIcon](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/oleicon.html)|
|Source Range |Yes | |- [OleFormat.SourceItem](https://apireference.aspose.com/words/net/aspose.words.drawing/oleformat/properties/sourceitem.html)|
...
- [Shape.ShapeType](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/shapetype.html)
- [Shape.IsTopLevel](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/istoplevel.html)
...
|Group Shape |Yes | |<p>- [GroupShape](https://apireference.aspose.com/words/net/aspose.words.drawing/groupshape.html) </p><p>- [Shape.IsGroup](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/isgroup.html)</p>|
|Drawing Canvas |Yes | | |
...
|Watermark |Yes |A watermark in a Microsoft Word document is actually a text shape or image centered in the middle of the page but in the header or footer. This {allows|enables} the watermark to appear behind all content and as faded. |- [How to Add a Watermark to a Document](/words/net/working-with-watermark/)|
...
- [Shape.Top](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/top.html)
- **Shape.Width**

|**Feature**|**Supported**|**Comment**|**See Also**|
| :- | :- | :- | :- |
|Inline |Yes | |- [Shape.IsInline](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/isinline.html)|
...
|Wrap Type |Yes | |- [Shape.WrapType](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/wraptype.html)|
|Wrap Sides |Yes | |- [Shape.WrapSide](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/wrapside.html)|
...
|Z-Order |Yes | |- [Shape.ZOrder](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/zorder.html)|
...
|Rotation |Yes | |- [Shape.Rotation](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/rotation.html)|
|Flip |Yes | |- [Shape.FlipOrientation](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/fliporientation.html)|
|Horizontal Alignment |Yes | |- **Shape.HorizontalAlignment**|
|Horizontal Position Relative To |Yes | |- [Shape.RelativeHorizontalPosition](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/relativehorizontalposition.html)|
|Vertical Alignment |Yes | |- [Shape.VerticalAlignment](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/verticalalignment.html)|
|Vertical Position Relative To |Yes | |- [Shape.RelativeVerticalPosition](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/relativeverticalposition.html)|
|Anchor Lock |Yes | |- [Shape.AnchorLocked](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/anchorlocked.html)|
|Allow Overlap |Yes | |- [Shape.AllowOverlap](https://apireference.aspose.com/words/net/aspose.words.drawing/shapebase/properties/allowoverlap.html)|

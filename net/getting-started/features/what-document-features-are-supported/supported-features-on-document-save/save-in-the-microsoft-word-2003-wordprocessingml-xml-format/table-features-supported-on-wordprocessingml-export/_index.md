...
[Jump to this location in the import section](/pages/createpage.action?spaceKey=wordsnet&title=WordML+Import&linkCreation=true&fromPageId=2595744)
...
|Table Style |Yes |Table styles are preserved when saving to WordML if the document loaded is an OOXML or WordML. <br><br>If imported from other formats then the table style is converted to direct formatting on save so all formatting is still preserved. | |

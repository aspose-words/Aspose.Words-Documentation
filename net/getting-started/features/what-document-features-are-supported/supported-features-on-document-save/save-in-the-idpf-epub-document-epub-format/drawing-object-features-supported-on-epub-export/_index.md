...
|Alternative text |Yes |Exported as "alt=xxxx" on an img element. | |
...
|Horizontal Alignment |Planned |Currently exported as an absolute position. This will be supported in a future version. <br><br>An alternative to achieve the same effect is to make the image inline in a paragraph and set the paragraph alignment to center. | |
...
|Gradient Fill |Yes |Gradient is rendered to a raster image. | |

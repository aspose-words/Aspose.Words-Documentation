...
Aspose.Words generates the XPS file (including subsetting TrueType fonts) completely on its own, without using any Windows or external libraries.
...
|Compatibility Options |N/A |Compatibility Options can influence how the document content appears. These properties are not supported upon rendering to XPS. | |
|Endnote Options |N/A | | |

---
title: Paragraph Features Supported on SWF Export
type: docs
weight: 80
url: /net/paragraph-features-supported-on-swf-export/
---

{{% alert color="primary" %}} 

Paragraphs with Heading styles can be exported to SWF so they appear in the document outline. There is a save option to control this.

See the following link in the documentation for further information:

- [SwfSaveOptions.HeadingsOutlineLevels](http://www.aspose.com/documentation/.net-components/aspose.words-for-.net/aspose.words.saving.swfsaveoptions.headingsoutlinelevels.html)

---
title: Annotation Features Supported on SWF Export
type: docs
weight: 10
url: /net/annotation-features-supported-on-swf-export/
---
...
Bookmarks are exported to SWF and can be made to appear the document outline by using the appropriate save option.

See the following link in the documentation for further information:

- [SwfSaveOptions.BookmarksOutlineLevel](http://www.aspose.com/documentation/.net-components/aspose.words-for-.net/aspose.words.saving.swfsaveoptions.bookmarksoutlinelevel.html)
...
##### **Comments**
Comments are exported to SWF.

In version 1.0 of comments rendering long or many comments are not truncated in SWF output.

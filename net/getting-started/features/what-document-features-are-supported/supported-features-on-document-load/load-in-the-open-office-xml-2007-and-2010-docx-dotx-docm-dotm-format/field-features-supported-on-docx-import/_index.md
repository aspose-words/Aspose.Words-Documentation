...
[Jump to this location in the export section](/pages/createpage.action?spaceKey=wordsnet&title=Field+Codes+Ooxml+Export&linkCreation=true&fromPageId=2595888)

{{% /alert %}} 
##### **Field Codes**
See the following links in the documentation for further information:

- [Working with Fields](/words/net/working-with-fields-html/)
...
|GreetingLine |Yes | | |
|If |Yes | | |
|MergeField |Yes | |- [How to Rename Merge Fields](/pages/createpage.action?spaceKey=wordsnet&title=How+to+Rename+Merge+Fields&linkCreation=true&fromPageId=2595888)|
|MergeRec |Yes | | |
|MergeSeq |Yes | | |
|Next |Yes | | |
|NextIf |Yes | | |
...
- [How to Replace or Modify Hyperlinks](/pages/createpage.action?spaceKey=wordsnet&title=How+to+Replace+or+Modify+Hyperlinks&linkCreation=true&fromPageId=2595888)

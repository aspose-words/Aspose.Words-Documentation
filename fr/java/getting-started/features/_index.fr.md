...
articleTitle: Caractéristiques prises en charge
linktitle: Caractéristiques prises en charge
...
La plupart des captures d'écran de cette section présentent des documents générés par Aspose.Words puis ouvert à la vue Microsoft Word et autres demandes.
...
|  :-  |  :-  |
| [Java](/words/java/supported-platforms/) | Aspose.Words pour Java est disponible pour Java 1.6, 1.7 et 1.8 et fonctionnera en tout lieu où Java est installé. |

## Formats de fichiers et conversions

{{% alert color="primary" %}}

De nombreux clients du monde entier comptent sur les caractéristiques complètes d'importation et d'exportation de documents fournies par Aspose.Words.

{{% /alert %}}

|  Fonctionnalité | Désignation des marchandises |
|  :-  |  :-  |
| Microsoft Word (DOC) ([Frais](/words/java/load-in-ms-word-97-2003-formats/) et [Enregistreur](/words/java/save-in-ms-word-97-2003-formats/)) | L'implémentation de format DOC la plus rapide et la plus complète que vous pouvez trouver. |
| Traitement de texteML (DOCX, XML) ([Frais](/words/java/load-in-the-open-office-xml-2007-and-2010-formats/) et [Enregistreur](/words/java/save-in-the-open-office-xml-docx-dotx-docm-dotm-format/)) | Aspose.Words fournit un support exhaustif OOXML, Flat OPC, et aussi Word 2003 XML. |
| Format de texte riche (RTF) ([Frais](/words/java/load-in-the-rich-text-format-1-9-rtf-format/) et [Enregistreur](/words/java/save-in-the-rich-text-format-1-9-rtf-format/)) | Support complet du format RTF pour interagir avec diverses applications. |
| HTML, XHTML et MHTML | [Chargeur](/words/java/load-in-the-html-html-xhtml-mhtml-format/) et [Enregistreur](/words/java/save-in-the-html-html-xhtml-mhtml-format/) HTML/XHTML pour une plus grande interopérabilité. Enregistrer comme MHTML est également disponible. |
| OpenDocument (ODT) | Aspose.Words peut [Frais](/words/java/load-in-the-opendocument-text-odt-ott-format/) et [Enregistreur](/words/java/save-in-the-opendocument-text-odt-ott-format/) les documents figurant dans `OpenDocument` Format texte (.odt). |
| [Format de document portable Adobe (PDF)](/words/java/save-in-the-adobe-portable-document-pdf-format/) | Convertissez tout document en PDF avec une grande fidélité. PDF/A est pris en charge. |
| Spécification du papier XML (XPS) ([Frais](/words/java/load-in-ms-word-2003-formats/) et [Enregistreur](/words/java/save-in-the-flatopc-ooxml-document-xml-format/)) | Convertir tout document en XPS avec une grande fidélité. |
| Texte simple (TXT) ([Frais](/words/java/load-in-the-plain-text-txt-format/) et [Enregistreur](/words/java/save-in-the-plain-text-txt-format/)) | Extraire facilement le texte en enregistrant au format texte simple. |
| [Édition numérique (EPUB)](/words/java/save-in-the-idpf-epub-document-epub-format/) | EPUB est un format populaire pour les livres électroniques. Vous pouvez convertir n'importe quel document Aspose.Words au format IDPF EPUB. |

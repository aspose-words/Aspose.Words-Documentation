...
description: "Aspose.Words pour Java est une bibliothèque logicielle conçue pour créer, modifier, convertir, rendre et imprimer des documents sans compter sur aucun autre logiciel."
type: docs
weight: 5
...
Généralités [Chargement, sauvegarde et conversion](/words/fr/java/loading-saving-and-converting/) avec [Formats de documents pris en charge](/words/fr/java/supported-document-formats/) permet aux utilisateurs de convertir des documents de [un format populaire](https://reference.aspose.com/words/java/com.aspose.words/loadformat/) à [another](https://reference.aspose.com/words/java/com.aspose.words/saveformat/), par exemple, de DOCX à PDF, JPEG, ou Markdown.

#### Document Object Model (DOM)

Accès programmatique à travers un riche API à tous les éléments du document et le formatage permet de créer, modifier, extraire, copier, diviser, rejoindre et remplacer le contenu du document. Pour en savoir plus dans la [Aspose.Words Document Object Model (DOM)](/words/fr/java/aspose-words-document-object-model/) Chapitre.

#### Rendus

Nous utilisons le terme [Rendus](/words/fr/java/rendering/) décrire le processus de conversion d'un document dans un format de fichier ou un support, paginé ou qui a le concept de pages.
...
Générer des documents ou des rapports à partir de zéro ou en remplissant des modèles avec des données provenant de sources de données ou d'objets commerciaux. Pour de plus amples renseignements sur la déclaration et la récupération des données dans les bases de données, voir le site Web suivant: [Mail Merge et rapports](/words/java/mail-merge-and-reporting/) et [LINQ Moteur de déclaration](/words/java/linq-reporting-engine/) Chapitres.
...
Pour dire simplement, si votre plate-forme peut exécuter standard <span notrans="<span notrans=" Java"=""></span>""> il peut courir Aspose.Words pour Java. Si votre application peut appeler standard Java <span notrans="<span notrans=" API"=""></span>""> vous n'aurez aucun problème à appeler Aspose.Words pour Java API de votre demande.
...
Bien qu'il y ait plus de 150 classes publiques et recensements dans <span notrans="<span notrans=" Aspose.Words"=""></span>""> la courbe d'apprentissage est minimale parce que Aspose.Words API a été soigneusement conçu en tenant compte des objectifs suivants:

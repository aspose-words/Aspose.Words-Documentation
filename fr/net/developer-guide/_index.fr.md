...
- [Mail Merge et rapports](https://docs.aspose.com/words/net/mail-merge-and-reporting/) – fournit des informations sur la génération de documents, tels que des rapports, des catalogues, des inventaires et des factures, à partir de modèles avec des champs mail merge.
- [Moteur de reporting LINQ](https://docs.aspose.com/words/net/linq-reporting-engine/) – fournit des informations sur la création de rapports à l'aide d'un ensemble étendu de fonctionnalités de reporting.

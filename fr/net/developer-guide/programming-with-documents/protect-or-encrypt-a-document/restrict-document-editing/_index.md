...
Aspose.Words vous permet de contrôler la manière dont vous restreignez le contenu à l'aide du paramètre d'énumération [ProtectionType](https://reference.aspose.com/words/net/aspose.words/protectiontype/). Cela vous permettra de sélectionner un type exact de protection tel que le suivant:
...
Aspose.Words vous permet de protéger vos documents des modifications en utilisant la méthode [Protect](https://reference.aspose.com/words/net/aspose.words/document/protect/#protect/). Cette méthode n'est pas une fonctionnalité de sécurité et ne crypte pas un document.

...
La classe [Document](https://reference.aspose.com/words/net/aspose.words/document/) fournit une propriété [FieldOptions](https://reference.aspose.com/words/net/aspose.words/document/fieldoptions/) qui contient des membres qui peuvent être utilisés pour contrôler la façon dont les champs sont mis à jour dans le document.

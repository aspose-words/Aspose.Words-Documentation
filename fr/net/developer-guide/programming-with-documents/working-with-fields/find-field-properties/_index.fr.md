...
Un champ inséré à l'aide de [DocumentBuilder](https://reference.aspose.com/words/net/aspose.words/documentbuilder/).[InsertField](https://reference.aspose.com/words/net/aspose.words/documentbuilder/insertfield/) renvoie un objet [Field](https://reference.aspose.com/words/net/aspose.words.fields/field/). Il s'agit d'une classe de façade qui fournit des méthodes utiles pour trouver rapidement certaines propriétés d'un champ.
...
Notez que si vous recherchez uniquement les noms des champs de fusion dans un document, vous pouvez utiliser la méthode [GetFieldNames](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/getfieldnames/) intégrée.

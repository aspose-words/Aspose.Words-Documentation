...
description: "Aspose.Words para Java é uma biblioteca de software projetada para criar, modificar, converter, renderizar e imprimir documentos sem confiar em qualquer outro software."
type: docs
weight: 5
...
Abrangente [Carregador, Salvar e conversor](/words/pt/java/loading-saving-and-converting/) com [Formatos de suporte](/words/pt/java/supported-document-formats/) permite aos usuários converter documentos de [um formato popular](https://reference.aspose.com/words/java/com.aspose.words/loadformat/) para [another](https://reference.aspose.com/words/java/com.aspose.words/saveformat/), por exemplo, de DOCX para PDF, JPEG ou Markdown.

#### Document Object Model (DOM)

Acesso programático através de um rico API para todos os elementos de documentos e formatação permite criar, modificar, extrair, copiar, dividir, juntar e substituir o conteúdo do documento. Saiba mais no [Aspose.Words Document Object Model (DOM)](/words/pt/java/aspose-words-document-object-model/) Secção.

#### Renderização

Usamos o termo [Renderização](/words/pt/java/rendering/) para descrever o processo de conversão de um documento em um formato de arquivo ou um meio, paginado ou que tem o conceito de páginas.
...
Gerar documentos ou relatórios do zero ou preenchendo modelos com dados de fontes de dados ou objetos de negócios. Para obter mais informações sobre relatórios e buscar dados de bancos de dados, consulte o [Mail Merge e Relatórios](/words/java/mail-merge-and-reporting/) e [LINQ Motor de relatório](/words/java/linq-reporting-engine/) seções.
...
Para colocá-lo simplesmente, se sua plataforma pode executar o padrão <span notrans="<span notrans=" Java"=""></span>, pode ser executado Aspose.Words para Java. Se o seu aplicativo pode chamar padrão Java <span notrans="<span notrans=" API"=""></span>, você não terá problemas para ligar Aspose.Words para Java API da sua aplicação.
...
Embora existam mais de 150 classes públicas e enumerações em <span notrans="<span notrans=" Aspose.Words"=""></span>, a curva de aprendizagem é mínima porque Aspose.Words API foi cuidadosamente projetado com os seguintes objetivos em mente:
...
[Document](https://reference.aspose.com/words/java/com.aspose.words/document/), [Paragraph](https://reference.aspose.com/words/java/com.aspose.words/paragraph/), [Bookmark](https://reference.aspose.com/words/java/com.aspose.words/bookmark/), [Range](https://reference.aspose.com/words/java/com.aspose.words/range/), [Section.PageSetup](https://reference.aspose.com/words/java/com.aspose.words/section/#getPageSetup) e [Paragraph.ParagraphFormat](https://reference.aspose.com/words/java/com.aspose.words/paragraph/#ParagraphFormat) são alguns dos Aspose.Words aulas. Ao mesmo tempo, Aspose.Words é bastante diferente da Microsoft Word Modelo de objeto em que representa um documento como uma árvore de objetos, mais como um XML DOM árvore. Se você trabalhou com qualquer XML DOM biblioteca, você vai achar que é fácil de entender e trabalhar com Aspose.Words.

## Preço e Políticas

Por favor, visite [Licenciamento e Subscrição](/words/pt/java/licensing/) página para informações sobre licenças e rever a [InformaÃ§Ãμes sobre Pricing](https://purchase.aspose.com/pricing/words/family/) página para detalhes sobre preços.

## Suporte técnico

Para mais informações sobre Aspose.Words suporte técnico, dar uma olhada no [Suporte para suporte técnico técnico](/words/pt/java/technical-support/).

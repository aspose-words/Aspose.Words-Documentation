...
type: docs
description: "Aspose.Words for C++ {allows|enables} you to load remote resources, that can be a reason of security risks. Take a look at common security issues and their solutions."
weight: 50
url: /cpp/web-applications-security-when-loading-external-resources/
---

By default, Aspose.Words for C++ can load remote resources such as images, CSS styles, or external HTML documents when importing documents or inserting images using the DocumentBuilder. This behavior {allows|enables} you to process your documents in full detail but can be a reason of some security risks if the library is a part of a web application.
...
The following code example {shows|demonstrates} how to disable external images loading:
...
The following code example {shows|demonstrates} how to disable remote resources:

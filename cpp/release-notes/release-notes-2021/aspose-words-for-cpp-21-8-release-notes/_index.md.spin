...
The new save option {allows|enables} to customize how the Lang entry should be exported. It can be useful for compatibility with some screen readers.
{{< highlight csharp >}}
/// <summary>
...
By default MS Word {allows|enables} to bind structured document tags to FlatOpc documents only. 
This option {allows|enables} to control this behavior and bind documents in any format.

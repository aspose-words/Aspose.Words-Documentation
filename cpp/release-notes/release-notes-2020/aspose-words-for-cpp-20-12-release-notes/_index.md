...
| WORDSNET-19312 | System.InvalidOperationException - too several styles in the document | Bug |
...
| WORDSNET-20910 | A long paragraph with shape near the bottom occupies a few pages | Bug |
...
/// When implemented, enables to override default comparison expressions evaluation for the <see cref="Aspose::Words::Fields::FieldIf">FieldIf</see> and <see cref="Aspose::Words::Fields::FieldCompare">FieldCompare</see> fields.
/// 

...
- We have moved common C++ dependencies into a separate package. It makes possible to use {several|multiple|a few|many|numerous} Aspose products in the same project.

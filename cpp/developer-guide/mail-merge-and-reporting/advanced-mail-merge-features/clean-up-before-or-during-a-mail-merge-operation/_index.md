...
Use the **CleanupOptions** property along with the [MailMergeCleanupOptions](https://reference.aspose.com/words/cpp/namespace/aspose.words.mail_merging#mailmergecleanupoptions) enumeration to set the removing option. Specify which items you want to remove by choosing the following options (you can combine more than one):

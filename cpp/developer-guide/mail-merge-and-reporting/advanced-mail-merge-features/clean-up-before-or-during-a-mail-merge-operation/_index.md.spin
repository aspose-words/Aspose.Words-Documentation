...
type: docs
description: "Aspose.Words for C++ {allows|enables} you to apply different cleaning and removing options such as deleting merge fields before performing a mail merge operation or removing unused regions during a mail merge operation."
...
You can download the sample file of this example from [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-C/blob/master/Data/Mail-Merge/MailMergeCleanUp.RemoveRowfromTable.docx).

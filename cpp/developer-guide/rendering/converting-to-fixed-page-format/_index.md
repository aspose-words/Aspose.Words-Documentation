...
![converting-to-fixed-page-format-aspose-words-cpp-1](converting-to-fixed-page-format_1.png)
...
![converting-to-fixed-page-format-aspose-words-cpp-2](converting-to-fixed-page-format_2.png)
...
- The number and range of pages contained in the output document ([PageIndex](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#a285f8d983f92466953a24c16c00ea14b), [PageCount](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#ac475196465c6f7ef7868f0884d44d22b)).
- Progress of page-by-page document saving ([PageSavingCallback](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#a0429001fdd2077ba739ac10f33d55e70)).
- A set of characters that are used to numbers rendering ([NumeralFormat](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#a342c8937835bd912528d137767001e22)).
- A metafile player ([MetafileRenderingOptions](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#a2bb0f4946fc21993f60e28b367c80c1f)). For more details, see the ["Handling Windows Metafiles"](/words/cpp/handling-windows-metafiles/) article.
- A quality rate for recompressing JPEG images, the value of which may differ slightly, depending on the selected save format ([JpegQuality](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#a97d6477b73da72eb08d9d68e61e464c6)).
- Optimization of vector graphics in Aspose.Words output ([OptimizeOutput](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#a5b5ba06ac381a275da60e5f7bfaf0fec)).
- Graphics options when saving to Tiff, Png, Bmp, Jpeg, Emf formats ([UseAntiAliasing](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.save_options/#ac07a919eda7dd3104c3539643caab82f), [UseHighQualityRendering](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.save_options/#a926127b8a13db96c893d2e327d1ac458)).
- Saving the document in grayscale ([ColorMode](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.fixed_page_save_options/#ac1a855cc8feceb3d1cbe331b282931ef)).
- Switching between the rendering of DrawingML shapes and fallback shapes ([DmlRenderingMode](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.save_options/#a40d3faab0e88622c6fac579bbc050772)).
- Switching between DML effects rendering modes ([DmlEffectsRenderingMode](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.save_options/#a0ad6a41669029f8bcb5d56ccd8eb1f25)).

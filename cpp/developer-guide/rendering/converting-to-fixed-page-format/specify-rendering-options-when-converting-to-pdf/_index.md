...
The example provided below demonstrates how to set Aspose.Words to avoid embedding core fonts and let the reader substitute them with PDF Type 1 fonts:

...
The [ExportDocumentStructure](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.pdf_save_options/#set_exportdocumentstructure) property {enables|allows} you to export document structure to PDF output.
...
You can also export headings in the output PDF, using the [HeadingsOutlineLevels](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.outline_options/#get_headingsoutlinelevels_const) property. This property specifies how {many|multiple|several|a few|numerous} levels of headings are included in the document outline.
...
The [EmbedFullFonts](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.pdf_save_options/#get_embedfullfonts_const) property {enables|allows} you to specify how Aspose.Words embeds fonts into an output PDF document.
...
- When saving with PDF/A-1 compliance, all used fonts must be embedded with the PDF document. When saving with this compliance, the [UseCoreFonts](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.pdf_save_options/#get_usecorefonts_const) property must be set to false and the [FontEmbeddingMode](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.pdf_save_options/#set_fontembeddingmode) property must be set to [EmbedAll](https://apireference.aspose.com/words/cpp/namespace/aspose.words.saving#pdffontembeddingmode95embedall)[.](http://www.aspose.com/api/net/words/aspose.words.saving/pdfsaveoptions/properties/usecorefonts)
...
The example provided below {shows|demonstrates} how to set Aspose.Words to avoid embedding core fonts and let the reader substitute them with PDF Type 1 fonts:

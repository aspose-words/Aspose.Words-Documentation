...
You can also export headings in the output PDF, using the [HeadingsOutlineLevels](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.outline_options/#get_headingsoutlinelevels_const) property. This property specifies how a few levels of headings are included in the document outline.

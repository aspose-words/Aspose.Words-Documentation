...
The shading texture is set with a [TextureIndex](https://apireference.aspose.com/words/cpp/namespace/aspose.words#textureindex) enumeration value that {allows|enables} the application of various patterns to the **Shading** object. For example, to set a background color for a document element, use the [TextureIndex.TextureSolid]https://apireference.aspose.com/words/cpp/namespace/aspose.words#textureindexae4cbed1cbf8df80d762b1bac0e7b1f8b) value and set the foreground shading color as appropriate. The code example given below {shows|demonstrates} how to apply borders and shading to a paragraph.

...
The code example given below {shows|demonstrates} how to Inserts a merge field into a document using DocumentBuilder.
...
The same technique is used to insert fields nested within other fields. The code example given below {demonstrates|shows} how to insert fields nested within another field using DocumentBuilder.
...
For more details, please refer to FieldMergeField Class API reference. The code example given below {shows|demonstrates} how to add a Merge Field using DOM to a paragraph in the document.
...
For more details, please refer to FieldAddressBlock Class API reference. The code example given below {shows|demonstrates} how to Add a Mail Merge Address Block Field using DOM to a Paragraph in Document.
...
For more details, please refer to FieldAdvance Class API reference. The code example given below {shows|demonstrates} how to Add an Advance Field using DOM to a Paragraph in Document.
...
For more details, please refer to [FieldAsk Class API reference](http://www.aspose.com/docs/display/wordsnet/Aspose.Words.Fields.FieldAsk+Class). The code example given below {shows|demonstrates} how to Add an ASK Field using DOM to a Paragraph in Document.
...
For more details, please refer to [FieldAuthor Class API reference](http://www.aspose.com/docs/display/wordsnet/Aspose.Words.Fields.FieldAuthor+Class). The code example given below {shows|demonstrates} how to Add an AUTHOR Field using DOM to a Paragraph in Document.
...
Please refer to FieldToa Class API reference. The code example given below {shows|demonstrates} how to Add a TOA field using DOM to a Paragraph in Document. 
...
If you want to insert untyped/empty fields ({}) just like MS Word allows, you can use DocumentBuilder.InsertField method with parameter FieldType.FieldNone. To insert a field in a Word document, you can press “Ctrl + F9” key combination. The code example given below {shows|demonstrates} how to insert an empty field in the document.

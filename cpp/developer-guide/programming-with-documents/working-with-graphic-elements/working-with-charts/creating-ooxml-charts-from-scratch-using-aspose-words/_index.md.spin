...
The code example given below {shows|demonstrates} how to insert a column chart.
...
The code example given below {shows|demonstrates} how to insert a scatter chart.

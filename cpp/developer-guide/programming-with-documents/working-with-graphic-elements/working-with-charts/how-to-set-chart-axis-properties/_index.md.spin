...
The following code example {shows|demonstrates} how to define X and Y-axis properties.
...
If you want to show or hide the chart axis, you can simply achieve this by setting the value of the set_Hidden property. The following code example {shows|demonstrates} how to hide the Y-axis of the chart. 

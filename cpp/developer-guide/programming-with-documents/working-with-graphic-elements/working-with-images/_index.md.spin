...
The code example given below {shows|demonstrates} how to extract images from a document and save them as files. You can download the template file of this example from here.

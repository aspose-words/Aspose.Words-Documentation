...
You can control the way of handling leading and trailing spaces during loading TXT file. The leading spaces could be trimmed, preserved or converted to indent and trailing spaces could be trimmed or preserved. Below code example {shows|demonstrates} how to trim leading and trailing spaces while importing TXT file.
...
If you want to export header and footer in output TXT document, you can use Options->set_ExportHeadersFootersMode property. This property specifies the way headers and footers are exported to the plain text format. Below code example {shows|demonstrates} how to export headers and footers to plain text format.

...
We use [Font](https://reference.aspose.com/words/cpp/class/aspose.words.font) formatting for inline blocks. When there is no direct correspondence for a Markdown feature in Aspose.Words DOM, we use a character style with a name that starts from some special words.
...
We use [Font](https://reference.aspose.com/words/cpp/class/aspose.words.font) formatting when translating **Bold**, *Italic* or ~~Strikethrough~~ inline markdown features.
...
| **Autolink**<br />`<scheme://domain.com>`<br />`<email@domain.com>` | The [FieldHyperlink](https://reference.aspose.com/words/cpp/class/aspose.words.fields.field_hyperlink) class. |
...
| **Link**<br />`[link text](url)`<br />`[link text](<url> "title")`<br />`[link text](url 'title')`<br />`[link text](url (title))` | The [FieldHyperlink](https://reference.aspose.com/words/cpp/class/aspose.words.fields.field_hyperlink) class. |
...
| **Image**<br />`![](url)`<br />`![alt text](<url> “title”)`<br />`![alt text](url ‘title’)`<br />`![alt text](url (title))` | The [Shape](https://reference.aspose.com/words/cpp/class/aspose.words.drawing.shape) class. |
...
| Markdown feature                         | Aspose.Words                                                 |
| ---------------------------------------- | ------------------------------------------------------------ |
| `Table`<br />`a|b`<br />`-|-`<br />`c|d` | [Table](https://reference.aspose.com/words/cpp/class/aspose.words.tables.table), [Row](https://reference.aspose.com/words/cpp/class/aspose.words.tables.row) and [Cell](https://reference.aspose.com/words/cpp/class/aspose.words.tables.cell) classes. |

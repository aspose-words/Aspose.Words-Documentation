...
The below code example {shows|demonstrates} how to create a new bookmark.
...
The below code example {shows|demonstrates} how to obtain bookmarks from a bookmark collection. You can download the template file of this example from here.
...
The below code example {shows|demonstrates} how to get or set bookmark name and text. You can download the template file of this example from here.
...
The below code example {shows|demonstrates} how to bookmark a table.

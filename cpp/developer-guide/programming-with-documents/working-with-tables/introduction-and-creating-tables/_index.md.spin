...
Below example {shows|demonstrates} how to make a clone of the last row of a table and append it to the table. You can download the template file of this example from here.
...
Aspose.Words supports inserting content into a document from an HTML source by using the DocumentBuilder.InsertHtml method. The input can be a full HTML page or just a partial snippet. Using this method we can insert tables into our document by using table elements e.g &lt;table&gt;, &lt;tr&gt;, &lt;td&gt;. Below example {shows|demonstrates} how to insert a table in a document from a string containing HTML tags.
...
| :- | :- | :- |
|DocumentBuilder (DocumentBuilder.StartTable)|The standard method of inserting tables and other document content.|Sometimes hard to create {many|multiple|several|a few|numerous} varieties of tables at the same time with the same instance of the builder.|

...
| :- | :- | :- |
|DocumentBuilder (DocumentBuilder.StartTable)|The standard method of inserting tables and other document content.|Sometimes hard to create multiple varieties of tables at the same time with the same instance of the builder.|

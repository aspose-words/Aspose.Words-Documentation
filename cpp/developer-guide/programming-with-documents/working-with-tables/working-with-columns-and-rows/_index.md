...
Below example demonstrates how to retrieve the index of a table in the document.
...
## Specify Rows to Repeat Them as Header Rows {#specify-rows-to-repeat-on-subsequent-pages-as-header-rows}

In Microsoft Word this option is found under Table Properties as *“Repeat row as a header on subsequent pages”.* Using this option you can choose to repeat only a single row or a few rows in a table.

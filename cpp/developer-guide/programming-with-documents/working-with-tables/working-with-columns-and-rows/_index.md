---
title: Working with Columns and Rows – Aspose.Words for С++
...
Below example autofits a table to fit the page width. You can download the template file of this example from [here](https://github.com/aspose-words/Aspose.Words-for-C/tree/master/Examples).

...
A generated PDF document can be signed during saving. Currently only PDF documents can be signed in the same way. Other formats are to be supported in future versions. The code sample below {shows|demonstrates} how to sign a generated PDF document using Aspose.Words.
...
The following code example {shows|demonstrates} how to sign the encrypted documents. 

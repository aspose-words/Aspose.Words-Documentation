...
Aspose.Words allows you to control the way you restrict the content using the [ProtectionType](https://reference.aspose.com/words/cpp/namespace/aspose.words#protectiontype) enumeration parameter. This will enable you to select an exact type of protection such as the following:
...
Aspose.Words allows you to protect your documents from changes using the [Protect](https://reference.aspose.com/words/cpp/class/aspose.words.document#protect_protectiontype) method. This method is not a security feature and does not encrypt a document.
...
Aspose.Words allows you to mark the parts that can be changed in your document using the [StartEditableRange](https://reference.aspose.com/words/cpp/class/aspose.words.document_builder#starteditablerange) and [EndEditableRange](https://reference.aspose.com/words/cpp/class/aspose.words.document_builder#endeditablerange) methods.

...
If you want Ole Object call DocumentBuilder.InsertOleObject. Pass to this method the ProgId explicitly with other parameters. The code example given below {shows|demonstrates} how to insert Ole Object into a document.
...
The following code example {shows|demonstrates} how to insert OLE Object as an icon. For this purpose, the DocumentBuilder class exposes the InsertOleObjectAsIcon method.
...
The following code example {demonstrates|shows} how to inserts an embedded OLE object as an icon from a stream into the document.

...
Use DocumentBuilder.InsertTextInput**,** DocumentBuilder.InsertCheckBox or DocumentBuilder.InsertComboBox to insert form fields into a document. The code example given below {shows|demonstrates} how to insert a combobox form field into a document.
...
A collection of form fields is represented by the FormFieldCollection class that can be retrieved using the Range.FormFields property. This means that you can obtain form fields contained in any document node including the document itself. The code example given below {shows|demonstrates} how to get a collection of form fields. You can download the template file of this example from here.
...
You can get a particular form field by its index or name. The code example given below {shows|demonstrates} how to access form fields. You can download the template file of this example from here.
...
The FormField properties allow you to work with form field name, type, and result. The code example given below {shows|demonstrates} how to work with form field name, type, and result. You can download the template file of this example from here.

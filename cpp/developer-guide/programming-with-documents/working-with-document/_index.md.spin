...
type: docs
description: "The Document class provides various document properties and methods. You use the Document class as the starting point for whatever you want to perform with Aspose.Words for C++. The Document object can be saved to a file or stream and also sent to a browser."
weight: 20
...
The **Document** object contains all content and formatting, styles, built-in and custom properties, and the [MailMerge](https://apireference.aspose.com/words/cpp/class/aspose.words.mail_merging.mail_merge) object that is used for a mail merge. **Document** {enables|allows} you to retrieve text, bookmarks, and form fields for the entire document or separate sections.

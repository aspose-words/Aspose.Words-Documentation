...
You can also use the [DuplicateStyle](https://reference.aspose.com/words/cpp/class/aspose.words.cleanup_options#get_duplicatestyle_const) property to substitute all duplicate styles with the original one and remove duplicates from a document.

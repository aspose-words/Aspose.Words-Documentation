...
type: docs
description: "Aspose.Words for C++ allows you to compare two documents in any supported formats and demonstrates content changes. You can apply advanced options when comparing."
weight: 50

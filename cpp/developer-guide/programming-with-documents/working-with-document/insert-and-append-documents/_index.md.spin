...
description: "Aspose.Words for C++ {allows|enables} you to combine documents into one: insert or append a document into a new or existing one using find and replace, merge field, bookmark, or simply at the document end."
type: docs
aliases:
...
The insert operation {allows|enables} you to insert the content of previously created documents into a new or existing one.

In turn, the append feature {allows|enables} you to add a document only at the end of another document.
...
The following code example {shows|demonstrates} how to create a handler for the replacing event to use it later in the inserting process:
...
The following code example {shows|demonstrates} how insert content of one document into another during a find and replace operation:
...
The following code example {shows|demonstrates} how to create a handler for the merging event to use it later in the inserting process:
...
The following code example {shows|demonstrates} how to insert a document into the merge field using the created handler:
...
The following coding example {shows|demonstrates} how to insert the contents of one document to a bookmark in another document:
...
The following code example {shows|demonstrates} how to append a document to the end of another document:
...
The following code example {shows|demonstrates} how to insert document content into another document using the **InsertDocument** method:
...
The following code example {shows|demonstrates} how to manually import nodes and insert them after a specific node using the **InsertAfter** method:
...
The following code example {shows|demonstrates} how to append one document to another while keeping the content from splitting across two pages:

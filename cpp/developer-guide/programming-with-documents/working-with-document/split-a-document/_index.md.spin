...
description: "Aspose.Words for C++ {allows|enables} you to split a document into {several|multiple|a few|many|numerous} files. Use the split feature to effectively split a document by headings or sections, as well as by pages or by page ranges."
type: docs
weight: 75
...
This section describes {several|multiple|a few|many|numerous} use cases of dividing documents by paged using the [Document](https://apireference.aspose.com/words/cpp/class/aspose.words.document) class and the **ExtractPages** method.

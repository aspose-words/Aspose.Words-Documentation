...
You can specify criteria using the [DocumentSplitCriteria](https://reference.aspose.com/words/cpp/namespace/aspose.words.saving#documentsplitcriteria) enumeration. So you can divide a document into chapters using one of the following criteria or combine more than one criteria together:
...
You cannot split a document using the [DocumentSplitCriteria](https://reference.aspose.com/words/cpp/namespace/aspose.words.saving#documentsplitcriteria) property when saving to MHTML format.
...
You can also split a document page by page, by page ranges, or starting with the specified page numbers. In such case the [ExtractPages](https://reference.aspose.com/words/cpp/class/aspose.words.document#extractpages_int_int) method can do the job.

This section describes several use cases of dividing documents by paged using the [Document](https://reference.aspose.com/words/cpp/class/aspose.words.document) class and the **ExtractPages** method.

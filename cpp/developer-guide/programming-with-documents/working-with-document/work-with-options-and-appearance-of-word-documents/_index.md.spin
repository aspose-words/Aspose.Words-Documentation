...
description: "Aspose.Words for C++ {allows|enables} you to control the appearance of Word documents taking into account the difference between various Microsoft Word versions."
type: docs
weight: 110
...
The [OptimizeFor](https://apireference.aspose.com/words/cpp/class/aspose.words.settings.compatibility_options#optimizefor_mswordversion) method {allows|enables} optimizing document content, as well as default Aspose.Words behaviour for a particular version of Microsoft Word. You can use this method to prevent Microsoft Word from displaying the “Compatibility mode” ribbon upon document loading. Note that you may also need to set the Compliance property to Iso29500_2008_Transitional or higher.

...
The code sample below {shows|demonstrates} how to access a section at the specified index. You can download the template file of this example from here.
...
If you want to copy and insert just the main text of a section excluding the section separator and section properties, use Section.PrependContent or Section.AppendContent passing a Section object for the content being copied. No new section is created; headers and footers are not copied. The former method inserts a copy of the content at the beginning of the section, while the latter inserts a copy of the content at the end of the section. The code sample below {shows|demonstrates} how to append content of an existing section. The number of sections in the document remains the same. You can download the template file of this example from here.
...
To delete the main text of a section, use Section.ClearContent. Below example {shows|demonstrates} how to delete main content of a section. You can download the template file of this example from here.
...
Use the Section.Clone method to create a duplicate of a particular section. Below example {shows|demonstrates} how to create a duplicate of a particular section. You can download the template file of this example from here.

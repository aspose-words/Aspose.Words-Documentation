...
description: "Aspose.Words for C++ {allows|enables} you to convert a document from almost any format to HTML or MHTML, as well as to EPUB format. You can also specify save options for managing the output document."
type: docs
weight: 20
...
Aspose.Words {allows|enables} converting a Word document to HTML using default or custom save options. Few examples of custom save options are described below.
...
Aspose.Words {allows|enables} converting a Word document into EPUB format using default or custom save options. You can specify a number of options by passing an instance of [HtmlSaveOptions](https://apireference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options) to the Save method.

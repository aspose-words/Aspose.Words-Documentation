...
For simple conversion to HTML, MHTML, or EPUB, one of the [Save](https://reference.aspose.com/words/cpp/class/aspose.words.document#save_stream_saveformat) method overloads is used. You can save the document to a file or stream and explicitly set the output document save format or define it from the file name extension.
...
Specifying the [ResourceFolder](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_resourcefolder_const) property is the simplest way to set the folder where all resources should be written. We can use individual properties, such as [FontsFolder](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_fontsfolder_const) which saves fonts to the specified folder and [ImagesFolder](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_imagesfolder_const) which saves images to a specified folder. When a relative path is specified, **FontsFolder** and **ImagesFolder** refer to the folder where the code assembly is located, **ResourceFolder** and [CssStyleSheetFileName](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_cssstylesheetfilename_const) refer to the output folder where the HTML document is located.
...
Using the [ResourceFolderAlias](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_resourcefolderalias_const) property, we can also specify the name of the folder used to construct URIs of all resources written into an HTML document. This is the simplest way to specify how URIs should be generated for all resource files. The same information can be specified for images and fonts separately via [ImagesFolderAlias](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_imagesfolderalias_const) and [FontsFolderAlias](https://reference.aspose.com/words/cpp/class/aspose.words.saving.html_save_options#get_fontsfolderalias_const) properties, respectively.

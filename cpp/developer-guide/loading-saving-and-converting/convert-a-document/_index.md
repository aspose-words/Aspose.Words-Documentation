...
The current section describes popular conversions, as well as ideas for working with some combinations of formats when loading and saving. Using the examples of this section, you can understand that the conversion process itself is quite universal, and there is no point in describing all the possible options, since there are a few hundred of them due to the large number of [formats supported by Aspose.Words for C++](https://docs.aspose.com/words/cpp/supported-document-formats/).

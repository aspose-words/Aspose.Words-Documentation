...
description: "Aspose.Words for C++ allows you to set advanced properties when loading a document. This allows you to more accurately control the load process."
type: docs
weight: 10

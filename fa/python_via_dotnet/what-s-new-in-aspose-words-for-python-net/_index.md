...
## Aspose.Words برای Python via .NET 24.1
...
## Aspose.Words برای Python via .NET 22.5، 22.6، 22.7، 22.8

Aspose.Words 22.5 پشتیبانی از فرمت های بارگیری جدید و اندازه صفحه چاپ جدید را معرفی می کند و همچنین برخی از گزینه های رندر را بهبود می بخشد.

Aspose.Words 22.6 امکانات تبدیل PDF به فرمت های دیگر و همچنین بهبود کار با DrawingML و جلوه پر کردن متن جامد را افزایش می دهد.

Aspose.Words 22.7 امکانات کار با ویژگی های رندر را افزایش می دهد و همچنین ویژگی های جدیدی را برای کار با واردات و صادرات HTML به PDF اضافه می کند.

Aspose.Words 22.8 فرمت صادراتی جدیدی را معرفی می کند و الگوریتم های مختلف رندر را بهبود می بخشد.

API برای توسعه انعطاف‌پذیرتر و راحت‌تر بهبود یافته است.

### فرمت های پشتیبانی شده

* پشتیبانی از بارگیری اسناد EPUB و XML با افزودن مقادیر جدید به شمارش **LoadFormat** معرفی شده است. با شروع از نسخه 22.5، امکان بارگیری اسناد EPUB و XML در مدل سند Aspose.Words و تبدیل آنها به هر [فرمت های سند پشتیبانی شده](/words/fa/python-net/supported-document-formats/) وجود دارد. <sup>22.5</sup>
* با شروع نسخه 22.8، می توان یک سند را با فرمت AZW3 ذخیره کرد - فرمت فایل کتاب الکترونیکی اختصاصی Amazon Kindle (KF8 نام دیگری برای قالب است). اکنون می توانید نه تنها اسناد AZW3 را بارگیری کنید، بلکه فایل های خود را به فرمت AZW3 که در اصل یک EPUB کامپایل شده است صادر کنید. <sup>22.8</sup>

### رندر و چاپ

#### اندازه چاپ جدید <sup>22.5</sup>

پشتیبانی از اندازه صفحه چاپ "پاکت شماره 10" با معرفی یک مقدار جدید به شمارش [PaperSize](https://reference.aspose.com/words/python-net/aspose.words/papersize/) اضافه شده است.

#### ارائه فرمول های MathML <sup>22.5</sup>

رندر کردن یک کادر حاشیه در اطراف فرمول‌های MathML و تشخیص فونت هنگام رندر کردن کاراکترها برای چنین فرمول‌هایی بهبود یافته است.

#### بهبود نمودار DML <sup>22.6</sup>

API عمومی نمودارهای DrawingML برای پشتیبانی از شیب، بافت و پرکردن الگو گسترش یافته است.

#### Glyph تشریح تجزیه و تحلیل برای OpenType <sup>22.7</sup>

تجزیه خطوط glyph خود Aspose.Words برای فونت های OpenType (CFF) پیاده سازی شده است.

پیش از این، تجزیه glyph برای فونت های OpenType (CFF) از طریق GDI+ انجام می شد. بنابراین اکنون در مواردی کار می‌کند که GDI+ در دسترس نباشد - پلتفرم‌های Java، .NET Standard، Linux، macOS، و غیره. Glyph در موارد خاصی مانند WordArt، جلوه‌های متنی، برخی از ویژگی‌های Office Math و موارد دیگر، به تجزیه و تحلیل رئوس مطالب نیاز است.

#### تنظیم Shape Shadow Formatting <sup>22.7</sup>

با افزودن ویژگی [shadow_format](https://reference.aspose.com/words/python-net/aspose.words.drawing/shapebase/shadow_format/) جدید، امکان تنظیم قالب بندی سایه شی شکل فراهم شده است.

#### پشتیبانی از فاصله سلولی در جداول <sup>22.8</sup>

موتور چیدمان اکنون به طور قابل توجهی بهبود یافته است: مکانیزم بسیار پیچیده فاصله سلولی در جداول پیاده سازی شده است.

#### جایگزینی فونت برای نمادها <sup>22.8</sup>

جایگزینی فونت برای نمادها بهبود یافته است.

#### الگوریتم چرخش برچسب محور نمودار <sup>22.8</sup>

الگوریتم چرخش برچسب های محور نمودار بهبود یافته است.

### بارگیری و ذخیره اسناد

#### بارگیری و تبدیل PDF به فرمت صفحه ثابت بدون Layout Model <sup>22.6</sup>

قابلیت بارگذاری و تبدیل اسناد PDF به فرمت های ثابت صفحه با دقت و کارایی بالا پیاده سازی شده است.

#### حالت واردات HTML جدید <sup>22.7</sup>

یک حالت واردات جدید HTML برای عناصر در سطح بلوک با افزودن یک مقدار جدید به شمارش [HtmlInsertOptions](https://reference.aspose.com/words/python-net/aspose.words/htmlinsertoptions/) معرفی شده است.

#### تبدیل به PDF/UA-1 مطابق با WCAG 2.0 <sup>22.7</sup>

پشتیبانی برای تبدیل یک سند به فرمت PDF/UA-1، مطابق با WCAG 2.0، اضافه شده است.

بنابراین، اگر مشتری یک سند Word قابل دسترسی داشته باشد و آن را از طریق Aspose.Words با ذکر مشخصات تبدیل به PDF/UA-1 تبدیل کند، خروجی با WCAG 2.0 سازگار خواهد بود.

WCAG یا دستورالعمل‌های دسترسی به محتوای وب مجموعه‌ای از دستورالعمل‌ها است که توسط W3C با همکاری افراد و سازمان‌ها در سراسر جهان توسعه یافته است. اکنون با Aspose.Words می توانید سند خود را به فرمت PDF/UA-1 خروجی تبدیل کنید، که برای ساخت اسناد PDF سازگار با WCAG 2.0 مناسب است.

شایان ذکر است که WCAG 2.0 دارای دو الزام اضافی است که در مشخصات PDF/UA-1 مشخص نشده اند:

- الزامات کنتراست
- الزامات برای برچسب گذاری محتوای چند رسانه ای

اما هر دو الزامات مربوط به مورد ما برای تبدیل از Word به PDF نیست.

### دیگر

به استثنای به ارث بردن اثر پر کردن متن جامد که رفتار MS Word را تقلید می کند، پیاده سازی شده است. <sup>22.6</sup>

{{% alert color="primary" %}}

درباره [یادداشت‌های انتشار Aspose.Words برای Python via .NET 22.5](/words/python-net/aspose-words-for-python-via-dotnet-22-5-release-notes/) بیشتر بدانید.

درباره [یادداشت‌های انتشار Aspose.Words برای Python via .NET 22.6](/words/python-net/aspose-words-for-python-via-dotnet-22-6-release-notes/) بیشتر بدانید.

درباره [یادداشت‌های انتشار Aspose.Words برای Python via .NET 22.7](/words/python-net/aspose-words-for-python-via-dotnet-22-7-release-notes/) بیشتر بدانید.

درباره [یادداشت‌های انتشار Aspose.Words برای Python via .NET 22.8](/words/python-net/aspose-words-for-python-via-dotnet-22-8-release-notes/) بیشتر بدانید.

{{% /alert %}}

## Aspose.Words برای Python via .NET 22.3، 22.4

Aspose.Words 22.3 امکانات کار با فرمت های PDF و TXT را گسترش می دهد و کار برخی از الگوریتم ها و موتورهای موجود را بهبود می بخشد.

Aspose.Words 22.4 قابلیت‌های PDF را افزایش می‌دهد - اکنون می‌توانید یک فایل را با فرمت PDF/A-4 ذخیره کنید و تعدادی پیشرفت دیگر در خروجی PDF دریافت کنید. در عین حال، Aspose.Words 22.4 توانایی‌های بیشتری را برای کار با نمودارهای DML، خواندن ابرداده‌های Photoshop و وارد کردن عناصر در سطح بلوک HTML فراهم می‌کند.

API برای توسعه انعطاف‌پذیرتر و راحت‌تر بهبود یافته است.

### ویژگی های پشتیبانی شده

با شروع Aspose.Words 22.4، پشتیبانی از Python 3.10 اضافه شده است.

### بهبود عملکرد

بارگیری یک حافظه پنهان جستجوی فونت ذخیره شده قبلی برای سرعت بخشیدن به فرآیند اولیه سازی حافظه پنهان فونت پس از رندر اجرا شده است. اکنون راه حل های شما حتی سریعتر کار خواهند کرد.

### فرمت های پشتیبانی شده

بارگیری یک سند با فرمت AZW3 (KF8 نام دیگری برای قالب است) اضافه شده است. اکنون می توانید یک سند AZW3 را بارگیری کرده و آن را به هر فرمت پشتیبانی شده دیگری تبدیل کنید.

### تفسیر

#### رندر کردن فرمول های MathML

رندر عملگرها در فرمول های MathML بهبود یافته است.

#### بهبود نمودار DML

بهبودهای زیر در نمودارهای DML انجام شده است:

* الگوریتم مقیاس بندی محور نمودار DML بهبود یافته است تا مانند MS Word باشد

* امکان دستکاری با ورودی های افسانه نمودار DrawingML ارائه شده است تا نمودار API ما را جامع تر و بیشتر کند
* قابلیت تعیین نام یک فایل xls/xlsx که نمودار DrawingML به آن پیوند داده شده است، اجرا شده است

#### ارائه به PDF با سازگاری PDF/A-4

رندر به PDF با سازگاری PDF/A-4 با افزودن مقادیر جدید به شمارش [PdfCompliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfcompliance/) - [PDF_A4](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfcompliance/#pdf_a4) اضافه شده است. این گزینه سطوح انطباق تجدید نظر شده را در نظر می گیرد: انطباق معمولی PDF/A-4 معادل سطح انطباق U نسخه های قبلی است و انطباق سطح A حذف می شود.

#### خواندن وضوح فراداده فتوشاپ در JPEG

خواندن رزولوشن ابرداده فتوشاپ در تصاویر JPEG برای رفع مشکل جالب مقیاس بندی نادرست تصاویر در هنگام رندر پیاده سازی شده است.

#### اجازه دهید متن لاتین در وسط یک کلمه پیچیده شود

پشتیبانی از ویژگی "اجازه دادن به متن لاتین برای قرار دادن در وسط یک کلمه" اجرا شده است تا پشتیبانی لاتین ما پس از رندر بهتر شود.

### بارگیری و ذخیره اسناد

#### کنترل رفتار سبک هنگام بارگیری یک سند

یک گزینه جدید [force_copy_styles](https://reference.aspose.com/words/python-net/aspose.words/importformatoptions/force_copy_styles/) برای کنترل رفتار سبک های متضاد هنگام وارد کردن سند معرفی شده است.

#### هنگام صادرات، شکل ها را به SVG تبدیل کنید

امکان تبدیل اشکال به تصاویر SVG پس از صادرات به HTML، MHTML یا EPUB با افزودن ویژگی [export_shapes_as_svg](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/export_shapes_as_svg/) فراهم شده است.

#### ذخیره در PDF 2.0 و بهبود در خروجی PDF

امکان ذخیره یک سند به عنوان PDF 2.0 با افزودن یک مقدار جدید به شمارش [PdfCompliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfcompliance/) و همچنین چندین بهبود درخواستی دیگر در خروجی PDF معرفی شده است.

#### حالت جدید واردات HTML

یک حالت واردات جدید برای عناصر در سطح بلوک HTML برای تقلید از رفتار Microsoft Word پیاده سازی شده است.

### دیگر

* امکان دریافت OOXML یک کنترل محتوا و ذخیره آن در رشته معرفی شده است.
* تشخیص پاورقی های غیر استاندارد در اسناد PDF هنگام واردات اضافه شده است.
* قابلیت دریافت اطلاعات فیلد سفارشی که با فیلد مرتبط است اضافه شده است.
* جدول مقایسه الگوریتم با تکیه بر تحلیل عمیق مکانیسم مقایسه Microsoft Word بهبود یافته است.
* نحو نظرات در موتور گزارش LINQ ارائه شده است.

{{% alert color="primary" %}}

درباره [یادداشت‌های انتشار Aspose.Words برای Python via .NET 22.3](/words/python-net/aspose-words-for-python-via-dotnet-22-3-release-notes/) بیشتر بدانید.

درباره [یادداشت‌های انتشار Aspose.Words برای Python via .NET 22.4](/words/python-net/aspose-words-for-python-via-dotnet-22-4-release-notes/) بیشتر بدانید.

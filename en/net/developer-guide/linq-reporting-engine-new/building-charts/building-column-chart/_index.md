...
description: "How to build a column chart using LINQ Reporting Engine in C#."
type: docs
weight: 10
...
After taking all the steps, LINQ Reporting Engine generates a column chart report as follows:\
\
<img src="column-chart-report.png"
  alt="Column chart report generated by LINQ Reporting Engine in C#."
  style="width:578px"/>

...
- La classe [VBAProject](https://reference.aspose.com/words/net/aspose.words.vba/vbaproject/) fornisce l'accesso alle informazioni sul progetto VBA
- La classe [VBAModuleCollection](https://reference.aspose.com/words/net/aspose.words.vba/vbamodulecollection/) restituisce la raccolta di moduli del progetto VBA
- La classe [VbaModule](https://reference.aspose.com/words/net/aspose.words.vba/vbamodule/) fornisce l'accesso al modulo di progetto VBA
- L'enumerazione [VbaModuleType](https://reference.aspose.com/words/net/aspose.words.vba/vbamoduletype/) definisce i tipi di un modello in un progetto VBA. Il modulo può essere un modulo procedurale, un modulo di documento, un modulo di classe o un modulo di progettazione

## Crea un progetto VBA

Aspose.Words API fornisce la proprietà [VbaProject](https://reference.aspose.com/words/net/aspose.words/document/vbaproject/) per ottenere o impostare VbaProject nel documento.
...
Il seguente esempio di codice mostra come modificare le macro VBA utilizzando la proprietà [SourceCode](https://reference.aspose.com/words/net/aspose.words.vba/vbamodule/sourcecode/):
...
Il seguente esempio di codice mostra come clonare il progetto VBA utilizzando la proprietà [Clone](https://reference.aspose.com/words/net/aspose.words.vba/vbaproject/clone/) che crea una copia del progetto esistente:
...
Il seguente esempio di codice mostra come clonare il modulo VBA utilizzando la proprietà [Clone](https://reference.aspose.com/words/net/aspose.words.vba/vbamodule/clone/) che crea una copia del progetto esistente:
...
Aspose.Words API fornisce la classe [VbaReferenceCollection](https://reference.aspose.com/words/net/aspose.words.vba/vbareferencecollection/) per funzionare con i riferimenti al progetto VBA che rappresentano una raccolta di riferimenti al progetto VBA.

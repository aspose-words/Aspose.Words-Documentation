...
L'esempio di codice seguente dimostra come inserire una filigrana di immagine in un documento definendo [ImageWatermarkOptions](https://reference.aspose.com/words/it/net/aspose.words/imagewatermarkoptions/) utilizzando il metodo [SetImage](https://reference.aspose.com/words/it/net/aspose.words/watermark/setimage/#setimage):
...
La classe [Watermark](https://reference.aspose.com/words/it/net/aspose.words/watermark/) fornisce il metodo di rimozione per rimuovere la filigrana da un documento.
...
Se le filigrane vengono aggiunte utilizzando l'oggetto classe [Shape](https://reference.aspose.com/words/it/net/aspose.words.drawing/shape/), per rimuovere la filigrana da un documento è necessario impostare solo il nome della forma della filigrana durante l'inserimento e quindi rimuovere la forma della filigrana con un nome assegnato.

...
L'utente può creare un nuovo stile e aggiungerlo alla raccolta di stili. Il metodo [Add](https://reference.aspose.com/words/net/aspose.words/stylecollection/add/) viene utilizzato per creare un nuovo stile di tabella.

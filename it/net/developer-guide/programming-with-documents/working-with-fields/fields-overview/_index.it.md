...
La classe [Document](https://reference.aspose.com/words/net/aspose.words/document/) fornisce una proprietà [FieldOptions](https://reference.aspose.com/words/net/aspose.words/document/fieldoptions/) che contiene membri che possono essere utilizzati per controllare il modo in cui i campi vengono aggiornati all'interno del documento.

...
*utilizzando [DocumentBuilder](https://reference.aspose.com/words/net/aspose.words/documentbuilder/)
*utilizzando [FieldBuilder](https://reference.aspose.com/words/net/aspose.words.fields/fieldbuilder/)
...
Se vuoi inserire campi non tipizzati/vuoti ({}) proprio come consente Microsoft Word, puoi utilizzare il metodo [InsertField](https://reference.aspose.com/words/net/aspose.words/documentbuilder/insertfield/) con il parametro [FieldType.FieldNone](https://reference.aspose.com/words/net/aspose.words.fields/fieldtype/). Per inserire un campo in un documento Word, puoi premere la combinazione di tasti "Ctrl + F9".
...
Il modo alternativo per inserire campi in Aspose.Words è la classe [FieldBuilder](https://reference.aspose.com/words/net/aspose.words.fields/fieldbuilder/). Fornisce un'interfaccia fluida per specificare le opzioni di campo e i valori degli argomenti come testo, nodi o anche campi nidificati.
...
Il campo `MERGEFIELD` nel documento Word può essere rappresentato dalla classe [FieldMergeField](https://reference.aspose.com/words/net/aspose.words.fields/fieldmergefield/). È possibile utilizzare la classe **FieldMergeField** per eseguire le seguenti operazioni:
...
Per maggiori dettagli vedere la classe [FieldMergeField](https://reference.aspose.com/words/net/aspose.words.fields/fieldmergefield/) API.
...
Per maggiori dettagli vedere la classe [FieldAddressBlock](https://reference.aspose.com/words/net/aspose.words.fields/fieldaddressblock/) API.
...
Per maggiori dettagli vedere la classe [FieldAdvance](https://reference.aspose.com/words/net/aspose.words.fields/fieldadvance/) API.
...
Per maggiori dettagli vedere la classe [FieldAsk](https://reference.aspose.com/words/net/aspose.words.fields/fieldask/) API.
...
Per maggiori dettagli vedere la classe [FieldAuthor](https://reference.aspose.com/words/net/aspose.words.fields/fieldauthor/) API.
...
Per maggiori dettagli vedere la classe [FieldIncludeText](https://reference.aspose.com/words/net/aspose.words.fields/fieldincludetext/) API.
...
Per maggiori dettagli vedere la classe [FieldToa](https://reference.aspose.com/words/net/aspose.words.fields/fieldtoa/) API.

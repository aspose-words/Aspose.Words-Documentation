...
Prima di immergerci nelle revisioni, spieghiamo il significato delle revisioni. Un [revision](https://reference.aspose.com/words/net/aspose.words/revision/) è una modifica che avviene in un nodo di un documento mentre un gruppo di revisione, rappresentato dalla classe [RevisionGroup](https://reference.aspose.com/words/net/aspose.words/revision/group/), è un gruppo di revisioni sequenziali che si verificano in molti nodi di un documento. Fondamentalmente, la revisione è uno strumento per tenere traccia delle modifiche.
...
Aspose.Words supporta diversi tipi di revisione, oltre che in Microsoft Word, come Inserimento, Eliminazione, FormatChange, StyleDefinitionChange e Moving. Tutti i tipi di revisione sono rappresentati con l'enumerazione [RevisionType](https://reference.aspose.com/words/net/aspose.words/revisiontype/).
...
Aspose.Words ti consente di verificare se un documento ha una revisione o meno utilizzando la proprietà [HasRevision](https://reference.aspose.com/words/net/aspose.words/document/hasrevisions/). Se non è necessario tenere traccia automaticamente delle modifiche nel documento tramite i metodi StartTrackRevisions e StopTrackRevisions, è possibile utilizzare la proprietà `TrackRevisions` per verificare se le modifiche vengono tracciate durante la modifica di un documento in Microsoft Word e archiviate come revisioni.

...
Passa un oggetto stream al metodo [Save](https://reference.aspose.com/words/net/aspose.words/document/save/). È necessario specificare esplicitamente il formato di salvataggio quando si salva in un flusso.

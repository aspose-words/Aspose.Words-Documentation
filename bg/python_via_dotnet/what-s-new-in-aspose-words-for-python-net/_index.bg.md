...
Научете повече за [Aspose.Words вместо .NET 23.12 Бележки за освобождаване](https://releases.aspose.com/words/python/release-notes/2023/aspose-words-for-python-via-dotnet-23-12-release-notes/).
...
- Нова функция за проверка, че даден списък е създаден от същия шаблон като списъка в сравнение е добавен чрез въвеждане на нов **HasSameTemplate** метод в [List](https://reference.aspose.com/words/python-net/aspose.words.lists/list/) Клас. <sup>22, 0</sup>

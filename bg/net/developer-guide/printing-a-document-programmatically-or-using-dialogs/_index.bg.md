...
От Aspose.Words може лесно да конвертира всеки документ в <span notrans="<span notrans=" XPS"=""></span>,"> Трябва само да напишете кода, който преминава XPS документ към `XpsPrint` API. Единственият проблем е, че `XpsPrint` API е неуправляем и изисква известно познание за технологията Platform Invoke.

...
Aspose.Words 24.8 въвежда персонализирано поставяне на етикети с данни, задвижван от Google AI превод на текст, подобрени опции за почистване на циркулярни документи и нови класове за обработка на LowCode.

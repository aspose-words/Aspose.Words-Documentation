...
- [Поддържани платформи](https://docs.aspose.com/words/java/platforms-and-interoperability/). Aspose.Words при изграждане на приложения за други платформи
...
- [Защо? Aspose.Words](https://docs.aspose.com/words/java/aspose-words-or-other-solutions/) Описва причините, поради които компонентите на базата са много по-добри от Microsoft Office Automation

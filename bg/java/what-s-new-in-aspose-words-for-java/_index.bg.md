...
## Aspose.Words вместо Java 24, 1, 24, 2, 24, 3
...
#### Чертежи на ML API Разширение <sup>24. 2 / 24. 3</sup>
...
* Възможност за промяна на текста на `TextBox` OLE контрол е въведен чрез добавяне на нов [Text](https://reference.aspose.com/words/java/com.aspose.words/textboxcontrol/#getText) собственост на новото [TextBoxControl](https://reference.aspose.com/words/java/com.aspose.words/textboxcontrol/) Клас. 24, 1 <sup>24, 1</sup>

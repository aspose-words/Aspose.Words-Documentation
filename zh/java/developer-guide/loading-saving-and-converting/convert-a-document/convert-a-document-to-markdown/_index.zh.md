---
title: 将文档转换为 Markdown 输入 Java
second_title: "Aspose.Words (单位:千美元) Java"
articleTitle: 将文档转换为 Markdown
linktitle: 将文档转换为 Markdown
type: docs
description: "用任何支持的负载格式将文档转换为 Markdown 而反之则使用 Java。 。 。 。"
...
Markdown 之所以如此流行,是因为使用这种格式很容易,而且可以相当简单地转换成其他格式。 为此, Aspose.Words 提供将文档转换到 [任何支持的负载格式](https://reference.aspose.com/words/java/com.aspose.words/loadformat/) 改为 Markdown 反之亦然 -- -- " Aspose.Words 也支持最受欢迎的 [保存格式](https://reference.aspose.com/words/java/com.aspose.words/saveformat/)。 。 。 。
...
Aspose.Words 提供使用 [MarkdownSaveOptions](https://reference.aspose.com/words/java/com.aspose.words/markdownsaveoptions/) 在将文档保存到 Markdown 格式。 除了其他继承或超载财产外,还有一些财产是专门针对 Markdown 还添加了格式。 例如, [TableContentAlignment](https://reference.aspose.com/words/java/com.aspose.words/tablecontentalignment/) 属性来控制表格中内容的对齐,或 [ImageSavingCallback](https://reference.aspose.com/words/java/com.aspose.words/markdownsaveoptions/#getImageSavingCallback) 和 [ImagesFolder](https://reference.aspose.com/words/java/com.aspose.words/markdownsaveoptions/#getImagesFolder) 来控制文档转换为 Markdown 格式。
...
* 缩进代码是样式名称中带有"缩进代码"的段落
*栅栏 代码是样式名称中带有"栅栏代码"的段落
...
* 页:1
* 页:1 `Table` 类
* 《大会正式记录,第五十八届会议,补编第5号》(A/C.6/61/Rev.1)。 链接作为 `FieldHyperlink` 类

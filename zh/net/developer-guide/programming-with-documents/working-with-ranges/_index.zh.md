...
Aspose.Words 还具有 [Range](https://reference.aspose.com/words/net/aspose.words/range/) 类，其设计的外观和行为与 Microsoft Word 中的 **Range** 类似。尽管 **Range** 无法覆盖文档的任意部分，并且没有 **Start** 和 **End**，但您可以访问任何文档节点（包括 [Document](https://reference.aspose.com/words/net/aspose.words/document/) 本身）覆盖的范围。换句话说，每个节点都有自己的范围。 **Range** 对象允许您访问和修改范围内的文本、书签和表单字段。

## 检索纯文本

使用 [Text](https://reference.aspose.com/words/net/aspose.words/range/text/) 属性检索范围内的纯文本、无格式文本。
...
Range允许通过调用[Delete](https://reference.aspose.com/words/net/aspose.words/range/delete/)来删除该范围内的所有字符。

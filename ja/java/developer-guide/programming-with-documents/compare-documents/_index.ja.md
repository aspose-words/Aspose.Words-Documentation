...
内の任意の二つの文書を比較することができることに注意してください [サポートされているファイル形式](/words/java/supported-document-formats/). 基本的に、ドキュメントオブジェクトを比較することができ、特定の形式を持たずにそれらのオブジェクトを最初から作成することもできます。

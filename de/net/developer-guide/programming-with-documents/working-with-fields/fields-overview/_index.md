...
Der Inhalt, aus dem der Feldcode besteht, wird als [Run](https://reference.aspose.com/words/net/aspose.words/run/)-Knoten zwischen [FieldStart](https://reference.aspose.com/words/net/aspose.words.fields/fieldstart/) und [FieldSeparator](https://reference.aspose.com/words/net/aspose.words.fields/fieldseparator/) gespeichert. Das Feldergebnis wird zwischen den **FieldSeparator**- und [FieldEnd](https://reference.aspose.com/words/net/aspose.words.fields/fieldend/)-Knoten gespeichert und kann aus verschiedenen Inhaltstypen bestehen. Normalerweise enthält das Feldergebnis nur Text, der aus **Run**-Knoten besteht. Es ist jedoch möglich, dass sich der **FieldEnd**-Knoten in einem völlig anderen Absatz befindet und das Feldergebnis somit auch aus [Logische Ebenen von Knoten in einem Dokument](/words/de/net/logical-levels-of-nodes-in-a-document/)-Knoten wie **Table** und **Paragraph**-Knoten besteht.
...
Die [Document](https://reference.aspose.com/words/net/aspose.words/document/)-Klasse stellt eine [FieldOptions](https://reference.aspose.com/words/net/aspose.words/document/fieldoptions/)-Eigenschaft bereit, die Mitglieder enthält, mit denen gesteuert werden kann, wie Felder im Dokument aktualisiert werden.

...
หากคุณยังไม่พบคำตอบสำหรับคำถามของคุณคุณสามารถถามในฟอรั่มการสนับสนุน สำหรับข้อมูลเกี่ยวกับวิธีการรายงานคำถามหรือปัญหาของคุณอย่างถูกต้องโปรดดูที่ [การสนับสนุนด้านเทคนิค](/words/cpp/technical-support/) เพจ.
...
Aspose.WordsสำหรับC++ ไม่จำเป็นต้องติดตั้งโปรแกรมของบุคคลที่สามหรือแพคเกจซอฟต์แวร์เพิ่มเติมในการทำงา เพียงแค่ดาวน์โหลดและติดตั้งAspose.Wordsตามที่อธิบายไว้ใน ["การติดตั้ง"](/words/cpp/installation/) บทความและเริ่มต้น.
...
สำหรับรายละเอียดโปรดดูที่ [ภาพรวมผลิตภัณฑ์](/words/cpp/product-overview/) เพจ.
...
คุณสามารถดูรายการที่สมบูรณ์ของรูปแบบที่สนับสนุนใน [รูปแบบเอกสารที่รองรับ](/words/cpp/supported-document-formats/) เพจ.
...
ดู [การออกใบอนุญาตและการสมัครสมาชิก](/words/cpp/licensing/) หน้าสำหรับข้อมูลเพิ่มเติม.
...
รายละเอียดเกี่ยวกับวิธีการติดตั้งAspose.Wordsสามารถอ่านได้บน [การติดตั้ง](/words/cpp/installation/) เพจ.

------

**ถาม:ฉันจะได้รับการสนับสนุนได้อย่างไร?**

ใช้ฟอรั่มการสนับสนุนทางเทคนิคฟรี สำหรับรายละเอียดเกี่ยวกับวิธีการรายงานปัญหาอย่างถูกต้องและสิ่งที่ต้องทำก่อนที่จะติดต่ [การสนับสนุนด้านเทคนิค](/words/cpp/technical-support/) เพจ.

## การแสดงผลเอกสาร

{{% alert color="primary" %}}

คุณสามารถค้นหาข้อมูลรายละเอียดเพิ่มเติมเกี่ยวกับการแสดงผลใน [การแสดงผล](/words/cpp/rendering/) ส่วนเอกสาร.

{{% /alert %}}

**ถาม:ทำไมเค้าโครงและแบบอักษรในเอกสารที่ส่งออกแตกต่างจากต้นฉบับ?**

แบบอักษรอาจไม่พร้อมใช้งานหรือสนับสนุนรูปแบบแบบอักษรโดยMicrosoft Wordแต่ไม่สนับสนุนโดยAspose.Words Aspose.Wordsจะดำเนินการ [การแทนที่แบบอักษร](/words/cpp/manipulate-and-substitute-truetype-fonts/).

เมื่อต้องการตรวจสอบว่าแบบอักษรหายไปหรือไม่:

- ในAspose.Wordsใช้คำเตือนการแทนที่แบบอักษร(สำหรับรายละเอียดให้ดูที่ส่วน"วิธีการรับรู้ว่าแบบอักษรถูกแทนที่"ของ [จัดการและแทนTrueTypeแบบอักษร](/words/cpp/manipulate-and-substitute-truetype-fonts/) ม).
...
คุณสามารถค้นหาข้อมูลรายละเอียดเพิ่มเติมเกี่ยวกับการเขียนโปรแกรมกับเอกสารใน [การเขียนโปรแกรมด้วยเอกสาร](/words/cpp/programming-with-documents/) ส่วนเอกสาร.
...
คุณสามารถค้นหาข้อมูลรายละเอียดเพิ่มเติมเกี่ยวกับการแปลงเอกสารใน [แปลงเอกสาร](/words/cpp/convert-a-document/) ส่วนเอกสาร.

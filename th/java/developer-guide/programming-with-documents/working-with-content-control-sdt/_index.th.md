...
ใน Microsoft Word, คุณสามารถสร้างแบบฟอร์มได้โดยเริ่มจากแม่แบบ และเพิ่มการควบคุมเนื้อหาได้ รวมถึง checkboxs, กล่องข้อความ, เลือกวันที่, และวางรายการ ใน <span notrans="<span notrans=" Aspose.Words"=""></span>'"> แท็กหรือเนื้อหาของเอกสารที่มีโครงสร้างหรือควบคุมจากเอกสารใด ๆ ที่ถูกโหลดเข้าไป Aspose.Words นําเข้ามาในรูปแบบโหนด DocumentTag แท็กของเอกสารที่ถูกคอมไพล์มา (SDT หรือ Control) อนุญาตให้มีการฝังโปรแกรมลูกข่ายที่กําหนดไว้ รวมถึงพฤติกรรมและรูปลักษณ์ ลงในเอกสารด้วย

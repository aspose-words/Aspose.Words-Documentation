...
โปรด สังเกต ว่า ตรง กัน ข้าม กับ <span notrans="<span notrans=" Microsoft Word"=""></span>'"> รูปแบบ PDF มีตัวเลือกจํากัดสําหรับแบบฟอร์มแก้ไขได้ เช่น กล่องคอมโบ และ checkbox Microsoft Word ตัว อย่าง เช่น มี รูป แบบ ต่าง ๆ มาก กว่า. โดย ทั่ว ไป แล้ว เป็น ไป ไม่ ได้ ที่ จะ เลียน แบบ เต็ม ที่ Microsoft Word พฤติกรรมใน PDF ดัง นั้น ใน บาง กรณี ที่ ค่อน ข้าง ซับ ซ้อน ผล งาน PDF อาจ ต่าง ไป จาก ที่ คุณ เห็น ใน Microsoft Word.

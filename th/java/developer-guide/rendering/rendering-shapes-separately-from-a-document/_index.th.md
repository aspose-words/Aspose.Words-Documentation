...
เมื่อทําการแปล **Shape**'"> มันจะต้องเป็นส่วนหนึ่งของการลําดับชั้นของเอกสาร ถ้า **Shape** ไม่ได้เป็นส่วนหนึ่งของต้นไม้ของเอกสารแล้วการแสดงผลที่แปลแล้วจะว่างเปล่าหลังจากการเชิญ **ShapeRenderer** วิธี

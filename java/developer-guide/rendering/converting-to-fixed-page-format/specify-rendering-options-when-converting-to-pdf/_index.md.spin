...
The [ExportDocumentStructure](https://apireference.aspose.com/words/java/com.aspose.words/pdfsaveoptions#ExportDocumentStructure) property {enables|allows} you to export document structure to PDF output.
...
The [EmbedFullFonts](https://apireference.aspose.com/words/java/com.aspose.words/pdfsaveoptions#EmbedFullFonts) property {enables|allows} you to specify how Aspose.Words embeds fonts into an output PDF document.

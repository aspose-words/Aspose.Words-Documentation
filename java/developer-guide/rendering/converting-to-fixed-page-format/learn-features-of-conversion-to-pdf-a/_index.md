...
description: "Aspose.Words for Java enables users to convert to PDF/A-1 and PDF/A-2. There are numerous problems when converting to PDF/A documents, and Aspose.Words for Java solves them."
type: docs
weight: 25
...
>
> * Strongly structured. The grouping elements nest to as several levels as necessary to reflect the organization of the material into articles, sections, subsections, and so on. At each level, the children of the grouping element should consist of a heading (H), one or more paragraphs (P) for content at that level, and perhaps one or more additional grouping elements for nested subsections.
>

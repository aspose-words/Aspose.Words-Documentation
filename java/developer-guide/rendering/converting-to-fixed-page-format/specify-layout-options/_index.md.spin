...
Aspose.Words {allows|enables} to manage formatting marks using the following properties:
...
The following code example {shows|demonstrates} how to customize revisions display:
...
The image below {shows|demonstrates} how Aspose.Words renders comments and the Delete revisions:
...
The [TextShaperFactory](https://apireference.aspose.com/words/java/com.aspose.words/ITextShaperFactory) property {enables|allows} you to set the text shaping functionality, as well as the OpenType features support.

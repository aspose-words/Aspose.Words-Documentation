...
description: "Aspose.Words for Java provides you with an efficient way to split one document into {multiple|several|a few|many|numerous} documents by headings or sections, as well as pages or page ranges."
type: docs
weight: 80
...
This section describes {several|multiple|a few|many|numerous} use cases of dividing documents by paged using the [Document](https://apireference.aspose.com/words/java/com.aspose.words/Document) class and the **ExtractPages** method.

...
The **Document** object contains all content and formatting, styles, built-in and custom properties, and the [MailMerge](https://apireference.aspose.com/words//java/com.aspose.words/mailmerge) object that is used for a mail merge. **Document** {enables|allows} you to retrieve text, bookmarks, and form fields for the entire document or separate sections.

...
type: docs
description: "Aspose.Words for Java enables you to find a string or regular expression pattern in your document and replace it with the text you want. In this case, you do not need third-party applications."
weight: 85
...
Aspose.Words provides numerous find and replace properties for ignoring text such as [IgnoreDeleted](https://apireference.aspose.com/words/java/com.aspose.words/findreplaceoptions#IgnoreDeleted), [IgnoreFields](https://apireference.aspose.com/words/java/com.aspose.words/findreplaceoptions#IgnoreFields), and [IgnoreInserted](https://apireference.aspose.com/words/java/com.aspose.words/findreplaceoptions#IgnoreInserted).
...
If you need to replace a string with an HTML tag, apply the **IReplacingCallback** interface to customize the find and replace operation so the match starts at the beginning of a run with the match node of your document. Let us provide numerous examples of using **IReplacingCallback**.

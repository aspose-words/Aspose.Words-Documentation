...
The answer is yes - it is possible and it is very easy, thanks to the ability to extend the mail merge process using event handlers. The [MailMerge](https://apireference.aspose.com/words/java/com.aspose.words/MailMerge) object provides the **MergeField** and **MergeImageField** event handlers.
...
This screenshot of Microsoft Word {shows|demonstrates} a template document with the merge fields: 
...
This screenshot of Microsoft Word {shows|demonstrates} the generated document. Note some fields were replaced with simple text, some fields were replaced with checkbox form fields and the Subject field was replaced with a text input form field.
...
The following code example {demonstrates|shows} how to set various image properties. 

...
The answer is yes - it is possible and it is very easy, thanks to the ability to extend the mail merge process using event handlers. The [MailMerge](https://reference.aspose.com/words/java/com.aspose.words/MailMerge) object provides the **MergeField** and **MergeImageField** event handlers.

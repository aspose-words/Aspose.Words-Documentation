...
Sometimes you need to add a group shape into a Word document. In Microsoft Word, you can quickly add a group shape using the Group command/button. A group shape consists of several shapes. Individual shapes in a group can be moved separately.

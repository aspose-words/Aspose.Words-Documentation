...
You can also use the [ListFormat.ListLevelNumber](https://reference.aspose.com/words/java/com.aspose.words/listformat/#getListLevelNumber) property to get or set the list level for the paragraph. The list levels are numbered 0 to 8.

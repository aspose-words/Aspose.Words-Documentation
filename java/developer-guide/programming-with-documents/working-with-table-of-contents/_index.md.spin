...
Aspose.Words allows you to completely update a TOC with only {a few|multiple|several|many|numerous} lines of code. This can be done to populate a newly inserted TOC or to update an existing TOC after changes to the document have been made.

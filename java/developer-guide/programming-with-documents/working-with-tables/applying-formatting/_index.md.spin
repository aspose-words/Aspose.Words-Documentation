...
The following code example {shows|demonstrates} how to apply an outline border to a table.
...
The following code example {shows|demonstrates} how to build a table with all borders enabled (grid).
...
The following code example {shows|demonstrates} how to modify the formatting of a table row.
...
The following code example {shows|demonstrates} how to modify the formatting of a table cell.
...
The following code example {shows|demonstrates} how to create a table that contains a single cell and apply row formatting.

...
The following code example {shows|demonstrates} how to create a simple table using DocumentBuilder with default formatting.
...
The following code example {shows|demonstrates} how to create a formatted table using DocumentBuilder.
...
The following code example {shows|demonstrates} how to insert a nested table using DocumentBuilder.
...
The following code example {shows|demonstrates} how to insert a table using the constructors of nodes.
...
The following code example {shows|demonstrates} how to make a clone of the last row of a table and append it to the table. You can download the template file of this example from [here](https://github.com/aspose-words/Aspose.Words-for-Java/blob/master/Examples/src/main/resources/Tables/Table.SimpleTable.doc).
...
Aspose.Words supports inserting content into a document from an HTML source by using the [DocumentBuilder.InsertHtml](https://apireference.aspose.com/words/java/com.aspose.words/documentbuilder#insertHtml(java.lang.String)) method. The input can be a full HTML page or just a partial snippet. Using this method we can insert tables into our document by using table elements e.g &lt;table&gt;, &lt;tr&gt;, &lt;td&gt;. Below example {shows|demonstrates} how to insert a table in a document from a string containing HTML tags.
...
The following code example {shows|demonstrates} how to replace all instances of a string of text in a table and cell.

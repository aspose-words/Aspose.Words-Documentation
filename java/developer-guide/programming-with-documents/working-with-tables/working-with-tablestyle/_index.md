---
title: Working with Table Styles – Aspose.Words for Java
...
In Aspose.Words you can apply a table style by using any of the [Table.getStyle()](https://apireference.aspose.com/words/java/com.aspose.words/Table#getStyle\(\)), [Table.setStyleIdentifier(int)](https://apireference.aspose.com/words/java/com.aspose.words/table#setStyleIdentifier\(int\)) and [Table.getStyleName()](https://apireference.aspose.com/words/java/com.aspose.words/table#getStyleName\(\)) properties. You can also choose which features of the table style to apply, for example, first column, last column, banded rows. These are listed under the TableStyleOptions enumeration and are applied by using [Table.setStyleOptions(int)](https://apireference.aspose.com/words/java/com.aspose.words/table#setStyleOptions\(int\)) property. The TableStyleOptions enumeration allows a bitwise combination of these features. Below example shows how to build a new table with a table style applied.

...
The following code example {shows|demonstrates} how to insert a paragraph into the document.
...
The following code example {shows|demonstrates} how to insert page breaks into a document.
...
Pass a single string representing a file that contains the image to DocumentBuilder.insertImage to insert the image into the document as an inline graphic. The following code example {shows|demonstrates} how to insert an inline image at the cursor position into a document.
...
The following code example {shows|demonstrates} how to insert a bookmark into a document using a document builder.
...
Form fields are a particular case of Word fields that {allows|enables} "interaction" with the user. Form fields in Microsoft Word include textbox, Combobox and checkbox.DocumentBuilder provides special methods to insert each type of form field into the document: [DocumentBuilder.insertTextInput](https://apireference.aspose.com/words/java/com.aspose.words/documentbuilder/methods/insertTextInput\(java.lang.String,int,java.lang.String,java.lang.String,int\)/) , [DocumentBuilder.insertCheckBox](https://apireference.aspose.com/words/java/com.aspose.words/documentbuilder/methods/insertCheckBox\(java.lang.String,boolean,boolean,int\)/), and {{DocumentBuilder.insertComboBox}} (https://apireference.aspose.com/words/java/com.aspose.words/documentbuilder/methods/insertComboBox(java.lang.String,java.lang.String\[\],int)/). Note that if you specify a name for the form field, then a bookmark is automatically created with the same name.

### Inserting a Text Input

DocumentBuilder.insertTextInput to insert a textbox into the document. The following code example {shows|demonstrates} how to insert a text input form field into a document.
...
Call DocumentBuilder.insertCheckBox to insert a checkbox into the document. The following code example {shows|demonstrates} how to insert a checkbox form field into a document.
...
Call DocumentBuilder.insertComboBox to insert a combo box into the document. The following code example {shows|demonstrates} how to insert a combo box form field into a document.
...
If you want Ole Object call [DocumentBuilder.insertOleObject](https://apireference.aspose.com/words/java/com.aspose.words/documentbuilder/methods/insertOleObject\(java.lang.String,java.lang.String,boolean,boolean,java.awt.image.BufferedImage\)/). Below example {shows|demonstrates} how to insert Ole Object into a document.
...
OLE package is a legacy and "undocumented" way to store embedded objects if the OLE handler is unknown. Early Windows versions such as Windows 3.1, 95 and 98 had Packager.exe application which could be used to embed any type of data into the document. Now, this application is excluded from Windows but MS Word and other applications still use it to embed data if the OLE handler is missing or unknown. OlePackage class {allows|enables} accessing OLE Package properties.The following code example {shows|demonstrates} how to set the file name, extension and display name for OLE Package.

{{< gist "aspose-words-gists" "827e71ccc0b8516a3cfe247b86ce6d4e" "Examples-src-main-java-com-aspose-words-examples-programming_documents-document-DocumentBuilderInsertElements-InsertOleObjectwithOlePackage.java" >}}

## Get Access to OLE Object Raw Data

The following code example {demonstrates|shows} how to get OLE Object raw data using OleFormat.GetRawData() method.

{{< gist "aspose-words-gists" "827e71ccc0b8516a3cfe247b86ce6d4e" "Examples-src-main-java-com-aspose-words-examples-programming_documents-document-DocumentBuilderInsertElements-GetAccessToOLEObjectRawData.java" >}}

## Insert Horizontal Rule into Document

The following code example {shows|demonstrates} how to insert horizontal rule shape into a document using DocumentBuilder.InsertHorizontalRule method.

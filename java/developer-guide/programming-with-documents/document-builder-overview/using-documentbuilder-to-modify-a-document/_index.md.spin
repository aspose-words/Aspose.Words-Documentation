...
| :- |
The following code example {shows|demonstrates} how to set font formatting.
...
| :- |
The following code example {shows|demonstrates} how to create a table that contains a single formatted cell.
...
| :- |
The below code example {shows|demonstrates} how to create a table that contains a single cell and apply row formatting.
...
The following code example {shows|demonstrates} how to build a multilevel list.
...
| :- |
The following code example {shows|demonstrates} how to set such properties as page size and orientation for the current section.
...
| :- |
The following code example {shows|demonstrates} how to apply a paragraph style.
...
The shading texture is set with a [TextureIndex](http://www.aspose.com/api/java/words/com.aspose.words/constants/TextureIndex) enumeration value that {allows|enables} the application of various patterns to the **Shading** object. For example, to set a background color for a document element, use the [TextureIndex.TextureSolid](http://www.aspose.com/api/java/words/com.aspose.words/constants/TextureIndex) value and set the foreground shading color as appropriate.

|![borders-and-shading-aspose-words-java](http://i.imgur.com/RDPc5fw.png)|
| :- |
The below example {shows|demonstrates} how to apply borders and shading to a paragraph.
...
The following code example {shows|demonstrates} how to move a cursor position to just after the bookmark end.
...
**ConvertUtil** is very useful when setting different page properties because for instance inches are more usual measurement units than points. The following example {demonstrates|shows} how to set up the page properties in inches.

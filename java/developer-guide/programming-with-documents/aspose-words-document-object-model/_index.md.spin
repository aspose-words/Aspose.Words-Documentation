...
You can remove a node from its parent by calling the [Remove](https://apireference.aspose.com/words/java/com.aspose.words/node#remove()) method.The following code example {shows|demonstrates} how to access the parent node:

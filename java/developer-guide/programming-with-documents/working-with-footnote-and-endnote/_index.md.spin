...
You can set the number of footnote layout columns using FootnoteOptions.Columns property. If this property has the value of 0, the footnotes area is formatted with a number of columns based on the number of columns on the displayed page. The code example given below {shows|demonstrates} how to set the number of columns for the footnote layout.
...
The footnote position can be at the bottom of each page or beneath the text on each page. The endnote position can be at the end of the section or at the end of the document. The following code example {shows|demonstrates} how to set the position of footnote and endnote.

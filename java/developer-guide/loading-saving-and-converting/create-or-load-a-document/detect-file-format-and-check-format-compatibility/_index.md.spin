...
description: "Aspose.Words for Java {allows|enables} you to obtain information about the document format before opening it to avoid an exception if you are not sure what the actual content of the file is."
type: docs
weight: 20

...
description: "Aspose.Words for Java {allows|enables} you to convert any document to the MHTML format and then send it by e-mail using one more Aspose family product."
type: docs
weight: 30
...
The following code example {shows|demonstrates} how to convert any document to MHTML and send it by email:

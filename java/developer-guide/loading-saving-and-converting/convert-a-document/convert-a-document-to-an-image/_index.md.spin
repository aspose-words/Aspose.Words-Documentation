...
type: docs
description: "Aspose.Words for Java {allows|enables} you to convert a document to any supported image format, such as JPEG or PNG, to create a document preview or create a document scan to send an invoice."
weight: 35
...
The following code example {shows|demonstrates} how to convert DOCX to JPEG:

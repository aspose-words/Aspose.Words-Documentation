...
Also, the engine enables you to use anonymous types in template expressions. Such types are useful while composing expressions with grouping by a few keys. See “Appendix A. Enumeration Extension Methods” for the examples.

...
A single `item` tag causes addition of a single combobox or dropdown list item during runtime. You can add many combobox or dropdown list items using several `item` tags as shown in the following snippet.

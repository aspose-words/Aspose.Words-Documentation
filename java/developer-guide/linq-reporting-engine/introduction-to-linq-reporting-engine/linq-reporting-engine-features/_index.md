...
LINQ Reporting Engine allows you to build reports in a similar way as Aspose.Words Mail Merge does. The engine provides the API that allows you to populate template documents with data that comes from various sources.

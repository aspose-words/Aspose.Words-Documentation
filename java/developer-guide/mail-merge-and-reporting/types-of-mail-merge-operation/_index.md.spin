...
Once your template is ready, you can start performing the simple mail merge operation. Aspose.Words {allows|enables} you to execute a simple mail merge operation using different [Execute methods](https://apireference.aspose.com/words/java/com.aspose.words/mailmerge#execute(com.aspose.words.IMailMergeDataSource)) that accept various data objects as the data source.

The following code example {shows|demonstrates} how to execute a simple mail merge operation using one of the [Execute](https://apireference.aspose.com/words/java/com.aspose.words/mailmerge#execute(java.lang.String[],java.lang.Object[])) method:
...
In Aspose.Words, the standard mail merge operation fills only a single document with content from your data source. So, you will need to execute the mail merge operation {multiple|several|a few|many|numerous} times to create {multiple|several|a few|many|numerous} merged documents as an output.

The following code example {shows|demonstrates} how to generate {multiple|several|a few|many|numerous} merged documents during a mail merge operation:
...
Aspose.Words {allows|enables} you to execute mail merge with regions using different [Execute methods](https://apireference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/methods/executewithregions/index) that accept various data objects as the data source.
...
The following code example {shows|demonstrates} how to execute mail merge with regions using the [ExecuteWithRegions(DataSet)](https://apireference.aspose.com/words/java/com.aspose.words/mailmerge#executeWithRegions(com.aspose.words.net.System.Data.DataSet)) method:

...
The most common example of a nested mail merge is an order that contains numerous items where you need to link many data tables and present the information in a template.

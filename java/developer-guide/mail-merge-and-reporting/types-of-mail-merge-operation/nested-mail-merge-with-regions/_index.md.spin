...
type: docs
description: "Aspose.Words for Java {allows|enables} you to perform a mail merge operation with nested regions. Nested merge is a feature that {enables|allows} you to merge hierarchical data from your data source into your merge template."

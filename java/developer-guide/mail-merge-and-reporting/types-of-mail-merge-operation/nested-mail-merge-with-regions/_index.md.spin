...
The most common example of a nested mail merge is an order that contains many items where you need to link a few data tables and present the information in a template.

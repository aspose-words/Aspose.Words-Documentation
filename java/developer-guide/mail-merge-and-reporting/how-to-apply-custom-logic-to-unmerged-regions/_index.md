...
![todo:image_alt_text](how-to-apply-custom-logic-to-unmerged-regions_1.png)

As a quick demonstration, we can execute a sample database on the sample document with the [MailMergeCleanupOptions.REMOVE_UNUSED_REGIONS](http://www.aspose.com/api/java/words/com.aspose.words/constants/MailMergeCleanupOptions) flag enabled. This property will automatically remove unmerged regions from the document during mail merge.
...
![todo:image_alt_text](how-to-apply-custom-logic-to-unmerged-regions_2.png)
...
![todo:image_alt_text](how-to-apply-custom-logic-to-unmerged-regions_3.png)
...
![todo:image_alt_text](how-to-apply-custom-logic-to-unmerged-regions_4.png)
...
![todo:image_alt_text](how-to-apply-custom-logic-to-unmerged-regions_5.png)
...
![todo:image_alt_text](how-to-apply-custom-logic-to-unmerged-regions_6.png)

...
Added predefined font fallback settings for Google Noto fonts. These are free fonts licensed under [SIL OFL](https://scripts.sil.org/OFL). They can be downloaded [from here](https://fonts.google.com/noto).

...
|WORDSNET-8582 |Extensive use of Frames in DOCX causes {many|multiple|several|a few|numerous} formatting issues in EPUB |Bug |
...
|WORDSNET-8275 |Text inside FORMDROPDOWN is not wrapping to {multiple|several|a few|many|numerous} lines in PDF |Feature |

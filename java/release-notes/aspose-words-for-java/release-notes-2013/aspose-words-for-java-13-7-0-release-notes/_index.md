...
|WORDSNET-8582 |Extensive use of Frames in DOCX causes multiple formatting issues in EPUB |Bug |
...
|WORDSNET-8275 |Text inside FORMDROPDOWN is not wrapping to numerous lines in PDF |Feature |

...
WORDSNET-6352 A table with too numerous columns cannot be opened when saving to Word formats.
...
WORDSNET-6467 Appending documents into empty (new Document()) stretches the contents of one page into numerous pages.

...
|WORDSNET-10255 |Saving a DOC {multiple|several|a few|many|numerous} times corrupts Table layout |Bug |
...
|WORDSNET-10475 |A Word is rendered in {multiple|several|a few|many|numerous} SPAN tags in HtmlFixed |Bug |

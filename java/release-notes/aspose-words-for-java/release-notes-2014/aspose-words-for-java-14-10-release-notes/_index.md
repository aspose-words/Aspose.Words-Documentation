...
|WORDSNET-10200 |Issue with MailMerge.ExecuteWithRegions when used with numerous same tables |Bug |
...
|WORDSNET-10274 |A Table moves down to the page which causes numerous more layout issues in PDF |Enhancement |
...
|WORDSNET-9927 |Mail merge with regions do not work when several TableStart/TableEnd exists in one Paragraph |Exception |

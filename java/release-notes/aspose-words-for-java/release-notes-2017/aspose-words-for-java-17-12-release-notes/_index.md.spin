...
This page contains release notes for [Aspose.Words for Java 17.12](https://repository.aspose.com/repo/com/aspose/aspose-words/17.12/)
...
|WORDSNET-16085|Word {shows|demonstrates} "Unknown" filename in Rename Package dialog.|Bug|
...
public class ChartAxis
{
    ...
    /// <summary>
    /// Returns a ChartNumberFormat object that {allows|enables} defining number formats for the axis.
    /// </summary>

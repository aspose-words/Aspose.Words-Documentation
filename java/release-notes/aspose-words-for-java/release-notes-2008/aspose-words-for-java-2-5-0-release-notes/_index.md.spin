...
The changes are not likely to affect {many|multiple|several|a few|numerous} users. Even if you cannot recompile your project because of a change, it is very easy to update your code because all changes are cosmetic, although they had to be done.

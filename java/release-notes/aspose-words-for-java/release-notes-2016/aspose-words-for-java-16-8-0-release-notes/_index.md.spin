...
- New base class FixedPageSaveOptions added for all fixed page formats e.g. PNG, PDF, HTML and multiple others.
...
|WORDSNET-13188|Extract several duplicate options from Fixed-page based save formats to one abstract class.|Enhancement|

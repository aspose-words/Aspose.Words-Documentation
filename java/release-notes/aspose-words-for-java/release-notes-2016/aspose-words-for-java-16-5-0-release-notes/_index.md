...
|WORDSNET-13538|Provide ReportingEngine.buildReport overload that accepts numerous data source objects|Feature|
...
It allows using a few data source objects while building a report.

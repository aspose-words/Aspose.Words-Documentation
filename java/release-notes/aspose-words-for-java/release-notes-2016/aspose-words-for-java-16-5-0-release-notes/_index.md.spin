...
- Added explicit support of {multiple|several|a few|many|numerous} data sources to LINQ Reporting Engine.
...
|WORDSNET-13538|Provide ReportingEngine.buildReport overload that accepts {multiple|several|a few|many|numerous} data source objects|Feature|
...
/// <remarks>
/// <para>
/// Using this overload you can reference {multiple|several|a few|many|numerous} data source objects and their members in the template.

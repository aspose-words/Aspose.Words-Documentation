...
[Aspose.Words for Java ](http://www.aspose.com/java/word-component.aspx)is an advanced class library for Java that {enables|allows} you to perform a great range of document processing tasks directly within your Java applications.

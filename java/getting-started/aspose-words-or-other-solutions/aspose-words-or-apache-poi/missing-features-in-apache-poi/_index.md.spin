...
description: "Aspose.Words for Java {allows|enables} to perform some operations with documents faster and more conveniently than Apache POI. In addition, there are operations that are not supported by Apache POI."
type: docs
weight: 20
...
| Join {multiple|several|a few|many|numerous} documents, including combine formatting of documents when importing content | The [“Insert and Append Documents”](/words/java/insert-and-append-documents/) article |

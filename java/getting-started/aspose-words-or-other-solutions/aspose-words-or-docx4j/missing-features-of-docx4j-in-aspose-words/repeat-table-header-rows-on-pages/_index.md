...
description: "Aspose.Words for Java enables to repeat a header row of a table on every page. Docx4j does not provide an opportunity to work with a header row."
type: docs
weight: 10

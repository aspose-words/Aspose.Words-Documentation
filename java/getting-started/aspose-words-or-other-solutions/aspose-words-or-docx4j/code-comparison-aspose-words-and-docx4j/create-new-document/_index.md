...
// Aspose.Words supports saving any document in several more formats.
doc.save("Aspose_NewDoc.docx",SaveFormat.DOCX);
{{< /highlight >}}

## docx4j - Create New Document

Creates a WordprocessingML document from scratch and show numerous different ways of adding basic content.

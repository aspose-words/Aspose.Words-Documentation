---
title: Generator or Producer Name Included in Output Documents – Aspose.Words for Java
...
|XamlFixed| `<!-- Generated by Aspose.Words for Java YY.M.N -->`<br />For example,<br />`<!-- Generated by Aspose.Words for Java 21.1.0 -->` | .xml file contains this comment. You can open it in Notepad to see this comment. |
...
|HtmlFixed| `<meta name="generator" content="Aspose.Words for Java YY.M.N" />`<br />For example,<br />`meta name="generator" content="Aspose.Words for Java 21.1.0" />` | HTML file contains this tag. You can open it in Notepad to see. |

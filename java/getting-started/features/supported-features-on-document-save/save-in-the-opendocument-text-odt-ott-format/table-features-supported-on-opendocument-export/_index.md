...
description: "Aspose.Words for Java allows you to work with table features supported when saving to OpenDocument Text format."
type: docs
weight: 120
url: /java/table-features-supported-on-opendocument-export/
---

{{% alert color="primary" %}}

[Jump to this location in the import section](/words/java/table-features-supported-on-opendocument-import/)
...
| :- | :- | :- | :- |
|Cell Margins|Yes| | |
|Borders|Yes|Diagonal borders are not saved to ODT. <br><br>Dashed, shadow and triple lines appear differently when saved to ODT.| |

...
description: "Aspose.Words for Java allows you to work with section features supported when saving to XPS format."
type: docs
weight: 100
...
|Line Numbering |Yes | | |
|Paper Source |Yes |The appropriate paper source from each section is exported to XPS using PrintTicket |<p>- **PageSetup.FirstPageTray** </p><p>- **PageSetup.OtherPageTray**</p>|
|Paper Size |Yes | | |
|Orientation |Yes | | |
|Protection |N/A | | |
|Text Direction |Yes | | |

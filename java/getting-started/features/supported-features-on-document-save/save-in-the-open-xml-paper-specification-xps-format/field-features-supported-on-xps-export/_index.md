...
description: "Aspose.Words for Java allows you to work with field features supported when saving to XPS format."
type: docs
weight: 50
...
|Bibliography |Yes | | |
|Citation |N/A | | |
|Hyperlink |Yes |Output to XPS as a clickable hyperlink. | |
|IncludePicture |Yes | | |
|IncludeText |Yes | | |
|Link |Yes | | |
|NoteRef |Yes |Exported as clickable link in XPS output. | |
|PageRef |Yes | | |
|Quote |Yes | | |

---
title: Document Features Supported on WordprocessingML Export – Aspose.Words for Java
...
description: "Aspose.Words for Java allows you to work with document features supported when saving to XML – Word 2003 WordprocessingML format."
type: docs
weight: 30
url: /java/document-features-supported-on-wordprocessingml-export/
---
...
|Variables |Yes | | |
|VBA Project (Macro) |Yes |VBA Projects are preserved during open and save to different formats that support them. <br><br>WordML format supports macros. You can optionally remove existing macros from a document by using the Document.RemoveMacros method. |- **Document.RemoveMacros**|

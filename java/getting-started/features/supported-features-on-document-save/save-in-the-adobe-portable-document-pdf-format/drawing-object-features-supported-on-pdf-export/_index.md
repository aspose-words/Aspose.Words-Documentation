...
|PNG |Yes | | |
|JPG |Yes | | |
|WMF |Yes |There is a save option to control exporting metafiles to PDF as vector images or to rasterize them first. |- [PdfSaveOptions.MetafileRenderingMode](https://reference.aspose.com/words/java/com.aspose.words/PdfSaveOptions)|
|EMF |Yes | | |
|EMF+ |Yes | | |
|BMP |Yes | | |
|GIF |Yes | | |

...
description: "Work with annotation features supported when saving to FlatOPC – XML format."
type: docs
weight: 10
...
[Jump to this location in the import section](/words/java/annotation-features-supported-on-flatopc-import/)

---
title: FIPS Mode
description: "Aspose.Words for Java uses multiple cryptography and hash algorithms when processing documents to comply with FIPS standards."
type: docs
weight: 80
url: /java/fips-mode/
---

Aspose.Words uses many cryptography and hash algorithms when processing documents and this article describes how it is related to the FIPS standards.

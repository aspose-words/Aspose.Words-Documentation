...
A style allows you to define a set of formatting that can be reused on a few elements in a document. This saves time and allows for more consistent formatting throughout your document.

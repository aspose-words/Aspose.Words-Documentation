...
A style allows you to define a set of formatting that can be reused on {many|multiple|several|a few|numerous} elements in a document. This saves time and allows for more consistent formatting throughout your document.

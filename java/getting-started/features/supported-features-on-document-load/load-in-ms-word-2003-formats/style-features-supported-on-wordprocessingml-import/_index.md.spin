...
type: docs
weight: 100
url: /java/style-features-supported-on-wordprocessingml-import/
---

{{% alert color="primary" %}} 

A style {allows|enables} you to define a set of formatting that can be reused on {many|multiple|several|a few|numerous} elements in a document. This saves time and {allows|enables} for more consistent formatting throughout your document.

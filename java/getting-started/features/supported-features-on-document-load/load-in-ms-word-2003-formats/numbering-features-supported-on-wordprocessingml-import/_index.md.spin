...
type: docs
weight: 70
url: /java/numbering-features-supported-on-wordprocessingml-import/
---

{{% alert color="primary" %}} 

A list used in a document is actually made up of {many|multiple|several|a few|numerous} complex parts. List and their properties are fully supported by Aspose.Words.

...
[Jump to this location in the export section](/words/java/annotation-features-supported-on-wordprocessingml-export/)
...
The range of a comment can span over various parts of the document text, including over {many|multiple|several|a few|numerous} paragraphs and tables.
...
- [How to Extract or Remove Comments](/words/java/working-with-document/#workingwithdocument-managetrackingchanges)
- **Comment**
- **Comment.Id**

...
description: "Import HTML-based document using paragraph load options in Java."
type: docs
weight: 80
...
|Space After |Yes |Imported from "margin-bottom" style attribute. <br><br>If this attribute is missing from a paragraph during import from HTML then Space After is set to Auto. |- **ParagraphFormat.SpaceAfter**|
|Space Auto |Yes |Paragraphs imported from HTML without margin-top or margin-bottom style attributes are imported as Auto spacing by default. |<p>- **ParagraphFormat.SpaceBeforeAuto** </p><p>- **ParagraphFormat.SpaceAfterAuto**</p>|

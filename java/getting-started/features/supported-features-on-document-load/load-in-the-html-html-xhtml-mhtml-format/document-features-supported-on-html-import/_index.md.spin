...
Aspose.Words supports most CSS 1 and CCS 2 properties that have an equivalent use in Word documents. Note that several classes on a single class attribute are currently not supported during import.

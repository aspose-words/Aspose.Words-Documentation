...
Office Open XML (OOXML) is the new XML-based format introduced in Microsoft Office 2007 applications. Office Open XML is a container format for multiple specialized XML-based markup languages. WordprocessingML is the markup language used by Microsoft Office Word to store its DOCX documents.
...
| :- | :- | :- | :- |
|Attached Template|Yes|The attached template is used to reference styles and other settings through the use of a separate document template. <br><br>The link to this template is imported from the source document and can be found in the API as the Document.AttachedTemplate property.|- **Document.AttachedTemplate**|
...
- [Protecting Document](/words/java/working-with-document/#workingwithdocument-protectingdocuments)
- **Document.Protect**
- **Document.Unprotect**

---
title: Drawing Object Features Supported on SWF Export
type: docs
weight: 40
url: /java/drawing-object-features-supported-on-swf-export/
---
...
|Group Shape |Yes | | |
|Drawing Canvas |Yes | | |
|Signature Line |N/A |SWF does not have any signature line feature. A signature line is exported as a regular image. <br><br>Only the original part of the signature is exported, any signed component of the signature is not rendered. | |
...
|Hyperlink on Shape |Yes |Hyperlink exported when saving to SWF format. | |
...
|Color |Yes | | |
|Alignment |Yes | | |
|Hyperlink |Yes |Hyperlink preserved on export to SWF format. | |
|Image |Yes | | |

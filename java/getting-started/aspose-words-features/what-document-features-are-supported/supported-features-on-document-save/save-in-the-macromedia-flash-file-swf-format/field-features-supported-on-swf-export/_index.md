---
title: Field Features Supported on SWF Export
type: docs
weight: 50
url: /java/field-features-supported-on-swf-export/
---
...
|Symbol |Yes | | |
##### **Form Fields**
Form fields are exported as static text/image.
...
|TOC (Table of Contents) |Yes |The \h switch on TOC can be used to export the TOC as hyperlinked to SWF. | |
|XE |N/A | | |
...
|Bibliography |Yes | | |
|Citation |N/A | | |
|Hyperlink |Yes |Output to SWF as a clickable hyperlink. | |
|IncludePicture |Yes | | |
|IncludeText |Yes | | |
|Link |Yes | | |
|NoteRef |Yes |Exported as clickable link in SWF output. | |
|PageRef |Yes | | |
|Quote |Yes | | |
|Ref |Yes |Exported as clickable link in SWF output. | |
|StyleRef |Yes | | |
##### **Mail Merge**
...
|UserName |Yes | | |
##### **Hyperlinks**
Exported as clickable hyperlink in SWF format.

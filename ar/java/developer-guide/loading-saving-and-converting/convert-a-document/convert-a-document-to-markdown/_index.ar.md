...
لتحويل وثيقة إلى <span notrans="<span notrans=" Markdown"=""></span>" أنت فقط بحاجة إلى تحميل وثيقة في أي شكل مدعم أو إنشاء واحدة جديدة من الناحية البرنامجية. إذن عليك أن تنقذ الوثيقة Markdown شكل
...
* ♪ SetextHeading that allows you to create multi-line headings in <span notrans="<span notrans=" Markdown"=""></span>" في حين أن العناوين العادية في Markdown يمكن أن يكون خط واحد فقط. (ستيكست هيدينغ) مبني على أسلوب "الرأس ن" و مستوىه لا يمكن إلا أن يكون 1 أو 2. إن كان (ن) في "مديرة" أكبر من 2 أو مساوياً لـ2، فـ "سيكست هيدينغ" المقابل مبني على "هيدينغ 2"

...
- [Mail Merge and Reporting](https://docs.aspose.com/words/java/mail-merge-and-reporting/) - تقديم معلومات عن إعداد الوثائق، مثل التقارير، والكتالوجات، وقوائم الجرد، والفواتير، من النماذج mail merge الحقول
- [LINQ FOR](https://docs.aspose.com/words/java/linq-reporting-engine/) - تقديم معلومات عن تقارير البناء باستخدام مجموعة واسعة من سمات الإبلاغ.

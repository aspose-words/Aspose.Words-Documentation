...
إذا لم تجد إجابة لسؤالك، يمكنك أن تسأل في منتدى الدعم. للحصول على معلومات حول كيفية الإبلاغ عن سؤالك أو مشكلتك بشكل صحيح، راجع [الدعم الفني](/words/cpp/technical-support/) الصفحة.
...
Aspose.Words ل C++ لا تحتاج إلى تثبيت أي تطبيقات طرف ثالث أو حزم برامج إضافية للعمل. مجرد تحميل وتثبيت Aspose.Words كما هو موضح في ["التثبيت"](/words/cpp/installation/) المادة وتبدأ.
...
لمزيد من التفاصيل، راجع [نظرة عامة على المنتج](/words/cpp/product-overview/) الصفحة.
...
يمكنك رؤية القائمة الكاملة للتنسيقات المدعومة على [تنسيقات المستندات المدعومة](/words/cpp/supported-document-formats/) الصفحة.
...
انظر ال [الترخيص والاشتراك](/words/cpp/licensing/) الصفحة لمزيد من المعلومات.
...
تفاصيل حول كيفية تثبيت Aspose.Words يمكن قراءتها على [تركيب](/words/cpp/installation/) الصفحة.

------

**س: كيف يمكنني الحصول على الدعم?**

استخدم منتدى الدعم الفني المجاني. للحصول على تفاصيل حول كيفية الإبلاغ عن مشكلة بشكل صحيح وما يجب القيام به قبل الاتصال بالمنتدى، راجع [الدعم الفني](/words/cpp/technical-support/) الصفحة.

## تقديم وثيقة

{{% alert color="primary" %}}

يمكنك العثور على مزيد من المعلومات التفصيلية حول العرض في [تقديم](/words/cpp/rendering/) قسم التوثيق.

{{% /alert %}}

**س: لماذا يختلف التخطيط والخطوط في مستند الإخراج عن الأصل?**

قد لا يكون الخط متاحا، أو أن تنسيق الخط مدعوم بـ Microsoft Word ولكن غير مدعوم بـ Aspose.Words. Aspose.Words سوف تؤدي [استبدال الخط](/words/cpp/manipulate-and-substitute-truetype-fonts/).

للتحقق مما إذا كان الخط مفقودا:

- في Aspose.Words استخدم تحذيرات استبدال الخط (للحصول على التفاصيل، راجع قسم " كيفية التعرف على استبدال الخط [التلاعب واستبدال TrueType الخطوط](/words/cpp/manipulate-and-substitute-truetype-fonts/) المادة).
...
يمكنك العثور على مزيد من المعلومات التفصيلية حول البرمجة مع المستندات في [البرمجة مع الوثائق](/words/cpp/programming-with-documents/) قسم التوثيق.
...
يمكنك العثور على مزيد من المعلومات التفصيلية حول تحويل مستند في [تحويل مستند](/words/cpp/convert-a-document/) قسم التوثيق.

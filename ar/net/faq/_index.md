...
تتطلب بعض خطوط البرامج النصية المعقدة معالجة ميزات الطباعة المتقدمة لعرضها بشكل صحيح. يتم تعطيل الطباعة المتقدمة في Aspose.Words افتراضيًا. يتعين على المستخدمين تمكين الطباعة المتقدمة باستخدام [TextShaperFactory](https://reference.aspose.com/words/net/aspose.words.layout/layoutoptions/textshaperfactory/).
...
* التحقق من تحميل البيانات بشكل صحيح في الجداول: قم بتعيين [TableName](https://reference.aspose.com/words/net/aspose.words.mailmerging/imailmergedatasource/tablename/) بشكل صحيح مع جميع المفاتيح والعلاقات الأساسية المطلوبة.
* تأكد من تسمية حقول الدمج بشكل صحيح. استخدم طريقة [GetFieldNames](https://reference.aspose.com/words/net/aspose.words.mailmerging/mailmerge/getfieldnames/) للحصول على جميع أسماء حقول الدمج والتأكد من تطابق اسم حقول الدمج في القالب الخاص بك مع الاسم الموجود في مصدر البيانات الخاص بك.
...
تظهر نتيجة الإلحاق على صفحة منفصلة بسبب الاختلاف في إعدادات [PageSetup](https://reference.aspose.com/words/net/aspose.words/pagesetup/) للأقسام التي يتم فيها إلحاق المستندات معًا. قم بإجراء إعدادات **PageSetup** متطابقة للأقسام التي يتم فيها إلحاق المستندات معًا.

...
في Aspose.Words، يتم تمثيل الحقول بمساحة الاسم [Fields](https://reference.aspose.com/words/net/aspose.words.fields/). تشرح المقالات الموجودة في قسم التوثيق هذا كيفية استخدام فئات Aspose.Words لمعالجة حقول المستند برمجيًا.
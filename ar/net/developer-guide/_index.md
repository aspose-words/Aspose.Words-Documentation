...
- [Mail Merge وإعداد التقارير](https://docs.aspose.com/words/net/mail-merge-and-reporting/) - يوفر معلومات حول إنشاء المستندات، مثل التقارير والكتالوجات وقوائم الجرد والفواتير، من القوالب التي تحتوي على حقول mail merge.
- [محرك التقارير LINQ](https://docs.aspose.com/words/net/linq-reporting-engine/) - يوفر معلومات حول إنشاء التقارير باستخدام مجموعة موسعة من ميزات إعداد التقارير.

...
In In In <span notrans="<span notrans=" Aspose.Words"=""></span>" שדות מיוצגים על ידי [Fields](https://reference.aspose.com/words/python-net/aspose.words.fields/) מודול. מאמרים בסעיף זה של תיעוד מסבירים כיצד להשתמש Aspose.Words שיעורים כדי לתמרן שדות מסמך באופן רציונאלי.
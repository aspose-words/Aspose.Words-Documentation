...
In In In Microsoft Word, אתה יכול ליצור טופס על ידי החל עם תבנית והוספת בקרת תוכן, כולל תיבות של Checkboxes, תיבות טקסט, בוחרים תאריך ורשימות ירידה. In In In <span notrans="<span notrans=" Aspose.Words"=""></span>" מסמך מובנה או בקרת תוכן מכל מסמך טעון לתוך Aspose.Words הוא מיובא כצומת מובנה. תגי מסמך ממובנים (SDT או בקרת תוכן) מאפשרים הטמעת סממנטיקה מוגדרת של הלקוח, כמו גם התנהגותו והופעתו במסמך.

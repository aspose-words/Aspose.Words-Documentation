...
מתי להפוך <span notrans="<span notrans=" **Shape**"=""></span>" זה חייב להיות חלק מההיררכיה של המסמך. אם **Shape** הוא לא חלק מעץ המסמכים, אז הפלט המתקבל יהיה ריק לאחר שהוא מעורר השראה. **ShapeRenderer** שיטות.

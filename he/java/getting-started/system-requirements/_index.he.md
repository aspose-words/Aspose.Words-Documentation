...
1 הורד **I/O 1.1**.
   בעת כתיבה, רק גרסת 32 סיביות של ההתקנה זמינה, כך שאם אתה משתמש ב-JDK אתה צריך להוריד [J_imageio-1_1-lib-windows-i586-jdk.exek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exe.exeek.exeek.exe.exe.exeek.exeek.exeek.exeek.exe.exeek.exe.exe.exe.exeek.exe.exe.exeek.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exeek.exeek.exeek.exeek.exe.exeek.exe.exeek.exeek.exe.exe.exe.exe.exeek.exeek.exeek.exeek.exeek.exeek.exeek.exe.exeek.exeek.exe.exeek.exeek.exeek.exeek.exeek.exe.exeek.exeek.exe](https://download.java.net/media/jai-imageio/builds/release/1.1/jai_imageio-1_1-lib-windows-i586-jdk.exe) אם אתה משתמש ב-JRE אתה צריך להוריד [J_imageio-1_1-lib-windows-i586-jre.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe.exe](https://download.java.net/media/jai-imageio/builds/release/1.1/jai_imageio-1_1-lib-windows-i586-jre.exe)
1.1 1. הפעל את המתקין ולהציג אותו למנהל שבו JDK/JRE מותקנת.

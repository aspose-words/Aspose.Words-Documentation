...
מתי להפוך <span notrans="<span notrans=" **Shape**"=""></span>" זה חייב להיות חלק מההיררכיה של המסמך. אם **Shape** אינו חלק מעץ המסמכים, אזי הפלט המתקבל יהיה ריק לאחר שהוא מעורר השראה. **ShapeRenderer** שיטות.

...
Клонирование создает новый документ с тем же содержимым, что и оригинал, но с уникальной копией каждого узла исходного документа. Вы также можете применить операцию клонирования к узлу документа, используя метод узла [clone](https://reference.aspose.com/words/python-net/aspose.words/document/clone/), который позволяет дублировать составные узлы документа с их дочерними узлами и без них.

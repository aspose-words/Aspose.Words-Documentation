---
title: Установите шрифты TrueType на Linux
...
description: "Aspose.Words вместо Python позволяет отображать документ, созданный с использованием Microsoft Word, на машине Linux с максимальной точностью. Для этого скопируйте файлы шрифтов с компьютера Windows или установите пакет шрифтов `TrueType` на свой компьютер Linux."
type: docs
weight: 20
...
- В версии Ubuntu используйте диспетчер пакетов Synaptic, чтобы найти и установить пакет *ttf-mscorefonts-installer*.
- В openSUSE используйте Yast2 → Управление программным обеспечением, чтобы найти и установить пакет *fetchmsttfonts*.
- Используйте шрифты Liberation, лицензированные по лицензии OFL, в качестве альтернативы стандартным шрифтам Windows года: Arial, Times New Roman и Courier New.
...
- [Шрифты Освобождения](https://pagure.io/liberation-fonts) как альтернатива стандартным шрифтам Windows

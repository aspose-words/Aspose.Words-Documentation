...
description: "PDF/A и PDF/UA устанавливают требования к доступности контента. При сохранении в PDF/A или PDF/UA Python и вопрос нарушает комплаенс, выдается предупреждение."
type: docs
weight: 29
...
Все предостережения [WarningType](https://reference.aspose.com/words/python-net/aspose.words/warningtype/)**.Малоформатная потеря** и [WarningSource](https://reference.aspose.com/words/python-net/aspose.words/warningsource/)**. Pdf**. Вот список новых предупреждающих значений описания:

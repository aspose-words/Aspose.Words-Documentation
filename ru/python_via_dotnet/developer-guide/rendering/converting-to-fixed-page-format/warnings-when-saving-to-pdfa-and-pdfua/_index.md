...
description: "PDF/A и PDF/UA предъявляют требования к доступности, связанные с содержимым документа. При сохранении в PDF/A или PDF/UA в Python, когда проблема нарушает соответствие требованиям, выдается предупреждение."
type: docs
weight: 29
...
Все предупреждения имеют номера [WarningType](https://reference.aspose.com/words/python-net/aspose.words/warningtype/)**.MinorFormattingLoss** и [WarningSource](https://reference.aspose.com/words/python-net/aspose.words/warningsource/)**.PDF**. Вот список новых значений предупреждений "Описание":

...
- [Поддерживаемые платформы](https://docs.aspose.com/words/java/platforms-and-interoperability/) - предоставляет информацию об использовании Aspose.Words При создании приложений для других платформ
...
- [Почему Aspose.Words](https://docs.aspose.com/words/java/aspose-words-or-other-solutions/) - описывает причины, по которым компоненты Aspose намного лучше, чем Microsoft Office Automation

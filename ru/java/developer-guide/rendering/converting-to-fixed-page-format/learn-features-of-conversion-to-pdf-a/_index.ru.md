...
description: "Преобразование в PDF/A-1, PDF/A-2, PDF/A-4 и PDF/UA Java. Выберите лучший стандарт PDF для конвертации документа Java."
type: docs
weight: 25
...
* [Как настроить запись ActualText для текста](https://helpx.adobe.com/acrobat/using/create-verify-pdf-accessibility.html), "Добавить фактический текст для сокращенного термина, формулы или символа без кода"

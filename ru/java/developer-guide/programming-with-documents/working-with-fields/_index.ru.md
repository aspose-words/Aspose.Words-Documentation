...
В <span notrans="<span notrans=" Aspose.Words"=""></span>"> Поля представлены различными классами, большинство названий которых начинаются с "поля". Статьи в этом разделе документации объясняют, как использовать Aspose.Words классы для программного манипулирования полями документов.
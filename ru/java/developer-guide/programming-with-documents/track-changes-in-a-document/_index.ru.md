---
title: Отслеживание изменений в документе в Java
second_title: Aspose.Words для Java
articleTitle: Отслеживание изменений в документе
linktitle: Отслеживание изменений в документе
description: "Отслеживайте изменения в контенте и форматировании, сделанные вами или другими. Доступ к отдельным изменениям в документе и применение различных свойств к ним с использованием Java."
type: docs
weight: 270
...
Прежде чем погрузиться в ревизии, давайте объясним смысл ревизий. А. [revision](https://reference.aspose.com/words/java/com.aspose.words/revision/) изменение, которое происходит в одном узле документа, в то время как группа пересмотра, представленная [RevisionGroup](https://reference.aspose.com/words/java/com.aspose.words/revisiongroup/) Класс - это группа последовательных изменений, которые происходят во многих узлах документа. Пересмотр является инструментом для отслеживания изменений.
...
Обратите внимание, что Microsoft Word не позволяет просматривать отдельные пересмотры, а только позволяет рассматривать последовательные пересмотры как единое целое. Но Aspose.Words Устраняет это ограничение с помощью **RevisionGroup** класс.

{{% /alert %}}

Aspose.Words поддерживает различные типы пересмотра, а также в Microsoft Word, такие как вставка, удаление, формат Изменение, StyleDefinition Меняться и двигаться. Все типы изменений представлены в [RevisionType](https://reference.aspose.com/words/java/com.aspose.words/revisiontype/) перечисление.
...
С помощью предыдущей функции отслеживания изменений вы можете понять, какие изменения были внесены в ваш документ и кто внес эти изменения. В то время как с [TrackRevisions](https://reference.aspose.com/words/java/com.aspose.words/document/#getTrackRevisions) Функция, вы заставляете любые изменения в вашем документе храниться в виде изменений.

Aspose.Words позволяет проверить, имеет ли документ пересмотр или нет, используя [HasRevision](https://reference.aspose.com/words/java/com.aspose.words/document/#hasRevisions) собственность. Если вам не нужно автоматически отслеживать изменения в вашем документе с помощью методов StartTrackRevisions и StopTrackRevisions, то вы можете использовать `TrackRevisions` свойство проверять, отслеживаются ли изменения при редактировании документа в Microsoft Word Сохраняется как ревизия.

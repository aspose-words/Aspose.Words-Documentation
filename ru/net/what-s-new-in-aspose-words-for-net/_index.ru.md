...
* API ограничение доступа к членам типа с использованием синтаксиса шаблона для `LINQ Reporting Engine` было предоставлено. <sup>24.1</sup>

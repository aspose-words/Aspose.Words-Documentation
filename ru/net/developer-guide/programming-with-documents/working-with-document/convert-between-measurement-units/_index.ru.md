...
Aspose.Words предоставляет класс [ConvertUtil](https://reference.aspose.com/words/ru/net/aspose.words/convertutil/), который предоставляет вспомогательные функции для преобразования между различными единицами измерения. Он позволяет конвертировать:

...
На вкладке "Азиатская типография" диалогового окна свойств абзаца в Microsoft Word есть группа разрывов строк. Параметры этой группы можно задать с помощью свойств [FarEastLineBreakControl](https://reference.aspose.com/words/ru/net/aspose.words/paragraphformat/fareastlinebreakcontrol/), [WordWrap](https://reference.aspose.com/words/ru/net/aspose.words/paragraphformat/wordwrap/), [HangingPunctuation](https://reference.aspose.com/words/ru/net/aspose.words/paragraphformat/hangingpunctuation/) класса **ParagraphFormat**.

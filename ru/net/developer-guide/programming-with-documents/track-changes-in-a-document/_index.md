...
Прежде чем углубляться в ревизии, давайте объясним значение ревизий. [revision](https://reference.aspose.com/words/net/aspose.words/revision/) — это изменение, которое происходит в одном узле документа, а группа редакций, представленная классом [RevisionGroup](https://reference.aspose.com/words/net/aspose.words/revision/group/), представляет собой группу последовательных редакций, которые происходят во многих узлах документа. По сути, ревизия — это инструмент отслеживания изменений.
...
Aspose.Words поддерживает различные типы изменений, как и Microsoft Word, такие как вставка, удаление, FormatChange, StyleDefinitionChange и Moving. Все типы редакций представлены перечислением [RevisionType](https://reference.aspose.com/words/net/aspose.words/revisiontype/).
...
Aspose.Words позволяет вам проверить, есть ли у документа редакция, используя свойство [HasRevision](https://reference.aspose.com/words/net/aspose.words/document/hasrevisions/). Если вам не нужно автоматически отслеживать изменения в вашем документе с помощью методов StartTrackRevisions и StopTrackRevisions, то вы можете использовать свойство `TrackRevisions`, чтобы проверить, отслеживаются ли изменения при редактировании документа в Microsoft Word и сохраняются ли они как ревизии.

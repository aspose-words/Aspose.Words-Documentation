...
description: "Работа с таблицами и их компонентами, такими как ячейки, строки, столбцы в Aspose.Words для .NET. Как работать с таблицами в C#."
type: docs
weight: 10
...
Как уже говорилось, таблица состоит из таких элементов, как **Cell**, **Row** и **Column**. Это понятия, общие для всех таблиц в целом, независимо от формата документа.
...
Вы можете проверить структуру узлов таблицы в документе, используя код **DocumentExplorer**.
...
В версии Aspose.Words все классы и свойства, связанные с таблицами, содержатся в пространстве имен [Aspose.Words.Tables](https://reference.aspose.com/words/ru/net/aspose.words.tables/).

...
* Если предварительно отрендеренный рисунок присутствует, но неверен, необходимо явно выполнить холодный рендеринг SmartArt, вызвав метод [UpdateSmartArtDrawing](https://reference.aspose.com/words/net/aspose.words.drawing/shape/updatesmartartdrawing/).

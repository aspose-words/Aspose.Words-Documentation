...
Класс [Document](https://reference.aspose.com/words/ru/net/aspose.words/document/) предоставляет свойство [FieldOptions](https://reference.aspose.com/words/ru/net/aspose.words/document/fieldoptions/), содержащее элементы, которые можно использовать для управления обновлением полей в документе.

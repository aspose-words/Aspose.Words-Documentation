...
description: "Узнайте, как заменить поля текстом в C#. Замените поля статическими данными, используя .NET API."
type: docs
weight: 37
...
Вы можете скачать образец файла этого примера по адресу [Aspose.Words GitHub](https://github.com/aspose-words/Aspose.Words-for-.NET/blob/master/Examples/Data/Linked%20fields.docx).
...
В следующем примере кода показано, как преобразовать все `IF` поля в последнем абзаце в статический текст:

...
Чтобы получить информацию обо всех проблемах на протяжении всего времени загрузки, используйте свойство [WarningCallback](https://reference.aspose.com/words/ru/net/aspose.words.loading/loadoptions/warningcallback/).
...
Если у вас возникла проблема с исключением "Недостаточно памяти" при загрузке документа, попробуйте использовать свойство [TempFolder](https://reference.aspose.com/words/ru/net/aspose.words.loading/loadoptions/tempfolder/). В этом случае Aspose.Words будет хранить некоторые данные во временных файлах вместо памяти, и это может помочь избежать такого исключения.
...
Вы можете загружать документы Word, зашифрованные паролем. Для этого используйте специальную перегрузку конструктора, принимающую объект [LoadOptions](https://reference.aspose.com/words/ru/net/aspose.words.loading/loadoptions/). Этот объект содержит свойство [Password](https://reference.aspose.com/words/ru/net/aspose.words.loading/loadoptions/password/), которое определяет строку пароля.

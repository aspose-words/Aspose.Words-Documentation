...
articleTitle: Características compatibles
linktitle: Características compatibles
description: "Aspose.Words para Java proporciona a los usuarios una amplia gama de características de simplemente convertir y modificar documentos para crear documentos estructurados y visualmente atractivos o automatizar informes."
type: docs
weight: 40
...
La mayoría de las capturas de pantalla en esta sección muestran los documentos generados por Aspose.Words y luego abierto para ver Microsoft Word y otras aplicaciones.
...
|  :-  |  :-  |
| [Java](/words/java/supported-platforms/) | Aspose.Words para Java disponible para Java 1.6, 1.7 y 1.8 y correrá en cualquier lugar donde Java está instalado. |

## Formatos y conversiones de archivos

{{% alert color="primary" %}}

Muchos clientes de todo el mundo confían en las características de importación y exportación de documentos detallados Aspose.Words.

{{% /alert %}}

|  Característica | Descripción |
|  :-  |  :-  |
| Microsoft Word (DOC) ([carga](/words/java/load-in-ms-word-97-2003-formats/) y [Guardar](/words/java/save-in-ms-word-97-2003-formats/)) | La implementación de formato DOC más rápida y completa que puedes encontrar. |
| WordprocessingML (DOCX, XML) ([carga](/words/java/load-in-the-open-office-xml-2007-and-2010-formats/) y [Guardar](/words/java/save-in-the-open-office-xml-docx-dotx-docm-dotm-format/)) | Aspose.Words Proporciona soporte exhaustivo OOXML, OPC plano y también XML Word 2003. |
| Formato de texto rico (RTF) ([carga](/words/java/load-in-the-rich-text-format-1-9-rtf-format/) y [Guardar](/words/java/save-in-the-rich-text-format-1-9-rtf-format/)) | Apoyo integral del formato RTF para interactuar con una variedad de aplicaciones. |
| HTML, XHTML y MHTML | [Carga](/words/java/load-in-the-html-html-xhtml-mhtml-format/) y [Guardar](/words/java/save-in-the-html-html-xhtml-mhtml-format/) HTML/XHTML para mayor interoperabilidad. Guardar como MHTML también está disponible. |
| OpenDocument (ODT) | Aspose.Words puede [carga](/words/java/load-in-the-opendocument-text-odt-ott-format/) y [Guardar](/words/java/save-in-the-opendocument-text-odt-ott-format/) documentos en los `OpenDocument` Formato de texto (.odt). |
| [Formato de documento portátil de Adobe (PDF)](/words/java/save-in-the-adobe-portable-document-pdf-format/) | Convertir cualquier documento en PDF con alta fidelidad. PDF/A es compatible. |
| Especificación de papel XML (XPS)[carga](/words/java/load-in-ms-word-2003-formats/) y [Guardar](/words/java/save-in-the-flatopc-ooxml-document-xml-format/)) | Convertir cualquier documento en XPS con alta fidelidad. |
| Texto del mensaje (TXT) ([carga](/words/java/load-in-the-plain-text-txt-format/) y [Guardar](/words/java/save-in-the-plain-text-txt-format/)) | Extrae fácilmente el texto guardando en formato texto simple. |
| [Digital Publishing (EPUB)](/words/java/save-in-the-idpf-epub-document-epub-format/) | EPUB es un formato popular para eBooks. Puede convertir cualquier documento desde Aspose.Words al formato IDPF EPUB. |

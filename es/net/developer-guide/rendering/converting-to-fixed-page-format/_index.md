...
- Un reproductor de metarchivos ([MetafileRenderingOptions](https://reference.aspose.com/words/net/aspose.words.saving/fixedpagesaveoptions/metafilerenderingoptions/)). Para obtener más detalles, consulte el artículo ["Manejo de metarchivos Windows"](/words/net/handling-windows-metafiles/).

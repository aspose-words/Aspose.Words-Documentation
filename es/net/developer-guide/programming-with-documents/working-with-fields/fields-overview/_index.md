...
El contenido que constituye el código de campo se almacena como nodos [Run](https://reference.aspose.com/words/net/aspose.words/run/) entre [FieldStart](https://reference.aspose.com/words/net/aspose.words.fields/fieldstart/) y [FieldSeparator](https://reference.aspose.com/words/net/aspose.words.fields/fieldseparator/). El resultado del campo se almacena entre los nodos **FieldSeparator** y [FieldEnd](https://reference.aspose.com/words/net/aspose.words.fields/fieldend/) y puede estar compuesto por varios tipos de contenido. Normalmente, el resultado del campo contiene solo texto compuesto por nodos **Run**; sin embargo, es posible que el nodo **FieldEnd** esté ubicado en un párrafo completamente diferente y, por lo tanto, el resultado del campo esté compuesto también por nodos [Niveles lógicos de nodos en un documento](/words/es/net/logical-levels-of-nodes-in-a-document/) como **Table** y **Paragraph**.
...
La clase [Document](https://reference.aspose.com/words/net/aspose.words/document/) proporciona una propiedad [FieldOptions](https://reference.aspose.com/words/net/aspose.words/document/fieldoptions/) que contiene miembros que pueden usarse para controlar cómo se actualizan los campos dentro del documento.

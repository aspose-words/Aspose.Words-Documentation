...
Si desea insertar campos vacíos/sin escribir ({}) tal como lo permite Microsoft Word, puede usar el método [InsertField](https://reference.aspose.com/words/net/aspose.words/documentbuilder/insertfield/) con el parámetro [FieldType.FieldNone](https://reference.aspose.com/words/net/aspose.words.fields/fieldtype/). Para insertar un campo en un documento de Word, puede presionar la combinación de teclas "Ctrl + F9".
...
La forma alternativa de insertar campos en Aspose.Words es la clase [FieldBuilder](https://reference.aspose.com/words/net/aspose.words.fields/fieldbuilder/). Proporciona una interfaz fluida para especificar cambios de campo y valores de argumentos como texto, nodos o incluso campos anidados.
...
El campo `MERGEFIELD` en un documento de Word se puede representar mediante la clase [FieldMergeField](https://reference.aspose.com/words/net/aspose.words.fields/fieldmergefield/). Puede utilizar la clase **FieldMergeField** para realizar las siguientes operaciones:
...
Para obtener más detalles, consulte la clase [FieldMergeField](https://reference.aspose.com/words/net/aspose.words.fields/fieldmergefield/) API.
...
Para obtener más detalles, consulte la clase [FieldAddressBlock](https://reference.aspose.com/words/net/aspose.words.fields/fieldaddressblock/) API.
...
Para obtener más detalles, consulte la clase [FieldAdvance](https://reference.aspose.com/words/net/aspose.words.fields/fieldadvance/) API.
...
Para obtener más detalles, consulte la clase [FieldAsk](https://reference.aspose.com/words/net/aspose.words.fields/fieldask/) API.
...
Para obtener más detalles, consulte la clase [FieldAuthor](https://reference.aspose.com/words/net/aspose.words.fields/fieldauthor/) API.
...
Para obtener más detalles, consulte la clase [FieldIncludeText](https://reference.aspose.com/words/net/aspose.words.fields/fieldincludetext/) API.
...
Para obtener más detalles, consulte la clase [FieldToa](https://reference.aspose.com/words/net/aspose.words.fields/fieldtoa/) API.

...
Para actualizar explícitamente los campos en todo el documento, simplemente llame al método [UpdateFields](https://reference.aspose.com/words/net/aspose.words/document/updatefields/). Para actualizar campos contenidos en parte de un documento, obtenga un objeto [Range](https://reference.aspose.com/words/net/aspose.words/range/) y llame al método [UpdateFields](https://reference.aspose.com/words/net/aspose.words/range/updatefields/). En Aspose.Words, puede obtener un **Range** para cualquier nodo en el árbol del documento, como [Section](https://reference.aspose.com/words/net/aspose.words/section/), [HeaderFooter](https://reference.aspose.com/words/net/aspose.words/headerfooter/), [Paragraph](https://reference.aspose.com/words/net/aspose.words/paragraph/), etc. utilizando la propiedad [Node.Range](https://reference.aspose.com/words/net/aspose.words/node/range/). Puede actualizar el resultado de un solo campo llamando al método [Update](https://reference.aspose.com/words/net/aspose.words.fields/field/update/).
...
Si desea actualizar todos los demás campos del documento, debe llamar a [UpdateFields](https://reference.aspose.com/words/net/aspose.words/document/updatefields/) antes de procesar el documento.

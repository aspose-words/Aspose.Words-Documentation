...
Para eliminar un campo insertado en un documento usando [DocumentBuilder](https://reference.aspose.com/words/net/aspose.words/documentbuilder/).[InsertField](https://reference.aspose.com/words/net/aspose.words/documentbuilder/insertfield/), use el objeto [Field](https://reference.aspose.com/words/net/aspose.words.fields/field/) devuelto, que proporciona un método [Remove](https://reference.aspose.com/words/net/aspose.words.fields/field/remove/) conveniente para eliminar fácilmente el campo del documento.

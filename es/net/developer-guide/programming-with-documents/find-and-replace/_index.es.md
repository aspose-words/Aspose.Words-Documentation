...
Utilice el otro método [Replace](https://reference.aspose.com/words/net/aspose.words/range/replace/) para buscar y reemplazar combinaciones de caracteres particulares configurando el parámetro `Regex` como patrón de expresión regular para encontrar coincidencias.
...
Puede buscar y reemplazar texto en la sección de encabezado/pie de página de un documento de Word utilizando la clase [HeaderFooter](https://reference.aspose.com/words/net/aspose.words/headerfooter/).

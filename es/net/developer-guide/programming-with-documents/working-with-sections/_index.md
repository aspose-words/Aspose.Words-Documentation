...
Dado que una sección es un nodo compuesto normal, todo el API de manipulación de nodos se puede utilizar para manipular secciones: para agregar, eliminar y otras operaciones en secciones. Puedes leer más sobre los nodos en el artículo ["Modelo de objetos de documento Aspose.Words (DOM)"](/words/net/aspose-words-document-object-model/).

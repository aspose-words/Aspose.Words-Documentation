...
Con el objeto **Range**, también puede llamar a métodos en todo el rango de la tabla y extraer la tabla como texto sin formato. Para hacer esto, use la propiedad [Text](https://reference.aspose.com/words/net/aspose.words/range/text/).

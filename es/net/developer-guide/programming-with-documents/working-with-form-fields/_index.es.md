...
Una colección de campos de formulario está representada por la clase [FormFieldCollection](https://reference.aspose.com/words/net/aspose.words.fields/formfieldcollection/) que se puede recuperar mediante la propiedad [FormFields](https://reference.aspose.com/words/net/aspose.words/range/formfields/). Esto significa que puede obtener campos de formulario contenidos en cualquier nodo del documento, incluido el documento mismo.
...
La propiedad [Font](https://reference.aspose.com/words/net/aspose.words/inline/font/) de [FormField](https://reference.aspose.com/words/net/aspose.words.fields/formfield/) permite aplicar formato de fuente al **FormField** en su conjunto, incluido el valor del campo.

...
- Un reproductor de metarchivos ([metafile_rendering_options](https://reference.aspose.com/words/python-net/aspose.words.saving/fixedpagesaveoptions/metafile_rendering_options/)). Para obtener más detalles, consulte el artículo ["Manejo de metarchivos Windows"](/words/python-net/handling-windows-metafiles/).

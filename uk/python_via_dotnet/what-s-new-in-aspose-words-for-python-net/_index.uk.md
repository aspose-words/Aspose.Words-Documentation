...
### Підтримані формати <sup>24.4 км</sup>
...
#### Увімкніть шрифти, декларовані в @font-face <sup>24.4 км</sup>
...
#### Робота з форматуванням Glow і відбиття <sup>24.4 км</sup>
...
Дізнатися більше [Aspose.Words для Python via .NET 23.9 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-9-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.10 Реліз Примітки](https://releases.aspose.com/words/python/release-notes/2023/aspose-words-for-python-via-dotnet-23-10-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.11 Реліз Примітки](https://releases.aspose.com/words/python/release-notes/2023/aspose-words-for-python-via-dotnet-23-11-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.12 Реліз Примітки](https://releases.aspose.com/words/python/release-notes/2023/aspose-words-for-python-via-dotnet-23-12-release-notes/)й
...
#### Забарвлений вміст на сторінці <sup>23.6 км</sup>
...
#### Вказати розмір Rendered Зображення <sup>23.8 км</sup>
...
- Реалізовано підтримку обгортання тексту в заголовках/футах. <sup>23.5 км</sup>
- до Додана можливість видалення цифрових підписів з документів ODT [RemoveAllSignatures](https://reference.aspose.com/words/python-net/aspose.words.digitalsignatures/digitalsignatureutil/remove_all_signatures/#str_str) метод. <sup>23.5 км</sup>
- до Громадська нерухомість [phonetic_guide](https://reference.aspose.com/words/python-net/aspose.words/run/phonetic_guide/) для отримання бази та рубати тексту фонетичного керівництва [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) Додано. <sup>23.5 км</sup>
- до Уміння отримати цифрову вартість підпису з цифрово підписаного документа як байтовий масив додано шляхом введення нового [signature_value](https://reference.aspose.com/words/python-net/aspose.words.digitalsignatures/digitalsignature/signature_value/) майно. <sup>23.7 км</sup>
- У [Row](https://reference.aspose.com/words/python-net/aspose.words.tables/row/) і [Cell](https://reference.aspose.com/words/python-net/aspose.words.tables/cell/) Завершилися заняття з новими членами [Row.next_row](https://reference.aspose.com/words/python-net/aspose.words.tables/row/next_row/), [Row.previous_row](https://reference.aspose.com/words/python-net/aspose.words.tables/row/previous_row/), [Cell.next_cell](https://reference.aspose.com/words/python-net/aspose.words.tables/cell/next_cell/), і [Cell.previous_cell](https://reference.aspose.com/words/python-net/aspose.words.tables/cell/previous_cell/)й <sup>23.7 км</sup>

{{% alert color="primary" %}}

Дізнатися більше [Aspose.Words для Python via .NET 23.5 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-5-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.6 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-6-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.7 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-7-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.8 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-8-release-notes/)й
...
#### Повідомлення про збереження документів <sup>23.3 км</sup>
...
- до Уміння уточнити налаштування корекції символів документа додано через [justification_mode](https://reference.aspose.com/words/python-net/aspose.words/document/justification_mode/) Реалізація майна <sup>23.2 км</sup>
- Шлях до інструкції Aspose.Words Чи можна включати текстові скриньки, примітки та кінцеві помилки у статистичній статистиці підрахунку слів, додавши додавання [include_textboxes_footnotes_endnotes_in_stat](https://reference.aspose.com/words/python-net/aspose.words/document/include_textboxes_footnotes_endnotes_in_stat/) Проживання <sup>23.2 км</sup>
- Новий варіант для стилю документа, який дозволяє вказати, чи автоматично перевизнається стиль на основі відповідного значення, представлений за допомогою відповідного значення. [automatically_update](https://reference.aspose.com/words/python-net/aspose.words/style/automatically_update/) Проживання <sup>23.2 км</sup>
- до Уміння визначити чи [Run](https://reference.aspose.com/words/python-net/aspose.words/run/) є фонетичним гідом, який додано за допомогою [is_phonetic_guide](https://reference.aspose.com/words/python-net/aspose.words/run/is_phonetic_guide/) Проживання <sup>23.4 км</sup>
- Простий спосіб роботи з серією та осями комбінованих діаграм реалізовано шляхом введення [ChartAxisCollection](https://reference.aspose.com/words/python-net/aspose.words.drawing.charts/chartaxiscollection/) клас і додавання [Chart.axes](https://reference.aspose.com/words/python-net/aspose.words.drawing.charts/chart/axes/) Проживання <sup>23.4 км</sup>
- Додані нові публічні властивості, пов'язані з формою відносного позиціонування та зміщення [Shape](https://reference.aspose.com/words/python-net/aspose.words.drawing/shape/) клас <sup>23.4 км</sup>
- Удосконалено точність та продуктивність розрахунку яскравості кольору для автоматичного визначення кольору тексту відповідно до останніх версій Microsoft Word <sup>23.4 км</sup>

{{% alert color="primary" %}}

Дізнатися більше [Aspose.Words для Python via .NET 23.1 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-1-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.2 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-2-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.3 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-3-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 23.4 Випускають Примітки](/words/python-net/aspose-words-for-python-via-dotnet-23-4-release-notes/)й
...
Дізнатися більше [Aspose.Words для Python via .NET 22.9 Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-9-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.10 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-10-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.11 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-11-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.12 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-12-release-notes/)й

{{% /alert %}}

## Aspose.Words для Python via .NET 22,5, 22.6, 22.7, 22.8

Aspose.Words 22.5 вводить підтримку нових форматів завантаження та нових розмірів сторінок друку, а також покращує деякі параметри рендерингу.

Aspose.Words 22.6 розширює можливості перетворення PDF в інші формати, а також покращують роботу з DrawingML і твердим текстом заповнює ефектом.
...
Про нас API Розширений для більш гнучкого і зручного розвитку.

### Підтримані формати

* Введено підтримку завантаження документів EPUB та XML, додаючи нові значення **LoadFormat** заохочення. Почати з версії 22,5 можна навантажити документи EPUB та XML у Aspose.Words модель документа і перетворення їх в будь-який [Підтримувані формати документів](/words/uk/python-net/supported-document-formats/)й <sup>22.5 км</sup>
* Починаючи з версії 22.8, можна зберегти документ у форматі AZW3 – Amazon Формат файлів електронних книг Kindle (KF8 є ще однією назвою для формату). Тепер ви можете не тільки завантажувати документи AZW3, але й експортувати файли до формату AZW3, що істотно складається EPUB. <sup>22.8 км</sup>

### Рендеринг і друк

#### Новий розмір друку <sup>22.5 км</sup>

Додана підтримка друку сторінок "Envelope No 10" шляхом введення нового значення до [PaperSize](https://reference.aspose.com/words/python-net/aspose.words/papersize/) заохочення.
...
#### ДМЛ Поліпшення діаграм <sup>22.6 км</sup>

DrawingML діаграми громадськість API Подовжується підтримка градієнтів, текстури та заповнює шаблони.
...
Попередньо, glyph Для шрифтів OpenType (CFF) виконано через GDI+. Так тепер працює у випадках, коли GDI+ не доступний – Java, .NET Standard платформи, Linux, macOS та ін. Glyph визначає парсінг, необхідний в конкретних випадках, таких як WordArt, текстові ефекти, деякі функції Office Math та інші.

#### Набір форм Shadow Форматування <sup>22.7 км</sup>

Уміння встановити форматування тіні об'єкта форми, надана шляхом додавання нового [shadow_format](https://reference.aspose.com/words/python-net/aspose.words.drawing/shapebase/shadow_format/) майно.

#### Підтримка стільникового спарингу в таблицях <sup>22.8 км</sup>

Двигун верстки тепер значно поліпшується: реалізовано дуже складний механізм збивання клітин в таблицях.

#### Заміна шрифту для символів <sup>22.8 км</sup>

Покращено зміну шрифту для символів.

#### Графік Axis Етикетка Rotation Algorithm <sup>22.8 км</sup>

Удосконалено алгоритм обертання міток осі діаграми.

### Завантаження та збереження документів

#### Перетворення та конвертація PDF у формат Фіксованої сторінки без моделі Layout <sup>22.6 км</sup>
...
Введено новий режим імпорту HTML для елементів блоків, додаючи нове значення [HtmlInsertOptions](https://reference.aspose.com/words/python-net/aspose.words/htmlinsertoptions/) заохочення.

#### Перетворення в PDF/UA-1 сумісний з WCAG 2.0 <sup>22.7 км</sup>
...
Статус на сервери Настанови, розроблені W3C у співпраці з фізичними особами та організаціями у всьому світі. Тепер з Aspose.Words Ви можете конвертувати документ у вихідний формат PDF/UA-1, який підходить для побудови документів PDF-документів WCAG 2.0.
...
Виняток успадкування твердого тексту заповнює ефект, який реалізується поведінка MS Word. <sup>22.6 км</sup>

{{% alert color="primary" %}}

Дізнатися більше [Aspose.Words для Python via .NET 22.5 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-5-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.6 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-6-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.7 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-7-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.8 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-8-release-notes/)й
...
Почати з Aspose.Words 22.4, підтримка Python 3.10 додано.

### Покращення продуктивності

Завантаживши раніше збережений кеш пошуку шрифту для прискорення процесу ідентифікації кешу шрифту при рендерингу. Тепер ваші рішення будуть працювати швидше.

### Підтримані формати

Навантаження документа в форматі AZW3 (KF8 є ще одне ім'я для формату). Тепер ви можете завантажити документ AZW3 і конвертувати його в будь-які інші формати підтримки.
...
#### ДМЛ Поліпшення діаграм

До діаграм DML додано наступні покращення:

* Ім'я * Алгоритм масштабування осі DML було покращено, щоб бути таким же, як у MS Word

* Ім'я * Надано можливість маніпуляції записами на діаграму DrawingML, щоб зробити наш графік API докладніше
* Ім'я * Уміння вказати ім'я файла xls/xx DrawingML, пов'язаний з реалізовано

#### Рендеринг в PDF з комплаєнсом PDF/A-4

Додана робота в PDF з комплаєнсом PDF/A-4 шляхом додавання нових значень до [PdfCompliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfcompliance/) заохочення – [PDF_A4](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfcompliance/#pdf_a4)й Ця опція передбачає переглянуті рівні конформансу: регулярний PDF/A-4 конформанс еквівалентний рівню конформансу U попередніх версій, а рівень Виводиться конформанс.

#### Читання метаданих Photoshop у JPEG

Читання метаданих Photoshop у зображеннях JPEG реалізовано для виправлення цікавого питання з неправильним масштабуванням зображень на рендерингу.

#### Дозвоніть латинський текст, щоб обгорнути в середині слова
...
Новий варіант [force_copy_styles](https://reference.aspose.com/words/python-net/aspose.words/importformatoptions/force_copy_styles/) Запроваджено контроль поведінки конфліктних стилів на імпорті документів.

#### Перетворення форм в SVG При експорті

Можливість перетворення форм на зображення SVG на експорт в HTML, MHTML, або EPUB була надана шляхом додавання форми до SVG зображень на експорт в HTML, MHTML або EPUB. [export_shapes_as_svg](https://reference.aspose.com/words/python-net/aspose.words.saving/htmlsaveoptions/export_shapes_as_svg/) майно.

#### Збереження у PDF 2.0 та вдосконалення у форматі PDF

Уміння зберегти документ як PDF 2.0 шляхом додавання нової цінності до [PdfCompliance](https://reference.aspose.com/words/python-net/aspose.words.saving/pdfcompliance/) запроваджено нумерацію, а також кілька інших необхідних поліпшень до виходу PDF.
...
* Ім'я * Введено можливість отримати OOXML управління контентом і зберегти його на рядок.
* Додано визнання нестандартних приміток у документах PDF на імпорт.
* Ім'я * Додана можливість отримати на замовлення дані поля, які асоціюються з поле.
...
Дізнатися більше [Aspose.Words для Python via .NET 22.3 Release Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-3-release-notes/)й

Дізнатися більше [Aspose.Words для Python via .NET 22.4 Реліз Примітки](/words/python-net/aspose-words-for-python-via-dotnet-22-4-release-notes/)й

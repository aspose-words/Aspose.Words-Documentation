...
Формат шрифту не може бути доступний, або формат шрифту підтримується Microsoft Word але не підтримується Aspose.Wordsй Aspose.Words виконувати [Налаштування та налаштування TrueType](/words/uk/java/manipulate-and-substitute-truetype-fonts/)й

Щоб перевірити, чи відсутні шрифти:

- В Aspose.Words Використовуйте попередження заміни шрифтів (для деталей, див. розділ "Як дізнатися, що запис було замінено шрифтом" [Налаштування та налаштування TrueType](/words/uk/java/manipulate-and-substitute-truetype-fonts/) стаття).

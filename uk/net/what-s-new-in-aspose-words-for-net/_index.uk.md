...
Дізнатися більше [Aspose.Words для .NET 24.1 Реліз Примітки](https://releases.aspose.com/words/net/release-notes/2024/aspose-words-for-net-24-1-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 24.2 Реліз Примітки](https://releases.aspose.com/words/net/release-notes/2024/aspose-words-for-net-24-2-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 24.3 Реліз Примітки](https://releases.aspose.com/words/net/release-notes/2024/aspose-words-for-net-24-3-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 24.4 Release Примітки](https://releases.aspose.com/words/net/release-notes/2024/aspose-words-for-net-24-4-release-notes/)й
...
Дізнатися більше [Aspose.Words для .NET 23.9 Реліз Примітки](/words/net/aspose-words-for-net-23-9-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.10 Реліз Примітки](https://releases.aspose.com/words/net/release-notes/2023/aspose-words-for-net-23-10-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.11 Реліз Примітки](https://releases.aspose.com/words/net/release-notes/2023/aspose-words-for-net-23-11-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.12 Реліз Примітки](https://releases.aspose.com/words/net/release-notes/2023/aspose-words-for-net-23-12-release-notes/)й
...
Дізнатися більше [Aspose.Words для .NET 23.5 Реліз Примітки](/words/net/aspose-words-for-net-23-5-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.6 Release Примітки](/words/net/aspose-words-for-net-23-6-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.7 Release Примітки](/words/net/aspose-words-for-net-23-7-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.8 Release Примітки](/words/net/aspose-words-for-net-23-8-release-notes/)й
...
Дізнатися більше [Aspose.Words для .NET 23.1 Release Примітки](/words/net/aspose-words-for-net-23-1-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.2 Release Примітки](/words/net/aspose-words-for-net-23-2-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.3 Release Примітки](/words/net/aspose-words-for-net-23-3-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 23.4 Випускають Примітки](/words/net/aspose-words-for-net-23-4-release-notes/)й
...
Дізнатися більше [Aspose.Words для .NET 22.9 Примітки](/words/net/aspose-words-for-net-22-9-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 22.10 Реліз Примітки](/words/net/aspose-words-for-net-22-10-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 22.11 Реліз Примітки](/words/net/aspose-words-for-net-22-11-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 22.12 Реліз Примітки](/words/net/aspose-words-for-net-22-12-release-notes/)й
...
* Введено підтримку завантаження документів EPUB та XML, додаючи нові значення [LoadFormat](https://reference.aspose.com/words/net/aspose.words/loadformat/) заохочення. Почати з версії 22.5 можна навантажити документи EPUB та XML у Aspose.Words модель документа і перетворення їх в будь-який [формати](https://reference.aspose.com/words/net/aspose.words/saveformat/)й <sup>22.5</sup>
...
Додана підтримка друку сторінок "Envelope No 10" шляхом введення нового значення до [PaperSize](https://reference.aspose.com/words/net/aspose.words/papersize/) заохочення.
...
Попередньо, glyph Для шрифтів OpenType (CFF) виконано через GDI+. Так тепер працює у випадках, коли GDI+ не доступний – Java, .NET Standard платформи, Linux ОС та ін. Glyph визначає парсінг, необхідний в конкретних випадках, таких як WordArt, текстові ефекти, деякі функції Office Math та інші.

#### Набір форм Shadow Форматування <sup>22.7</sup>

Уміння встановити форматування тіні об'єкта форми, надана шляхом додавання нового [ShadowFormat](https://reference.aspose.com/words/net/aspose.words.drawing/shapebase/shadowformat/) майно.
...
Введено новий режим імпорту HTML для елементів блоків, додаючи нове значення [HtmlInsertOptions](https://reference.aspose.com/words/net/aspose.words/htmlinsertoptions/) заохочення.

#### Перетворення в PDF/UA-1 CSompliant з WCAG 2.0 <sup>22.7</sup>
...
* Вимоги до завантаження мультимедійного вмісту

Але обидва вимоги не актуальні для нашого випадку перетворення з Word в PDF.

### Інше

* Виняток успадкування твердого тексту заповнюється ефектом, який імітує поведінку MS Word. <sup>22.6</sup>
* Підтримка `DATABASE` додано поля. Використовуючи цей тип поля, ви можете, наприклад, показати результати запиту бази даних в Microsoft Word стіл. <sup>22.7</sup>

{{% alert color="primary" %}}

Дізнатися більше [Aspose.Words для .NET 22.5 Реліз Примітки](/words/net/aspose-words-for-net-22-5-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 22.6 Release Примітки](/words/net/aspose-words-for-net-22-6-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 22.7 Release Примітки](/words/net/aspose-words-for-net-22-7-release-notes/)й

Дізнатися більше [Aspose.Words для .NET 22.8 Release Примітки](/words/net/aspose-words-for-net-22-8-release-notes/)й

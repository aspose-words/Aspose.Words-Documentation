...
Дізнатися більше про інформацію mail merge в [Mail Merge та звітність](/words/net/mail-merge-and-reporting/) розділ документації.
...
* Ім'я * Перевірити розділ "Як налаштувати відносини з даними в гнізді Mail Merge з регіонами" у статті [Непристойна Mail Merge з регіонами](/words/net/nested-mail-merge-with-regions/)й

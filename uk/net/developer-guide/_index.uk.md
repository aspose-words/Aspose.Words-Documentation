...
- до [Mail Merge та звітність](https://docs.aspose.com/words/net/mail-merge-and-reporting/) – надає інформацію про генеруючі документи, такі як звіти, каталоги, винахідники та рахунки-фактури, з шаблонів з mail merge поля.
- до [ЛІНК Звітний двигун](https://docs.aspose.com/words/net/linq-reporting-engine/) – надає інформацію про будівельні звіти з використанням розширеного набору функцій звітності.

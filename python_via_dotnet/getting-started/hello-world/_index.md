...
1. Inisialize a **DocumentBuilder** class
1. Insert text to the document start using simple **Write** method
1. Open an existing **Document** from a file. Automatically detects the file format
1. **Append** document "A" to the and of the document "B"
1. **Save** the output as PDF

...
description: "Embed customer-defined semantics as well as its behavior and appearance into a document using Structured document tags (SDT or content control) using Python."
type: docs
weight: 50

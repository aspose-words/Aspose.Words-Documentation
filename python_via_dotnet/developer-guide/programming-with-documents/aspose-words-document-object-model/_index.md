...
[CompositeNode](https://reference.aspose.com/words/python-net/aspose.words/compositenode/) also provides the [child_nodes](https://reference.aspose.com/words/python-net/aspose.words/compositenode/child_nodes/) collection enabling indexed or enumerated access to the child nodes. The [child_nodes](https://reference.aspose.com/words/python-net/aspose.words/compositenode/child_nodes/) property is a live collection of nodes, which means that whenever the document is changed, such as when nodes are removed or added, the [child_nodes](https://reference.aspose.com/words/python-net/aspose.words/compositenode/child_nodes/) collection is automatically updated.

If a node has no child, then the [child_nodes](https://reference.aspose.com/words/python-net/aspose.words/compositenode/child_nodes/) property returns an empty collection. You can check whether the [CompositeNode](https://reference.aspose.com/words/python-net/aspose.words/compositenode/) contains any child nodes using the [has_child_nodes](https://reference.aspose.com/words/python-net/aspose.words/compositenode/has_child_nodes/) property.

The following code example shows how to enumerate immediate child nodes of a [CompositeNode](https://reference.aspose.com/words/python-net/aspose.words/compositenode/) using the enumerator provided by the [child_nodes](https://reference.aspose.com/words/python-net/aspose.words/compositenode/child_nodes/) collection:

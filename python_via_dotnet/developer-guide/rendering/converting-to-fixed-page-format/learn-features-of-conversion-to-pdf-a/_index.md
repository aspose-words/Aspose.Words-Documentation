...
description: "Aspose.Words for Python allows users to convert to PDF/A-1 and PDF/A-2. There are a few problems when converting to PDF/A documents, and Aspose.Words for Python via .NET solves them."
type: docs
weight: 25

...
- [Mail Merge a podávání zpráv](https://docs.aspose.com/words/net/mail-merge-and-reporting/) Informace o vytváření dokumentů, jako jsou zprávy, katalogy, inventury a faktury, z šablon mail merge Pole.
- [LINQ Vykazovací motor](https://docs.aspose.com/words/net/linq-reporting-engine/) Informace o stavbových zprávách poskytuje rozšířený soubor zpravodajských prvků.
